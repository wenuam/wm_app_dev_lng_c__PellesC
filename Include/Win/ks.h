...
/* Windows Driver Model/Connection and Streaming Architecture (WDM-CSA) definitions */
...
typedef void (*PFNKSGRAPHMANAGER_NOTIFY)(PFILE_OBJECT GraphManager,
    ULONG EventId,
    PVOID Filter,
    PVOID Pin,
    PVOID Frame,
...
#include <pshpack1.h>
#endif /* !PACK_PRAGMAS_NOT_SUPPORTED */
...
void __inline KsGateInitialize(PKSGATE Gate, LONG InitialCount,
...
KSDDKAPI NTSTATUS NTAPI KsGenerateEvent(
    PKSEVENT_ENTRY EventEntry
);
...
KSDDKAPI NTSTATUS NTAPI KsGenerateThermalEvent(
    PVOID Object,
    KSDEVICE_THERMAL_STATE Value
);

typedef void (*PFNKSDEVICETHERMALACTIVECOOLING)(
    PKSDEVICE KsDevice,
    BOOLEAN Engaged,
    KSDEVICE_THERMAL_STATE *DeviceThermalState
);

typedef void (*PFNKSDEVICETHERMALPASSIVECOOLING)(
    PKSDEVICE KsDevice,
    ULONG Percentage,
    KSDEVICE_THERMAL_STATE *DeviceThermalState
);
...
KSDDKAPI NTSTATUS NTAPI KsDeviceRegisterThermalDispatch(
    PKSDEVICE KsDevice,
...
KSDDKAPI NTSTATUS NTAPI KsCreateDefaultAllocator(
    PIRP Irp
);
...
KSDDKAPI NTSTATUS NTAPI KsAllocateDefaultClock(
...
KSDDKAPI NTSTATUS NTAPI KsAllocateDefaultClockEx(
    ...
    const KSRESOLUTION *Resolution,
    ULONG Flags
);

#endif /* (NTDDI_VERSION >= NTDDI_WINXP) */

KSDDKAPI void NTAPI KsFreeDefaultClock(
    PKSDEFAULTCLOCK DefaultClock
);

KSDDKAPI NTSTATUS NTAPI KsCreateDefaultClock(
    PIRP Irp,
    PKSDEFAULTCLOCK DefaultClock
);
...
KSDDKAPI KSSTATE NTAPI KsGetDefaultClockState(
    PKSDEFAULTCLOCK DefaultClock
);

KSDDKAPI void NTAPI KsSetDefaultClockState(
    PKSDEFAULTCLOCK DefaultClock,
    KSSTATE State
);

KSDDKAPI LONGLONG NTAPI KsGetDefaultClockTime(
    PKSDEFAULTCLOCK DefaultClock
);

KSDDKAPI void NTAPI KsSetDefaultClockTime(
    PKSDEFAULTCLOCK DefaultClock,
    LONGLONG Time
);
...
KSDDKAPI NTSTATUS NTAPI KsReferenceBusObject(
    KSDEVICE_HEADER Header
);

KSDDKAPI void NTAPI KsDereferenceBusObject(
    KSDEVICE_HEADER Header
);

KSDDKAPI NTSTATUS NTAPI KsDispatchQuerySecurity(
    PDEVICE_OBJECT DeviceObject,
    PIRP Irp
);

KSDDKAPI NTSTATUS NTAPI KsDispatchSetSecurity(
    PDEVICE_OBJECT DeviceObject,
    PIRP Irp
);

KSDDKAPI NTSTATUS NTAPI KsDispatchSpecificProperty(
    PIRP Irp,
    PFNKSHANDLER Handler
);

KSDDKAPI NTSTATUS NTAPI KsDispatchSpecificMethod(
    PIRP Irp,
    PFNKSHANDLER Handler
);
...
KSDDKAPI NTSTATUS NTAPI KsProbeStreamIrp(
    PIRP Irp,
    ULONG ProbeFlags,
    ULONG HeaderSize
);

KSDDKAPI NTSTATUS NTAPI KsAllocateExtraData(
    PIRP Irp,
    ULONG ExtraSize,
    PVOID *ExtraBuffer
);

KSDDKAPI void NTAPI KsNullDriverUnload(
...
KSDDKAPI NTSTATUS NTAPI KsDispatchIrp(
    PDEVICE_OBJECT DeviceObject,
    PIRP Irp
);
...
KSDDKAPI void NTAPI KsCancelIo(
    PLIST_ENTRY QueueHead,
    PKSPIN_LOCK SpinLock
);

KSDDKAPI void NTAPI KsReleaseIrpOnCancelableQueue(
    PIRP Irp,
...
KSDDKAPI void NTAPI KsRemoveSpecificIrpFromCancelableQueue(
    PIRP Irp
);
...
KSDDKAPI NTSTATUS NTAPI KsAcquireResetValue(
    PIRP Irp,
    KSRESET *ResetValue
);
...
KSDDKAPI void NTAPI KsUnregisterWorker(
    PKSWORKER Worker
);

KSDDKAPI NTSTATUS NTAPI KsQueueWorkItem(
    PKSWORKER Worker,
...
KSDDKAPI PKSDEVICE NTAPI KsGetDeviceForDeviceObject(
    PDEVICE_OBJECT FunctionalDeviceObject
);
...
KSDDKAPI void NTAPI KsReleaseDevice(
    PKSDEVICE Device
);
...
typedef struct _KSDEVICE_PROFILE_INFO KSDEVICE_PROFILE_INFO, *PKSDEVICE_PROFILE_INFO;

__drv_maxIRQL(PASSIVE_LEVEL)
KSDDKAPI NTSTATUS NTAPI KsInitializeDeviceProfile(
    PKSFILTERFACTORY FilterFactory
);

__drv_maxIRQL(PASSIVE_LEVEL)
KSDDKAPI NTSTATUS NTAPI KsPublishDeviceProfile(
    PKSFILTERFACTORY FilterFactory,
    PKSDEVICE_PROFILE_INFO Profile
);

__drv_maxIRQL(PASSIVE_LEVEL)
KSDDKAPI NTSTATUS NTAPI KsPersistDeviceProfile(
    PKSFILTERFACTORY FilterFactory
);

#endif /* (NTDDI_VERSION >= NTDDI_WINTHRESHOLD) */

KSDDKAPI void NTAPI KsAddEvent(
    PVOID Object,
    PKSEVENT_ENTRY EventEntry
);
...
KSDDKAPI void NTAPI KsStreamPointerUnlock(
    PKSSTREAM_POINTER StreamPointer,
    BOOLEAN Eject
);
...
KSDDKAPI NTSTATUS NTAPI KsPinHandshake(
    PKSPIN Pin,
    PKSHANDSHAKE In,
    PKSHANDSHAKE Out
);
...
KSDDKAPI KSOBJECTTYPE NTAPI KsGetObjectTypeFromIrp(
    PIRP Irp
);

KSDDKAPI PVOID NTAPI KsGetObjectFromFileObject(
    PFILE_OBJECT FileObject
);

KSDDKAPI KSOBJECTTYPE NTAPI KsGetObjectTypeFromFileObject(
    PFILE_OBJECT FileObject
);
...
KSDDKAPI void NTAPI KsFilterAttemptProcessing(
    PKSFILTER Filter,
    BOOLEAN Asynchronous
);

KSDDKAPI PKSGATE NTAPI KsPinGetAndGate(
    PKSPIN Pin
);

KSDDKAPI void NTAPI KsPinAttachAndGate(
    PKSPIN Pin,
    PKSGATE AndGate
);

KSDDKAPI void NTAPI KsPinAttachOrGate(
    PKSPIN Pin,
    PKSGATE OrGate
);
...
KSDDKAPI void NTAPI KsPinReleaseProcessingMutex(
    PKSPIN Pin
);
...
KSDDKAPI void NTAPI KsPinAttemptProcessing(
    PKSPIN Pin,
    BOOLEAN Asynchronous
);

KSDDKAPI PVOID NTAPI KsGetParent(
    PVOID Object
);
...
KSDDKAPI PKSFILTER NTAPI KsPinGetParentFilter(
    PKSPIN Pin
);
...
KSDDKAPI ULONG NTAPI KsFilterGetChildPinCount(
    PKSFILTER Filter,
    ULONG PinId
);

KSDDKAPI PKSPIN NTAPI KsFilterGetFirstChildPin(
    PKSFILTER Filter,
    ULONG PinId
);
...
KSDDKAPI PKSPIN NTAPI KsPinGetNextSiblingPin(
    PKSPIN Pin
);
...
KSDDKAPI ULONG NTAPI KsGetNodeIdFromIrp(
    PIRP Irp
);
...
KSDDKAPI void NTAPI KsReleaseControl(
    PVOID Object
);
...
KSDDKAPI NTSTATUS NTAPI KsAllocateObjectBag(
    PKSDEVICE Device,
    KSOBJECT_BAG* ObjectBag
);

KSDDKAPI void NTAPI KsFreeObjectBag(
    KSOBJECT_BAG ObjectBag
);

KSDDKAPI NTSTATUS NTAPI KsCopyObjectBagItems(
    KSOBJECT_BAG ObjectBagDestination,
    KSOBJECT_BAG ObjectBagSource
);
...
KSDDKAPI NTSTATUS NTAPI KsFilterCreatePinFactory(
    PKSFILTER Filter,
    const KSPIN_DESCRIPTOR_EX *const PinDescriptor,
    PULONG PinID
);
...
KSDDKAPI PFILE_OBJECT NTAPI KsPinGetConnectedPinFileObject(
    PKSPIN Pin
);

KSDDKAPI PDEVICE_OBJECT NTAPI KsPinGetConnectedPinDeviceObject(
    PKSPIN Pin
);
...
KSDDKAPI NTSTATUS NTAPI KsPinGetReferenceClockInterface(
    PKSPIN Pin,
    PIKSREFERENCECLOCK* Interface
);

#endif /* defined(_UNKNOWN_H_) || defined(__IUnknown_INTERFACE_DEFINED__) */

KSDDKAPI void NTAPI KsPinSetPinClockTime(
    PKSPIN Pin,
    LONGLONG Time
);
...
KSDDKAPI PUNKNOWN NTAPI KsGetOuterUnknown(
    PVOID Object
);
...
KSDDKAPI DWORD WINAPI KsCreateAllocator(
    HANDLE ConnectionHandle,
    PKSALLOCATOR_FRAMING AllocatorFraming,
    PHANDLE AllocatorHandle
);

KSDDKAPI DWORD NTAPI KsCreateClock(
    HANDLE ConnectionHandle,
    PKSCLOCK_CREATE ClockCreate,
    PHANDLE ClockHandle
);

KSDDKAPI DWORD WINAPI KsCreatePin(
    HANDLE FilterHandle,
    PKSPIN_CONNECT Connect,
    ACCESS_MASK DesiredAccess,
    PHANDLE ConnectionHandle
...
KSDDKAPI DWORD WINAPI KsCreateTopologyNode(
    HANDLE ParentHandle,
    PKSNODE_CREATE NodeCreate,
    ACCESS_MASK DesiredAccess,
    PHANDLE NodeHandle
...
typedef void (*PFNKSCANCELPINNEDMDL)(
    GUID,
    PVOID,
    PVOID
);

KSDDKAPI NTSTATUS WINAPI KsAcquireCachedMdl(
    PIRP Irp,
    REFGUID Guid,
...
KSDDKAPI NTSTATUS WINAPI KsReleaseCachedMdl(
    REFGUID Guid,
    PMDL MdlAddr,
