...
WINADVAPI BOOL WINAPI SaferGetPolicyInformation(
    DWORD dwScopeId,
...
WINADVAPI BOOL WINAPI SaferSetPolicyInformation(
    DWORD dwScopeId,
    SAFER_POLICY_INFO_CLASS SaferPolicyInfoClass,
    DWORD InfoBufferSize,
    PVOID InfoBuffer,
...
WINADVAPI BOOL WINAPI SaferCreateLevel(
    DWORD dwScopeId,
    DWORD dwLevelId,
    DWORD OpenFlags,
...
WINADVAPI BOOL WINAPI SaferCloseLevel(
    SAFER_LEVEL_HANDLE hLevelHandle
);

WINADVAPI BOOL WINAPI SaferIdentifyLevel(
...
WINADVAPI BOOL WINAPI SaferComputeTokenFromLevel(
...
WINADVAPI BOOL WINAPI SaferGetLevelInformation(
    SAFER_LEVEL_HANDLE LevelHandle,
...
WINADVAPI BOOL WINAPI SaferSetLevelInformation(
    SAFER_LEVEL_HANDLE LevelHandle,
    SAFER_OBJECT_INFO_CLASS dwInfoType,
    LPVOID lpQueryBuffer,
    DWORD dwInBufferSize
...
WINADVAPI BOOL WINAPI SaferRecordEventLogEntry(
    SAFER_LEVEL_HANDLE hLevel,
    LPCWSTR szTargetPath,
    LPVOID lpReserved
);

WINADVAPI BOOL WINAPI SaferiIsExecutableFileType(
