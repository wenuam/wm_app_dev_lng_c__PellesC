...
typedef struct ICertAdmin2Vtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *GetArchivedKey )(
        ...
        LONG RequestId,
        LONG Flags,
        BSTR *pstrArchivedKey);

    HRESULT (STDMETHODCALLTYPE *GetConfigEntry )(
        ICertAdmin2 *This,
        const BSTR strConfig,
        const BSTR strNodePath,
        const BSTR strEntryName,
        VARIANT *pvarEntry);
