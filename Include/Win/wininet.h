...
#define INTERNETAPIX(type)  EXTERN_C DECLSPEC_IMPORT type STDAPICALLTYPE
...
#ifndef BOOLAPI
#define BOOLAPI  INTERNETAPIX(BOOL)
#endif
...
INTERNETAPI_(DWORD) HttpIsHostHstsEnabled(
    PCWSTR pcwszUrl,
    PBOOL pfIsHsts
);
