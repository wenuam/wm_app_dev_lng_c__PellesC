...
#define REO_READWRITEMASK (0x000007FFL)
#define REO_CANROTATE  (0x00000080L)
...
#define REO_USEASBACKGROUND (0x00000400L)
#define REO_WRAPTEXTAROUND  (0x00000200L)
#define REO_ALIGNTORIGHT (0x00000100L)
