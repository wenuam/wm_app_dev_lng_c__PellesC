...
typedef DWORD (WINAPI *PCREATE_STATIC_SERVICE)(
    ULONG InterfaceIndex,
    PIPX_SERVER_ENTRY ServerEntry
);

typedef DWORD (WINAPI *PDELETE_STATIC_SERVICE)(ULONG InterfaceIndex,
    PIPX_SERVER_ENTRY ServerEntry
);
...
typedef DWORD (WINAPI *PGET_NEXT_SERVICE_FROM_ID)(
    ULONG ServiceID,
    PIPX_SERVICE NextService,
    PULONG NextServiceID
);
