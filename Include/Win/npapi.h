...
DWORD APIENTRY NPAddConnection(
...
DWORD APIENTRY NPAddConnection4(
    HWND hwndOwner,
    LPNETRESOURCEW lpNetResource,
    PVOID lpAuthBuffer,
    DWORD cbAuthBuffer,
...
DWORD APIENTRY NPCancelConnection(
    LPWSTR lpName,
    BOOL fForce
);
...
DWORD APIENTRY NPCancelConnection2(
    LPWSTR lpName,
    BOOL fForce,
    DWORD dwFlags
);
...
DWORD APIENTRY NPGetConnection3(
    LPCWSTR lpLocalName,
    DWORD dwLevel,
    LPVOID lpBuffer,
...
DWORD APIENTRY NPGetConnectionPerformance(
...
DWORD APIENTRY NPGetPersistentUseOptionsForConnection(
    LPWSTR lpRemotePath,
    LPBYTE lpReadUseOptions,
    DWORD cbReadUseOptions,
    LPBYTE lpWriteUseOptions,
    LPDWORD lpSizeWriteUseOptions
);
...
DWORD APIENTRY NPGetResourceParent(
    LPNETRESOURCEW lpNetResource,
    LPVOID lpBuffer,
    LPDWORD lpBufferSize
);
...
DWORD APIENTRY NPFormatNetworkName(
    LPWSTR lpRemoteName,
...
DWORD APIENTRY NPGetPropertyText(
    DWORD iButton,
    DWORD nPropSel,
    LPWSTR lpName,
    LPWSTR lpButtonName,
...
DWORD APIENTRY NPPropertyDialog(
    HWND hwndParent,
    DWORD iButtonDlg,
    DWORD nPropSel,
    LPWSTR lpFileName,
...
DWORD APIENTRY NPGetDirectoryType(
    LPWSTR lpName,
    LPINT lpType,
    BOOL bFlushCache
);
...
DWORD APIENTRY NPDirectoryNotify(
    HWND hwnd,
    LPWSTR lpDir,
    DWORD dwOper
);
...
DWORD APIENTRY AddConnectNotify(
...
DWORD APIENTRY NPFMXGetPermCaps(
    LPWSTR lpDriveName
);
...
DWORD APIENTRY NPFMXGetPermHelp(
    LPWSTR lpDriveName,
    DWORD nDialogType,
    BOOL fDirectory,
