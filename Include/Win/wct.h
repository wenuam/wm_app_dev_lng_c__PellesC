...
WINADVAPI HWCT WINAPI OpenThreadWaitChainSession(
    DWORD Flags,
    PWAITCHAINCALLBACK callback
);

WINADVAPI VOID WINAPI CloseThreadWaitChainSession(
    HWCT WctHandle
);
...
WINADVAPI BOOL WINAPI GetThreadWaitChain(
    HWCT WctHandle,
    DWORD_PTR Context,
    DWORD Flags,
    DWORD ThreadId,
...
WINADVAPI VOID WINAPI RegisterWaitChainCOMCallback(
