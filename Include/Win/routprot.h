...
typedef struct _SUPPORT_FUNCTIONS_50 {
    ...
    DWORD (WINAPI *DemandDialRequest)(
        DWORD ProtocolId,
    ...
    DWORD (WINAPI *MIBEntryCreate)(
        DWORD dwRoutingPid,
        DWORD dwEntrySize,
        LPVOID lpEntry
    );
    DWORD (WINAPI *MIBEntryDelete)(
        DWORD dwRoutingPid,
        DWORD dwEntrySize,
        LPVOID lpEntry
    );
    DWORD (WINAPI *MIBEntrySet)(
        DWORD dwRoutingPid,
        DWORD dwEntrySize,
        LPVOID lpEntry
    );
    ...
    BOOL (WINAPI *HasMulticastBoundary)(
        DWORD dwIfIndex,
...
typedef struct _SUPPORT_FUNCTIONS_60 {
    ...
    DWORD (WINAPI *ValidateRouteEx)(
        DWORD dwProtocolId,
        DWORD dwSubProtocolId,
        DWORD dwTransportId,
        PVOID pRouteInfo,
        GUID *pRoutingDomainId,
        PVOID pDestAddress
    );
    DWORD (WINAPI *GetRoutingDomainInfo)(
        GUID *pRoutingDomainId,
        DWORD dwRevision,
        DWORD dwBufSize,
        PVOID pRoutingDomainInfo
    );
    DWORD (WINAPI *GetInterfaceInformation)(
...
typedef DWORD (WINAPI *PPROTOCOL_ACTION)(
    DWORD ActionType,
    PVOID ActionInfo,
    DWORD ActionSize
);

typedef DWORD (WINAPI *PGET_ROUTING_DOMAIN_GLOBAL_INFO)(
    GUID *pRoutingDomainId,
    PVOID GlobalInfo,
    PULONG BufferSize,
    PULONG StructureVersion,
...
typedef DWORD (WINAPI *PSET_ROUTING_DOMAIN_GLOBAL_INFO)(
    GUID *pRoutingDomainId,
    PVOID GlobalInfo,
    ULONG StructureVersion,
    ULONG StructureSize,
...
typedef DWORD (WINAPI *PGET_PROTOCOL_STATISTICS)(
    DWORD InEntryType,
    PVOID InEntry,
    DWORD InEntrySize,
    DWORD OutEntryType,
...
typedef void (WINAPI *PPROTOCOL_BUFFER_FREE)(
    PVOID Ptr
);
