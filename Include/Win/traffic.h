...
ULONG APIENTRY TcRegisterClient(
    ULONG TciVersion,
    HANDLE ClRegCtx,
...
ULONG APIENTRY TcEnumerateInterfaces(
    HANDLE ClientHandle,
    PULONG pBufferSize,
    PTC_IFC_DESCRIPTOR InterfaceBuffer
);

ULONG APIENTRY TcOpenInterfaceA(
...
ULONG APIENTRY TcOpenInterfaceW(
    LPWSTR pInterfaceName,
    HANDLE ClientHandle,
    HANDLE ClIfcCtx,
    PHANDLE pIfcHandle
...
ULONG APIENTRY TcCloseInterface(
    HANDLE IfcHandle
);

ULONG APIENTRY TcQueryInterface(
    HANDLE IfcHandle,
    LPGUID pGuidParam,
...
ULONG APIENTRY TcGetFlowNameA(
    HANDLE FlowHandle,
    ULONG StrSize,
    LPSTR pFlowName
);

ULONG APIENTRY TcGetFlowNameW(
    HANDLE FlowHandle,
    ULONG StrSize,
    LPWSTR pFlowName
);

ULONG APIENTRY TcModifyFlow(
    HANDLE FlowHandle,
    PTC_GEN_FLOW pGenericFlow
);

ULONG APIENTRY TcAddFilter(
    HANDLE FlowHandle,
    PTC_GEN_FILTER pGenericFilter,
    PHANDLE pFilterHandle
);

ULONG APIENTRY TcDeregisterClient(
    HANDLE ClientHandle
);

ULONG APIENTRY TcDeleteFlow(
    HANDLE FlowHandle
);

ULONG APIENTRY TcDeleteFilter(
    HANDLE FilterHandle
);

ULONG APIENTRY TcEnumerateFlows(
    HANDLE IfcHandle,
    PHANDLE pEnumHandle,
    PULONG pFlowCount,
    PULONG pBufSize,
