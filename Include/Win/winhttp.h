...
#define WINHTTP_FLAG_AUTOMATIC_CHUNKING    0x00000200
...
#define WINHTTP_PROXY_TYPE_DIRECT             0x00000001
#define WINHTTP_PROXY_TYPE_PROXY              0x00000002
#define WINHTTP_PROXY_TYPE_AUTO_PROXY_URL     0x00000004
#define WINHTTP_PROXY_TYPE_AUTO_DETECT        0x00000008
...
WINHTTPAPI WINHTTP_STATUS_CALLBACK WINAPI WinHttpSetStatusCallback(
    HINTERNET hInternet,
...
WINHTTPAPI BOOL WINAPI WinHttpTimeFromSystemTime(
    CONST SYSTEMTIME *pst,
    LPWSTR pwszTime
);

WINHTTPAPI BOOL WINAPI WinHttpTimeToSystemTime(
    LPCWSTR pwszTime,
    SYSTEMTIME *pst
);

WINHTTPAPI BOOL WINAPI WinHttpCrackUrl(
    LPCWSTR pwszUrl,
    DWORD dwUrlLength,
    DWORD dwFlags,
...
WINHTTPAPI BOOL WINAPI WinHttpCreateUrl(
    LPURL_COMPONENTS lpUrlComponents,
    DWORD dwFlags,
    LPWSTR pwszUrl,
...
WINHTTPAPI BOOL WINAPI WinHttpSetDefaultProxyConfiguration(WINHTTP_PROXY_INFO *pProxyInfo);
...
WINHTTPAPI BOOL WINAPI WinHttpCloseHandle(
    HINTERNET hInternet
);
...
WINHTTPAPI BOOL WINAPI WinHttpReadData(
    HINTERNET hRequest,
    LPVOID lpBuffer,
...
WINHTTPAPI DWORD WINAPI WinHttpReadDataEx(
    HINTERNET hRequest,
    LPVOID lpBuffer,
    DWORD dwNumberOfBytesToRead,
    LPDWORD lpdwNumberOfBytesRead,
...
WINHTTPAPI BOOL WINAPI WinHttpWriteData(
    HINTERNET hRequest,
    LPCVOID lpBuffer,
...
WINHTTPAPI BOOL WINAPI WinHttpQueryDataAvailable(
    HINTERNET hRequest,
    LPDWORD lpdwNumberOfBytesAvailable
);

WINHTTPAPI BOOL WINAPI WinHttpQueryOption(
    HINTERNET hInternet,
    DWORD dwOption,
    LPVOID lpBuffer,
...
WINHTTPAPI BOOL WINAPI WinHttpSetOption(
    HINTERNET hInternet,
    DWORD dwOption,
    LPVOID lpBuffer,
...
WINHTTPAPI BOOL WINAPI WinHttpSetTimeouts(
    HINTERNET hInternet,
    int nResolveTimeout,
    int nConnectTimeout,
    int nSendTimeout,
...
WINHTTPAPI DWORD WINAPI WinHttpIsHostInProxyBypassList(
...
WINHTTPAPI BOOL WINAPI WinHttpAddRequestHeaders(
    HINTERNET hRequest,
    LPCWSTR lpszHeaders,
...
WINHTTPAPI DWORD WINAPI WinHttpAddRequestHeadersEx(
    HINTERNET hRequest,
    DWORD dwModifiers,
    ULONGLONG ullFlags,
    ULONGLONG ullExtra,
...
WINHTTPAPI BOOL WINAPI WinHttpSendRequest(
    HINTERNET hRequest,
    LPCWSTR lpszHeaders,
    DWORD dwHeadersLength,
    LPVOID lpOptional,
...
WINHTTPAPI BOOL WINAPI WinHttpSetCredentials(
    HINTERNET hRequest,
    DWORD AuthTargets,
    DWORD AuthScheme,
...
WINHTTPAPI BOOL WINAPI WinHttpQueryAuthSchemes(
    HINTERNET hRequest,
...
WINHTTPAPI BOOL WINAPI WinHttpQueryAuthParams(
    HINTERNET hRequest,
    DWORD AuthScheme,
    LPVOID *pAuthParams
);
...
WINHTTPAPI BOOL WINAPI WinHttpReceiveResponse(
    HINTERNET hRequest,
    LPVOID lpReserved
);

WINHTTPAPI BOOL WINAPI WinHttpQueryHeaders(
    HINTERNET hRequest,
    DWORD dwInfoLevel,
    LPCWSTR pwszName,
    LPVOID lpBuffer,
...
WINHTTPAPI DWORD WINAPI WinHttpQueryHeadersEx(
    HINTERNET hRequest,
    DWORD dwInfoLevel,
    ULONGLONG ullFlags,
    UINT uiCodePage,
...
WINHTTPAPI DWORD WINAPI WinHttpQueryConnectionGroup(
    HINTERNET hInternet,
...
WINHTTPAPI void WINAPI WinHttpFreeQueryConnectionGroupResult(
...
WINHTTPAPI BOOL WINAPI WinHttpDetectAutoProxyConfigUrl(
    DWORD dwAutoDetectFlags,
    LPWSTR *ppwstrAutoConfigUrl
);

WINHTTPAPI BOOL WINAPI WinHttpGetProxyForUrl(
    HINTERNET hSession,
    LPCWSTR lpcwszUrl,
...
WINHTTPAPI DWORD WINAPI WinHttpCreateProxyResolver(
    HINTERNET hSession,
    HINTERNET *phResolver
);

WINHTTPAPI DWORD WINAPI WinHttpGetProxyForUrlEx(
    HINTERNET hResolver,
    PCWSTR pcwszUrl,
    WINHTTP_AUTOPROXY_OPTIONS *pAutoProxyOptions,
    DWORD_PTR pContext
...
WINHTTPAPI DWORD WINAPI WinHttpGetProxyForUrlEx2(
    HINTERNET hResolver,
    PCWSTR pcwszUrl,
    WINHTTP_AUTOPROXY_OPTIONS *pAutoProxyOptions,
...
WINHTTPAPI DWORD WINAPI WinHttpGetProxyResult(
    HINTERNET hResolver,
    WINHTTP_PROXY_RESULT *pProxyResult
);

WINHTTPAPI DWORD WINAPI WinHttpGetProxyResultEx(
    HINTERNET hResolver,
    WINHTTP_PROXY_RESULT_EX *pProxyResultEx
);

WINHTTPAPI void WINAPI WinHttpFreeProxyResult(
    WINHTTP_PROXY_RESULT *pProxyResult
);

WINHTTPAPI void WINAPI WinHttpFreeProxyResultEx(
    WINHTTP_PROXY_RESULT_EX *pProxyResultEx
);

WINHTTPAPI DWORD WINAPI WinHttpResetAutoProxy(
    HINTERNET hSession,
    DWORD dwFlags
);

WINHTTPAPI BOOL WINAPI WinHttpGetIEProxyConfigForCurrentUser(
    WINHTTP_CURRENT_USER_IE_PROXY_CONFIG *pProxyConfig
);

WINHTTPAPI DWORD WINAPI WinHttpWriteProxySettings(
    HINTERNET hSession,
    BOOL fForceUpdate,
    WINHTTP_PROXY_SETTINGS *pWinHttpProxySettings
);

WINHTTPAPI DWORD WINAPI WinHttpReadProxySettings(
    HINTERNET hSession,
...
WINHTTPAPI void WINAPI WinHttpFreeProxySettings(
    WINHTTP_PROXY_SETTINGS *pWinHttpProxySettings
);

WINHTTPAPI DWORD WINAPI WinHttpGetProxySettingsVersion(
    HINTERNET hSession,
    DWORD *pdwProxySettingsVersion
);

WINHTTPAPI DWORD WINAPI WinHttpSetProxySettingsPerUser(
...
WINHTTPAPI HINTERNET WINAPI WinHttpWebSocketCompleteUpgrade(
    HINTERNET hRequest,
    DWORD_PTR pContext
);

WINHTTPAPI DWORD WINAPI WinHttpWebSocketSend(
...
WINHTTPAPI DWORD WINAPI WinHttpWebSocketReceive(
    HINTERNET hWebSocket,
    PVOID pvBuffer,
    DWORD dwBufferLength,
    DWORD *pdwBytesRead,
...
WINHTTPAPI DWORD WINAPI WinHttpWebSocketShutdown(
    HINTERNET hWebSocket,
    USHORT usStatus,
    PVOID pvReason,
...
WINHTTPAPI DWORD WINAPI WinHttpWebSocketClose(
    HINTERNET hWebSocket,
    USHORT usStatus,
    PVOID pvReason,
    DWORD dwReasonLength
...
WINHTTPAPI DWORD WINAPI WinHttpWebSocketQueryCloseStatus(
    HINTERNET hWebSocket,
    USHORT *pusStatus,
    PVOID pvReason,
    DWORD dwReasonLength,
...
typedef void (CALLBACK *WINHTTP_PROXY_CHANGE_CALLBACK)(
    ULONGLONG ullFlags,
    PVOID pvContext
);
...
WINHTTPAPI DWORD WINAPI WinHttpRegisterProxyChangeNotification(
    ULONGLONG ullFlags,
...
WINHTTPAPI DWORD WINAPI WinHttpUnregisterProxyChangeNotification(
    WINHTTP_PROXY_CHANGE_REGISTRATION_HANDLE hRegistration
);
...
WINHTTPAPI DWORD WINAPI WinHttpGetProxySettingsEx(
    HINTERNET hResolver,
...
WINHTTPAPI DWORD WINAPI WinHttpGetProxySettingsResultEx(
    HINTERNET hResolver,
    PVOID pProxySettingsEx
);

WINHTTPAPI DWORD WINAPI WinHttpFreeProxySettingsEx(
    WINHTTP_PROXY_SETTINGS_TYPE ProxySettingsType,
    PVOID pProxySettingsEx
);
