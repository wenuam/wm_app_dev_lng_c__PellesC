...
#else /* (_WIN32_WINNT < _WIN32_WINNT_WS03) */
...
#if !defined(_MMSYSTEM_H) && (!defined(NOVIDEO) || !defined(NOAVICAP))
#include <mmsystem.h>
#endif /* !defined(_MMSYSTEM_H) && (!defined(NOVIDEO) || !defined(NOAVICAP)) */
...
#if __POCC__ >= 0x100
#pragma ref dwICValue
#endif /* __POCC__ >= 0x100 */
...
static inline LRESULT VFWAPI_INLINE ICDecompressEx(
    HIC hic,
    DWORD dwFlags,
    LPBITMAPINFOHEADER lpbiSrc,
    LPVOID lpSrc,
...
static inline LRESULT VFWAPI_INLINE ICDecompressExBegin(
    HIC hic,
    DWORD dwFlags,
    LPBITMAPINFOHEADER lpbiSrc,
    LPVOID lpSrc,
...
static inline LRESULT VFWAPI_INLINE ICDecompressExQuery(
    HIC hic,
    DWORD dwFlags,
    LPBITMAPINFOHEADER lpbiSrc,
    LPVOID lpSrc,
...
static inline LRESULT VFWAPI_INLINE ICDrawSuggestFormat(
    HIC hic,
    LPBITMAPINFOHEADER lpbiIn,
...
static inline LRESULT VFWAPI_INLINE ICSetStatusProc(
    HIC hic,
    DWORD dwFlags,
    LRESULT lParam,
...
extern LPVOID VFWAPI DrawDibGetBuffer(
    HDRAWDIB hdd,
    LPBITMAPINFOHEADER lpbi,
    DWORD dwSize,
    DWORD dwFlags
...
extern BOOL VFWAPI DrawDibSetPalette(
    HDRAWDIB hdd,
    HPALETTE hpal
);

extern BOOL VFWAPI DrawDibChangePalette(
    HDRAWDIB hdd,
    int iStart,
    int iLen,
    LPPALETTEENTRY lppe
...
extern UINT VFWAPI DrawDibRealize(
    HDRAWDIB hdd,
    HDC hdc,
    BOOL fBackground
);

extern BOOL VFWAPI DrawDibStart(
    HDRAWDIB hdd,
    DWORD rate
);

extern BOOL VFWAPI DrawDibStop(
    HDRAWDIB hdd
);

extern BOOL VFWAPI DrawDibBegin(
    HDRAWDIB hdd,
    HDC hdc,
    int dxDst,
    int dyDst,
...
extern BOOL VFWAPI DrawDibDraw(
    HDRAWDIB hdd,
    HDC hdc,
    int xDst,
    int yDst,
...
EXTERN_C HRESULT CDECL AVISaveA(
    LPCSTR szFile,
    CLSID *pclsidHandler,
...
EXTERN_C HRESULT CDECL AVISaveW(
    LPCWSTR szFile,
    CLSID *pclsidHandler,
    AVISAVECALLBACK lpfnCallback,
    int nStreams,
...
STDAPI_(INT_PTR) AVISaveOptions(
    HWND hwnd,
    UINT uiFlags,
    int nStreams,
    PAVISTREAM *ppavi,
...
#endif /* !defined(NOAVICAP) || !defined(NOVIDEO) */
