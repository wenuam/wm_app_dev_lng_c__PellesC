...
/* ApiSet contract for api-ms-win-appmodel-runtime-l1 */
...
WINBASEAPI LONG WINAPI GetCurrentPackageId(
    UINT32 * bufferLength,
    BYTE * buffer
);

WINBASEAPI LONG WINAPI GetCurrentPackageFullName(
...
WINBASEAPI LONG WINAPI GetCurrentPackagePath(
    UINT32 * pathLength,
    PWSTR path
);

WINBASEAPI LONG WINAPI GetPackageId(
    HANDLE hProcess,
    UINT32 * bufferLength,
    BYTE * buffer
);

WINBASEAPI LONG WINAPI GetPackageFullName(
    HANDLE hProcess,
    UINT32 * packageFullNameLength,
    PWSTR packageFullName
);

WINBASEAPI LONG WINAPI GetPackageFullNameFromToken(
    HANDLE token,
    UINT32 * packageFullNameLength,
    PWSTR packageFullName
);

WINBASEAPI LONG WINAPI GetPackageFamilyName(
    HANDLE hProcess,
    UINT32 * packageFamilyNameLength,
    PWSTR packageFamilyName
);

WINBASEAPI LONG WINAPI GetPackageFamilyNameFromToken(
    HANDLE token,
    UINT32 * packageFamilyNameLength,
    PWSTR packageFamilyName
);

WINBASEAPI LONG WINAPI GetPackagePath(
...
WINBASEAPI LONG WINAPI GetPackagePathByFullName(
    PCWSTR packageFullName,
    UINT32 * pathLength,
    PWSTR path
);

WINBASEAPI LONG WINAPI GetStagedPackagePathByFullName(
    PCWSTR packageFullName,
    UINT32 * pathLength,
    PWSTR path
);
...
WINBASEAPI LONG WINAPI GetPackagePathByFullName2(
    PCWSTR packageFullName,
...
WINBASEAPI LONG WINAPI GetStagedPackagePathByFullName2(
    PCWSTR packageFullName,
    PackagePathType packagePathType,
    UINT32 * pathLength,
    PWSTR path
...
WINBASEAPI LONG WINAPI GetCurrentPackageInfo2(
    const UINT32 flags,
    PackagePathType packagePathType,
    UINT32 * bufferLength,
    BYTE * buffer,
...
WINBASEAPI LONG WINAPI GetCurrentPackagePath2(
    PackagePathType packagePathType,
    UINT32 * pathLength,
    PWSTR path
);
...
WINBASEAPI LONG WINAPI GetCurrentApplicationUserModelId(
    UINT32 * applicationUserModelIdLength,
    PWSTR applicationUserModelId
);

WINBASEAPI LONG WINAPI GetApplicationUserModelId(
    HANDLE hProcess,
    UINT32 * applicationUserModelIdLength,
    PWSTR applicationUserModelId
);

WINBASEAPI LONG WINAPI GetApplicationUserModelIdFromToken(
    HANDLE token,
    UINT32 * applicationUserModelIdLength,
    PWSTR applicationUserModelId
);

WINBASEAPI LONG WINAPI VerifyPackageFullName(
    PCWSTR packageFullName
);

WINBASEAPI LONG WINAPI VerifyPackageFamilyName(
    PCWSTR packageFamilyName
);

WINBASEAPI LONG WINAPI VerifyPackageId(
    const PACKAGE_ID * packageId
);

WINBASEAPI LONG WINAPI VerifyApplicationUserModelId(
    PCWSTR applicationUserModelId
);

WINBASEAPI LONG WINAPI VerifyPackageRelativeApplicationId(
    PCWSTR packageRelativeApplicationId
);

WINBASEAPI LONG WINAPI PackageIdFromFullName(
    PCWSTR packageFullName,
    const UINT32 flags,
    UINT32 * bufferLength,
    BYTE * buffer
...
WINBASEAPI LONG WINAPI PackageFamilyNameFromId(
    const PACKAGE_ID * packageId,
    UINT32 * packageFamilyNameLength,
    PWSTR packageFamilyName
);

WINBASEAPI LONG WINAPI PackageFamilyNameFromFullName(
    PCWSTR packageFullName,
    UINT32 * packageFamilyNameLength,
    PWSTR packageFamilyName
);
...
WINBASEAPI LONG WINAPI FormatApplicationUserModelId(
    PCWSTR packageFamilyName,
    PCWSTR packageRelativeApplicationId,
    UINT32 * applicationUserModelIdLength,
    PWSTR applicationUserModelId
...
WINBASEAPI LONG WINAPI GetPackagesByPackageFamily(
    PCWSTR packageFamilyName,
    UINT32 * count,
...
WINBASEAPI LONG WINAPI FindPackagesByPackageFamily(
    PCWSTR packageFamilyName,
...
WINBASEAPI LONG WINAPI GetStagedPackageOrigin(
    PCWSTR packageFullName,
...
WINBASEAPI LONG WINAPI GetCurrentPackageInfo(
    const UINT32 flags,
    UINT32 * bufferLength,
    BYTE * buffer,
    UINT32 * count
...
WINBASEAPI LONG WINAPI OpenPackageInfoByFullName(
    PCWSTR packageFullName,
    const UINT32 reserved,
    PACKAGE_INFO_REFERENCE * packageInfoReference
);

WINBASEAPI LONG WINAPI OpenPackageInfoByFullNameForUser(
    PSID userSid,
    PCWSTR packageFullName,
    const UINT32 reserved,
    PACKAGE_INFO_REFERENCE * packageInfoReference
...
WINBASEAPI LONG WINAPI ClosePackageInfo(
    PACKAGE_INFO_REFERENCE packageInfoReference
);

WINBASEAPI LONG WINAPI GetPackageInfo(
    PACKAGE_INFO_REFERENCE packageInfoReference,
    const UINT32 flags,
    UINT32 * bufferLength,
    BYTE * buffer,
...
WINBASEAPI LONG WINAPI GetPackageApplicationIds(
    PACKAGE_INFO_REFERENCE packageInfoReference,
    UINT32 * bufferLength,
    BYTE * buffer,
    UINT32 * count
...
#if NTDDI_VERSION >= NTDDI_WIN10_19H1
WINBASEAPI LONG WINAPI GetPackageInfo2(
    PACKAGE_INFO_REFERENCE packageInfoReference,
    const UINT32 flags,
    PackagePathType packagePathType,
    UINT32 * bufferLength,
...
WINBASEAPI HRESULT WINAPI CheckIsMSIXPackage(
    PCWSTR packageFullName,
    BOOL * isMSIXPackage
);
...
WINBASEAPI HRESULT WINAPI TryCreatePackageDependency(
    PSID user,
    PCWSTR packageFamilyName,
...
WINBASEAPI HRESULT WINAPI DeletePackageDependency(
    PCWSTR packageDependencyId
);

WINBASEAPI HRESULT WINAPI AddPackageDependency(
    PCWSTR packageDependencyId,
    INT32 rank,
...
WINBASEAPI HRESULT WINAPI RemovePackageDependency(
    PACKAGEDEPENDENCY_CONTEXT packageDependencyContext
);

WINBASEAPI HRESULT WINAPI GetResolvedPackageFullNameForPackageDependency(
    PCWSTR packageDependencyId,
    PWSTR * packageFullName
);

WINBASEAPI HRESULT WINAPI GetIdForPackageDependencyContext(
    PACKAGEDEPENDENCY_CONTEXT packageDependencyContext,
    PWSTR * packageDependencyId
);
...
WINBASEAPI LONG WINAPI AppPolicyGetLifecycleManagement(
    HANDLE processToken,
...
WINBASEAPI LONG WINAPI AppPolicyGetWindowingModel(
    HANDLE processToken,
...
WINBASEAPI LONG WINAPI AppPolicyGetMediaFoundationCodecLoading(
    HANDLE processToken,
...
WINBASEAPI LONG WINAPI AppPolicyGetClrCompat(
    HANDLE processToken,
...
WINBASEAPI LONG WINAPI AppPolicyGetThreadInitializationType(
    HANDLE processToken,
...
WINBASEAPI LONG WINAPI AppPolicyGetShowDeveloperDiagnostic(
    HANDLE processToken,
...
WINBASEAPI LONG WINAPI AppPolicyGetProcessTerminationMethod(
    HANDLE processToken,
...
WINBASEAPI LONG WINAPI AppPolicyGetCreateFileAccess(
    HANDLE processToken,
