...
#ifndef _LMLOCALGROUP_H
#define _LMLOCALGROUP_H
...
#endif /* !defined(_WINBASE_H) && !defined(_FILETIME_) */
...
NET_API_STATUS NET_API_FUNCTION I_NetLogonControl(
	LPCWSTR ServerName,
	DWORD FunctionCode,
	DWORD QueryLevel,
	LPBYTE *Buffer
