...
typedef struct IADsComputerVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *put_OperatingSystemVersion )(
        IADsComputer * This,
        BSTR bstrOperatingSystemVersion);
