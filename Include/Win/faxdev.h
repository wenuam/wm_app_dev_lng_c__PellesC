...
typedef BOOL (CALLBACK *PFAX_SERVICE_CALLBACK)(
    HANDLE FaxHandle,
    DWORD DeviceId,
    DWORD_PTR Param1,
    DWORD_PTR Param2,
...
typedef void (CALLBACK *PFAX_LINECALLBACK)(
    HANDLE FaxHandle,
    DWORD hDevice,
    DWORD dwMessage,
...
typedef BOOL (CALLBACK *PFAX_SEND_CALLBACK)(
    HANDLE FaxHandle,
    HCALL CallHandle,
    DWORD Reserved1,
    DWORD Reserved2
...
BOOL WINAPI FaxDevConfigure(
    HPROPSHEETPAGE *PropSheetPage
);

typedef BOOL (WINAPI *PFAXDEVINITIALIZE)(HLINEAPP, HANDLE, PFAX_LINECALLBACK *, PFAX_SERVICE_CALLBACK);
typedef BOOL (WINAPI *PFAXDEVVIRTUALDEVICECREATION)(
    LPDWORD DeviceCount,
    LPWSTR DeviceNamePrefix,
    LPDWORD DeviceIdPrefix,
    HANDLE CompletionPort,
