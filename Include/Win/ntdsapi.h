...
#ifndef _NTDSAPI_POSTXP_ASLIB_
#define NTDSAPI_POSTXP  DECLSPEC_IMPORT
#else /* _NTDSAPI_POSTXP_ASLIB_ */
#define NTDSAPI_POSTXP
#endif /* _NTDSAPI_POSTXP_ASLIB_ */
...
#define NTDSDSA_OPT_BLOCK_RPC                   (1 << 6)
...
NTDSAPI DWORD WINAPI DsBindA(
    LPCSTR DomainControllerName,
    LPCSTR DnsDomainName,
    HANDLE *phDS
);
NTDSAPI DWORD WINAPI DsBindW(
...
NTDSAPI DWORD WINAPI DsBindWithCredA(
    LPCSTR DomainControllerName,
    LPCSTR DnsDomainName,
    RPC_AUTH_IDENTITY_HANDLE AuthIdentity,
    HANDLE *phDS
);
NTDSAPI DWORD WINAPI DsBindWithCredW(
    LPCWSTR DomainControllerName,
    LPCWSTR DnsDomainName,
    RPC_AUTH_IDENTITY_HANDLE AuthIdentity,
    HANDLE *phDS
...
NTDSAPI DWORD WINAPI DsBindWithSpnA(
    LPCSTR DomainControllerName,
    LPCSTR DnsDomainName,
    RPC_AUTH_IDENTITY_HANDLE AuthIdentity,
...
NTDSAPI DWORD WINAPI DsBindWithSpnW(
    LPCWSTR DomainControllerName,
    LPCWSTR DnsDomainName,
    RPC_AUTH_IDENTITY_HANDLE AuthIdentity,
...
NTDSAPI_POSTXP DWORD WINAPI DsBindWithSpnExA(
    LPCSTR DomainControllerName,
    LPCSTR DnsDomainName,
    RPC_AUTH_IDENTITY_HANDLE AuthIdentity,
    LPCSTR ServicePrincipalName,
...
NTDSAPI_POSTXP DWORD WINAPI DsBindWithSpnExW(
    LPCWSTR DomainControllerName,
    LPCWSTR DnsDomainName,
    RPC_AUTH_IDENTITY_HANDLE AuthIdentity,
    LPCWSTR ServicePrincipalName,
...
NTDSAPI_POSTXP DWORD WINAPI DsBindByInstanceA(
    LPCSTR ServerName,
    LPCSTR Annotation,
    GUID *InstanceGuid,
    LPCSTR DnsDomainName,
...
NTDSAPI_POSTXP DWORD WINAPI DsBindByInstanceW(
    LPCWSTR ServerName,
    LPCWSTR Annotation,
    GUID *InstanceGuid,
    LPCWSTR DnsDomainName,
...
NTDSAPI_POSTXP DWORD WINAPI DsBindToISTGA(
    LPCSTR SiteName,
    HANDLE *phDS
);
NTDSAPI_POSTXP DWORD WINAPI DsBindToISTGW(
    LPCWSTR SiteName,
    HANDLE *phDS
);
#ifdef UNICODE
...
NTDSAPI_POSTXP DWORD WINAPI DsBindingSetTimeout(
    HANDLE hDS,
    ULONG cTimeoutSecs
);

NTDSAPI DWORD WINAPI DsUnBindA(
    HANDLE *phDS
);
NTDSAPI DWORD WINAPI DsUnBindW(
    HANDLE *phDS
);
#ifdef UNICODE
...
NTDSAPI DWORD WINAPI DsMakePasswordCredentialsA(
    LPCSTR User,
    LPCSTR Domain,
    LPCSTR Password,
    RPC_AUTH_IDENTITY_HANDLE *pAuthIdentity
);
NTDSAPI DWORD WINAPI DsMakePasswordCredentialsW(
    LPCWSTR User,
    LPCWSTR Domain,
    LPCWSTR Password,
    RPC_AUTH_IDENTITY_HANDLE *pAuthIdentity
...
NTDSAPI void WINAPI DsFreePasswordCredentials(
    RPC_AUTH_IDENTITY_HANDLE AuthIdentity
);
...
NTDSAPI DWORD WINAPI DsCrackNamesA(
    HANDLE hDS,
    DS_NAME_FLAGS flags,
...
NTDSAPI DWORD WINAPI DsCrackNamesW(
    HANDLE hDS,
    DS_NAME_FLAGS flags,
    DS_NAME_FORMAT formatOffered,
    DS_NAME_FORMAT formatDesired,
...
NTDSAPI void WINAPI DsFreeNameResultA(
    DS_NAME_RESULTA *pResult
);
NTDSAPI void WINAPI DsFreeNameResultW(
...
NTDSAPI DWORD WINAPI DsGetSpnA(
...
NTDSAPI DWORD WINAPI DsGetSpnW(
    DS_SPN_NAME_TYPE ServiceType,
    LPCWSTR ServiceClass,
    LPCWSTR ServiceName,
    USHORT InstancePort,
    USHORT cInstanceNames,
    LPCWSTR *pInstanceNames,
    const USHORT *pInstancePorts,
    DWORD *pcSpn,
    LPWSTR **prpszSpn
);
...
NTDSAPI void WINAPI DsFreeSpnArrayA(
    DWORD cSpn,
    LPSTR *rpszSpn
);
NTDSAPI void WINAPI DsFreeSpnArrayW(
    DWORD cSpn,
    LPWSTR *rpszSpn
);
#ifdef UNICODE
...
NTDSAPI DWORD WINAPI DsWriteAccountSpnA(
    HANDLE hDS,
...
NTDSAPI DWORD WINAPI DsWriteAccountSpnW(
    HANDLE hDS,
    DS_SPN_WRITE_OP Operation,
    LPCWSTR pszAccount,
    DWORD cSpn,
...
NTDSAPI DWORD WINAPI DsClientMakeSpnForTargetServerA(
    LPCSTR ServiceClass,
    LPCSTR ServiceName,
    DWORD *pcSpnLength,
    LPSTR pszSpn
);
NTDSAPI DWORD WINAPI DsClientMakeSpnForTargetServerW(
    LPCWSTR ServiceClass,
    LPCWSTR ServiceName,
    DWORD *pcSpnLength,
    LPWSTR pszSpn
...
NTDSAPI DWORD WINAPI DsServerRegisterSpnA(
    DS_SPN_WRITE_OP Operation,
    LPCSTR ServiceClass,
    LPCSTR UserObjectDN
);
NTDSAPI DWORD WINAPI DsServerRegisterSpnW(
    DS_SPN_WRITE_OP Operation,
    LPCWSTR ServiceClass,
...
NTDSAPI DWORD WINAPI DsReplicaSyncA(
    HANDLE hDS,
    LPCSTR NameContext,
...
NTDSAPI DWORD WINAPI DsReplicaAddA(
    HANDLE hDS,
    LPCSTR NameContext,
    LPCSTR SourceDsaDn,
    LPCSTR TransportDn,
    LPCSTR SourceDsaAddress,
    const PSCHEDULE pSchedule,
    DWORD Options
);
NTDSAPI DWORD WINAPI DsReplicaAddW(
    HANDLE hDS,
    LPCWSTR NameContext,
    LPCWSTR SourceDsaDn,
    LPCWSTR TransportDn,
...
NTDSAPI DWORD WINAPI DsReplicaDelA(
    HANDLE hDS,
    LPCSTR NameContext,
    LPCSTR DsaSrc,
    ULONG Options
);
NTDSAPI DWORD WINAPI DsReplicaDelW(
    HANDLE hDS,
    LPCWSTR NameContext,
    LPCWSTR DsaSrc,
    ULONG Options
...
NTDSAPI DWORD WINAPI DsReplicaModifyA(
    HANDLE hDS,
    LPCSTR NameContext,
...
NTDSAPI DWORD WINAPI DsReplicaModifyW(
    HANDLE hDS,
    LPCWSTR NameContext,
    const UUID *pUuidSourceDsa,
    LPCWSTR TransportDn,
...
NTDSAPI DWORD WINAPI DsReplicaUpdateRefsA(
    HANDLE hDS,
    LPCSTR NameContext,
    LPCSTR DsaDest,
...
NTDSAPI DWORD WINAPI DsReplicaUpdateRefsW(
    HANDLE hDS,
    LPCWSTR NameContext,
    LPCWSTR DsaDest,
    const UUID *pUuidDsaDest,
...
NTDSAPI DWORD WINAPI DsReplicaSyncAllA(
    HANDLE hDS,
...
NTDSAPI DWORD WINAPI DsReplicaSyncAllW(
    HANDLE hDS,
...
NTDSAPI DWORD WINAPI DsRemoveDsServerA(
    HANDLE hDs,
    LPSTR ServerDN,
    LPSTR DomainDN,
...
NTDSAPI DWORD WINAPI DsRemoveDsServerW(
    HANDLE hDs,
    LPWSTR ServerDN,
    LPWSTR DomainDN,
    BOOL *fLastDcInDomain,
...
NTDSAPI DWORD WINAPI DsRemoveDsDomainA(
    HANDLE hDs,
    LPSTR DomainDN
);
NTDSAPI DWORD WINAPI DsRemoveDsDomainW(
    HANDLE hDs,
    LPWSTR DomainDN
);
#ifdef UNICODE
...
NTDSAPI DWORD WINAPI DsListSitesA(
    HANDLE hDs,
    PDS_NAME_RESULTA *ppSites
);
NTDSAPI DWORD WINAPI DsListSitesW(
    HANDLE hDs,
...
NTDSAPI DWORD WINAPI DsListServersInSiteA(
    HANDLE hDs,
    LPCSTR site,
    PDS_NAME_RESULTA *ppServers
);
NTDSAPI DWORD WINAPI DsListServersInSiteW(
    HANDLE hDs,
    LPCWSTR site,
...
NTDSAPI DWORD WINAPI DsListDomainsInSiteA(
    HANDLE hDs,
    LPCSTR site,
    PDS_NAME_RESULTA *ppDomains
);
NTDSAPI DWORD WINAPI DsListDomainsInSiteW(
    HANDLE hDs,
    LPCWSTR site,
...
NTDSAPI DWORD WINAPI DsListServersForDomainInSiteA(
    HANDLE hDs,
    LPCSTR domain,
    LPCSTR site,
    PDS_NAME_RESULTA *ppServers
);
NTDSAPI DWORD WINAPI DsListServersForDomainInSiteW(
    HANDLE hDs,
    LPCWSTR domain,
    LPCWSTR site,
    PDS_NAME_RESULTW *ppServers
...
NTDSAPI DWORD WINAPI DsListInfoForServerA(
    HANDLE hDs,
    LPCSTR server,
    PDS_NAME_RESULTA *ppInfo
);
NTDSAPI DWORD WINAPI DsListInfoForServerW(
    HANDLE hDs,
    LPCWSTR server,
...
NTDSAPI DWORD WINAPI DsListRolesA(
    HANDLE hDs,
    PDS_NAME_RESULTA *ppRoles
);
NTDSAPI DWORD WINAPI DsListRolesW(
    HANDLE hDs,
...
NTDSAPI_POSTXP DWORD WINAPI DsQuerySitesByCostA(
    HANDLE hDS,
    LPSTR pszFromSite,
    LPSTR *rgszToSites,
    DWORD cToSites,
...
NTDSAPI_POSTXP DWORD WINAPI DsQuerySitesByCostW(
    HANDLE hDS,
    LPWSTR pwszFromSite,
    LPWSTR *rgwszToSites,
    DWORD cToSites,
...
NTDSAPI DWORD WINAPI DsMapSchemaGuidsA(
    HANDLE hDs,
    DWORD cGuids,
    GUID *rGuids,
    DS_SCHEMA_GUID_MAPA **ppGuidMap);

NTDSAPI DWORD WINAPI DsMapSchemaGuidsW(
    HANDLE hDs,
    DWORD cGuids,
    GUID *rGuids,
    DS_SCHEMA_GUID_MAPW **ppGuidMap);

NTDSAPI void WINAPI DsFreeSchemaGuidMapA(
    PDS_SCHEMA_GUID_MAPA pGuidMap);

NTDSAPI void WINAPI DsFreeSchemaGuidMapW(
    PDS_SCHEMA_GUID_MAPW pGuidMap);
...
NTDSAPI DWORD WINAPI DsGetDomainControllerInfoA(
    HANDLE hDs,
    LPCSTR DomainName,
    DWORD InfoLevel,
    DWORD *pcOut,
...
NTDSAPI DWORD WINAPI DsGetDomainControllerInfoW(
    HANDLE hDs,
    LPCWSTR DomainName,
    DWORD InfoLevel,
    DWORD *pcOut,
...
NTDSAPI void WINAPI DsFreeDomainControllerInfoA(
    DWORD InfoLevel,
    DWORD cInfo,
    VOID *pInfo);

NTDSAPI void WINAPI DsFreeDomainControllerInfoW(
    DWORD InfoLevel,
    DWORD cInfo,
    VOID *pInfo);
...
NTDSAPI DWORD WINAPI DsReplicaConsistencyCheck(
    HANDLE hDS,
    DS_KCC_TASKID TaskID,
    DWORD dwFlags);

NTDSAPI DWORD WINAPI DsReplicaVerifyObjectsA(
    HANDLE hDS,
    LPCSTR NameContext,
    const UUID *pUuidDsaSrc,
    ULONG ulOptions
);
NTDSAPI DWORD WINAPI DsReplicaVerifyObjectsW(
    HANDLE hDS,
    LPCWSTR NameContext,
    const UUID *pUuidDsaSrc,
    ULONG ulOptions
...
NTDSAPI DWORD WINAPI DsReplicaGetInfoW(
    HANDLE hDS,
...
NTDSAPI DWORD WINAPI DsReplicaGetInfo2W(
    HANDLE hDS,
    DS_REPL_INFO_TYPE InfoType,
    LPCWSTR pszObject,
    UUID *puuidForSourceDsaObjGuid,
...
NTDSAPI void WINAPI DsReplicaFreeInfo(
    DS_REPL_INFO_TYPE InfoType,
    VOID *pInfo);
...
NTDSAPI DWORD WINAPI DsAddSidHistoryA(
    HANDLE hDS,
    DWORD Flags,
    LPCSTR SrcDomain,
    LPCSTR SrcPrincipal,
    LPCSTR SrcDomainController,
    RPC_AUTH_IDENTITY_HANDLE SrcDomainCreds,
    LPCSTR DstDomain,
    LPCSTR DstPrincipal
);
NTDSAPI DWORD WINAPI DsAddSidHistoryW(
    HANDLE hDS,
    DWORD Flags,
    LPCWSTR SrcDomain,
    LPCWSTR SrcPrincipal,
    LPCWSTR SrcDomainController,
    RPC_AUTH_IDENTITY_HANDLE SrcDomainCreds,
    LPCWSTR DstDomain,
...
NTDSAPI DWORD WINAPI DsInheritSecurityIdentityA(
    HANDLE hDS,
    DWORD Flags,
    LPCSTR SrcPrincipal,
    LPCSTR DstPrincipal
);
NTDSAPI DWORD WINAPI DsInheritSecurityIdentityW(
    HANDLE hDS,
    DWORD Flags,
    LPCWSTR SrcPrincipal,
    LPCWSTR DstPrincipal
...
#define FLAG_FOREST_OPTIONAL_FEATURE     (0x00000001)
#define FLAG_DOMAIN_OPTIONAL_FEATURE     (0x00000002)
#define FLAG_DISABLABLE_OPTIONAL_FEATURE (0x00000004)
#define FLAG_SERVER_OPTIONAL_FEATURE     (0x00000008)
