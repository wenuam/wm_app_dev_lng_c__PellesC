...
#endif /* (_WIN32_WINDOWS >= 0x0600 || _WIN32_WINNT >= 0x0600 || (defined(NTDDI_VERSION) && NTDDI_VERSION >= NTDDI_VISTA)) */
...
#else /* !((_WIN32_WINDOWS >= 0x0501 || _WIN32_WINNT >= 0x0501 || (defined(NTDDI_VERSION) && NTDDI_VERSION >= NTDDI_WINXP))) */
...
#endif  /* !((_WIN32_WINDOWS >= 0x0501 || _WIN32_WINNT >= 0x0501 || (defined(NTDDI_VERSION) && NTDDI_VERSION >= NTDDI_WINXP))) */
...
BOOL __stdcall PdhIsRealTimeQuery(
    PDH_HQUERY hQuery
);
...
PDH_FUNCTION PdhVerifySQLDBW(
    LPCWSTR szDataSource
);

PDH_FUNCTION PdhVerifySQLDBA(
    LPCSTR szDataSource
);

PDH_FUNCTION PdhCreateSQLTablesW(
    LPCWSTR szDataSource
);

PDH_FUNCTION PdhCreateSQLTablesA(
    LPCSTR szDataSource
);
...
PDH_FUNCTION PdhGetLogSetGUID(
    PDH_HLOG hLog,
    GUID *pGuid,
    int *pRunId
);

PDH_FUNCTION PdhSetLogSetRunID(
    PDH_HLOG hLog,
    int RunId
);
...
#endif /* (_WIN32_WINDOWS >= 0x0600 || _WINNT_WINNT >= 0x0600 || (defined(NTDDI_VERSION) && NTDDI_VERSION >= NTDDI_VISTA)) */
