/* Generated from structuredquery.idl by POIDL version 0.80 - Do not edit */
...
interface IQueryParser {
    CONST_VTBL IQueryParserVtbl* lpVtbl;
};
...
interface IQuerySolution {
    CONST_VTBL IQuerySolutionVtbl* lpVtbl;
};
...
interface IConditionFactory {
    CONST_VTBL IConditionFactoryVtbl* lpVtbl;
};
...
interface IConditionFactory2 {
    CONST_VTBL IConditionFactory2Vtbl* lpVtbl;
};
...
interface IConditionGenerator {
    CONST_VTBL IConditionGeneratorVtbl* lpVtbl;
};
...
interface IInterval {
    CONST_VTBL IIntervalVtbl* lpVtbl;
};
...
interface IMetaData {
    CONST_VTBL IMetaDataVtbl* lpVtbl;
};
...
interface IRelationship {
    CONST_VTBL IRelationshipVtbl* lpVtbl;
};
...
interface INamedEntity {
    CONST_VTBL INamedEntityVtbl* lpVtbl;
};
...
typedef struct ISchemaProviderVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *Localize)(
        ISchemaProvider *This,
        LCID lcid,
        ISchemaLocalizerSupport *pSchemaLocalizerSupport);
...
interface ISchemaProvider {
    CONST_VTBL ISchemaProviderVtbl* lpVtbl;
};
...
interface ITokenCollection {
    CONST_VTBL ITokenCollectionVtbl* lpVtbl;
};
...
typedef enum __POIDL_structuredquery_tag_00000013 {
    NEC_LOW = 0,
    NEC_MEDIUM = 1,
    NEC_HIGH = 2
...
interface INamedEntityCollector {
    CONST_VTBL INamedEntityCollectorVtbl* lpVtbl;
};
...
interface ISchemaLocalizerSupport {
    CONST_VTBL ISchemaLocalizerSupportVtbl* lpVtbl;
};
...
interface IQueryParserManager {
    CONST_VTBL IQueryParserManagerVtbl* lpVtbl;
};
