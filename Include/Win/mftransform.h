/* Generated from mftransform.idl by POIDL version 0.80 - Do not edit */
...
interface IMFDeviceTransform {
    CONST_VTBL IMFDeviceTransformVtbl* lpVtbl;
};
...
typedef struct IMFDeviceTransformCallbackVtbl {
    ...
    /*** IMFDeviceTransformCallback methods ***/
...
interface IMFDeviceTransformCallback {
    CONST_VTBL IMFDeviceTransformCallbackVtbl* lpVtbl;
};
