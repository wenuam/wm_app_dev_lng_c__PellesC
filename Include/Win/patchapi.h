...
typedef BOOL (CALLBACK PATCH_SYMLOAD_CALLBACK)(
    ULONG WhichFile,
    LPCSTR SymbolFileName,
    ULONG SymType,
    ULONG SymbolFileCheckSum,
    ULONG SymbolFileTimeDate,
    ULONG ImageFileCheckSum,
    ULONG ImageFileTimeDate,
    PVOID CallbackContext
);
...
BOOL PATCHAPI CreatePatchFileA(
    LPCSTR OldFileName,
    LPCSTR NewFileName,
...
BOOL PATCHAPI CreatePatchFileExW(
    ULONG OldFileCount,
    PPATCH_OLD_FILE_INFO_W OldFileInfoArray,
    LPCWSTR NewFileName,
    LPCWSTR PatchFileName,
    ULONG OptionFlags,
    PPATCH_OPTION_DATA OptionData,
...
BOOL PATCHAPI TestApplyPatchToFileA(
    LPCSTR PatchFileName,
    LPCSTR OldFileName,
...
BOOL PATCHAPI TestApplyPatchToFileByBuffers(
...
BOOL PATCHAPI ApplyPatchToFileA(
    LPCSTR PatchFileName,
    LPCSTR OldFileName,
    LPCSTR NewFileName,
    ULONG ApplyOptionFlags
...
BOOL PATCHAPI ApplyPatchToFileExA(
    LPCSTR PatchFileName,
    LPCSTR OldFileName,
    LPCSTR NewFileName,
    ULONG ApplyOptionFlags,
...
BOOL PATCHAPI ApplyPatchToFileExW(
    LPCWSTR PatchFileName,
    LPCWSTR OldFileName,
    LPCWSTR NewFileName,
    ULONG ApplyOptionFlags,
...
BOOL PATCHAPI ApplyPatchToFileByBuffers(
...
BOOL PATCHAPI GetFilePatchSignatureA(
    LPCSTR FileName,
    ULONG OptionFlags,
    PVOID OptionData,
    ULONG IgnoreRangeCount,
...
BOOL PATCHAPI GetFilePatchSignatureW(
    LPCWSTR FileName,
    ULONG OptionFlags,
    PVOID OptionData,
    ULONG IgnoreRangeCount,
...
BOOL PATCHAPI GetFilePatchSignatureByBuffer(
