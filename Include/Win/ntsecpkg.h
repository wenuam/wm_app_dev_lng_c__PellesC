...
typedef NTSTATUS (*PSAM_CREDENTIAL_UPDATE_NOTIFY_ROUTINE)(
    ...
    PVOID OldCredentials,
    ULONG OldCredentialSize,
    ULONG UserAccountControl,
    PUNICODE_STRING UPN,
    PUNICODE_STRING UserName,
    PUNICODE_STRING NetbiosDomainName,
    PUNICODE_STRING DnsDomainName,
    PVOID *NewCredentials,
    ULONG *NewCredentialSize
);
...
typedef NTSTATUS ( *PSAM_CREDENTIAL_UPDATE_REGISTER_MAPPED_ENTRYPOINTS_ROUTINE)(
    SAM_REGISTER_MAPPING_TABLE *Table
);
...
#define PRIMARY_CRED_FOR_PASSWORD_CHANGE            0x00800000
...
typedef NTSTATUS (NTAPI LSA_REDIRECTED_LOGON_INIT)(
...
typedef NTSTATUS (NTAPI LSA_REDIRECTED_LOGON_CALLBACK)(
    HANDLE RedirectedLogonHandle,
    PVOID Buffer,
    ULONG BufferLength,
    PVOID *ReturnBuffer,
...
typedef void (NTAPI LSA_REDIRECTED_LOGON_CLEANUP_CALLBACK)(
    HANDLE RedirectedLogonHandle
);

typedef NTSTATUS (NTAPI LSA_REDIRECTED_LOGON_GET_LOGON_CREDS)(
    HANDLE RedirectedLogonHandle,
    PBYTE *LogonBuffer,
    PULONG LogonBufferLength
);

typedef NTSTATUS (NTAPI LSA_REDIRECTED_LOGON_GET_SUPP_CREDS)(
    HANDLE RedirectedLogonHandle,
    PSECPKG_SUPPLEMENTAL_CRED_ARRAY *SupplementalCredentials
);

typedef NTSTATUS (NTAPI LSA_REDIRECTED_LOGON_GET_SID)(
    HANDLE RedirectedLogonHandle,
    PSID *Sid
);
...
typedef NTSTATUS (NTAPI LSA_GET_CLIENT_INFO_EX)(
    PSECPKG_CLIENT_INFO_EX ClientInfo,
    ULONG StructSize
);
...
typedef NTSTATUS (NTAPI LSA_CALL_PACKAGE)(
    PUNICODE_STRING AuthenticationPackage,
    PVOID ProtocolSubmitBuffer,
    ULONG SubmitBufferLength,
    PVOID *ProtocolReturnBuffer,
    PULONG ReturnBufferLength,
...
typedef NTSTATUS (NTAPI LSA_GET_APP_MODE_INFO)(
    PULONG UserFunction,
    PULONG_PTR Argument1,
    PULONG_PTR Argument2,
    PSecBuffer UserData,
    PBOOLEAN ReturnToLsa
);

typedef NTSTATUS (NTAPI LSA_SET_APP_MODE_INFO)(
    ULONG UserFunction,
    ULONG_PTR Argument1,
    ULONG_PTR Argument2,
    PSecBuffer UserData,
...
typedef NTSTATUS (NTAPI LSA_GET_EXTENDED_CALL_FLAGS)(
    PULONG Flags
);
...
typedef NTSTATUS (NTAPI LSA_EXPAND_AUTH_DATA_FOR_DOMAIN)(
    ...
    ULONG UserAuthDataSize,
    PVOID Reserved,
    PUCHAR *ExpandedAuthData,
    PULONG ExpandedAuthDataSize
);
...
typedef NTSTATUS (NTAPI LSA_GET_SERVICE_ACCOUNT_PASSWORD)(
    PUNICODE_STRING AccountName,
    PUNICODE_STRING DomainName,
    CRED_FETCH CredFetch,
    FILETIME *FileTimeExpiry,
    PUNICODE_STRING CurrentPassword,
    PUNICODE_STRING PreviousPassword,
    FILETIME *FileTimeCurrPwdValidForOutbound);

typedef void (NTAPI LSA_AUDIT_LOGON_EX)(
    NTSTATUS Status,
    NTSTATUS SubStatus,
    PUNICODE_STRING AccountName,
    PUNICODE_STRING AuthenticatingAuthority,
...
typedef NTSTATUS (NTAPI LSA_CHECK_PROTECTED_USER_BY_TOKEN)(
    HANDLE UserToken,
    PBOOLEAN ProtectedUser
);

typedef NTSTATUS (NTAPI LSA_QUERY_CLIENT_REQUEST)(
    PLSA_CLIENT_REQUEST ClientRequest,
    ULONG QueryType,
    PVOID *ReplyBuffer
);
...
typedef NTSTATUS (NTAPI CredReadFn)(
    ...
    ULONG Type,
    ULONG Flags,
    PENCRYPTED_CREDENTIALW *Credential
);
...
typedef void (NTAPI CredFreeCredentialsFn)(
    ULONG Count,
    PENCRYPTED_CREDENTIALW *Credentials
);
...
typedef NTSTATUS (NTAPI CrediUnmarshalandDecodeStringFn)(
    LPWSTR MarshaledString,
    LPBYTE *Blob,
    ULONG *BlobSize,
...
NTSTATUS CredMarshalTargetInfo(
    PCREDENTIAL_TARGET_INFORMATIONW InTargetInfo,
    PUSHORT *Buffer,
    PULONG BufferSize
);
...
typedef PVOID (NTAPI LSA_LOCATE_PKG_BY_ID)(
    ULONG PackgeId
);
...
typedef NTSTATUS (NTAPI SpGetExtendedInformationFn)(
    SECPKG_EXTENDED_INFORMATION_CLASS Class,
    PSECPKG_EXTENDED_INFORMATION *ppInformation
);
...
typedef NTSTATUS (LSA_AP_LOGON_USER_EX3)(
    PLSA_CLIENT_REQUEST ClientRequest,
    SECURITY_LOGON_TYPE LogonType,
    PVOID ProtocolSubmitBuffer,
    PVOID ClientBufferBase,
    ULONG SubmitBufferSize,
    PSECPKG_SURROGATE_LOGON SurrogateLogon,
    PVOID *ProfileBuffer,
    PULONG ProfileBufferSize,
    PLUID LogonId,
    PNTSTATUS SubStatus,
...
typedef NTSTATUS (LSA_AP_PRE_LOGON_USER_SURROGATE)(
    PLSA_CLIENT_REQUEST ClientRequest,
    SECURITY_LOGON_TYPE LogonType,
    PVOID ProtocolSubmitBuffer,
    PVOID ClientBufferBase,
...
typedef NTSTATUS (LSA_AP_POST_LOGON_USER_SURROGATE)(
    PLSA_CLIENT_REQUEST ClientRequest,
    SECURITY_LOGON_TYPE LogonType,
    PVOID ProtocolSubmitBuffer,
    PVOID ClientBufferBase,
...
typedef NTSTATUS (NTAPI SpChangeAccountPasswordFn)(
    PUNICODE_STRING pDomainName,
    PUNICODE_STRING pAccountName,
    PUNICODE_STRING pOldPassword,
    PUNICODE_STRING pNewPassword,
    BOOLEAN Impersonating,
    PSecBufferDesc pOutput
);

typedef NTSTATUS (NTAPI SpQueryMetaDataFn)(
    LSA_SEC_HANDLE CredentialHandle,
    PUNICODE_STRING TargetName,
    ULONG ContextRequirements,
...
typedef NTSTATUS (NTAPI SpExchangeMetaDataFn)(
    LSA_SEC_HANDLE CredentialHandle,
    PUNICODE_STRING TargetName,
    ULONG ContextRequirements,
...
typedef NTSTATUS (NTAPI SpGetCredUIContextFn)(
    LSA_SEC_HANDLE ContextHandle,
    GUID *CredType,
...
typedef NTSTATUS (NTAPI SpUpdateCredentialsFn)(
    LSA_SEC_HANDLE ContextHandle,
    GUID *CredType,
...
typedef NTSTATUS (NTAPI SpValidateTargetInfoFn)(
    ...
    PVOID ClientBufferBase,
    ULONG SubmitBufferLength,
    PSECPKG_TARGETINFO TargetInfo
);

typedef NTSTATUS (NTAPI SpExtractTargetInfoFn)(
    PLSA_CLIENT_REQUEST ClientRequest,
    PVOID ProtocolSubmitBuffer,
    PVOID ClientBufferBase,
    ULONG SubmitBufferLength,
...
typedef NTSTATUS (NTAPI LSA_AP_POST_LOGON_USER)(
    PSECPKG_POST_LOGON_USER_INFO PostLogonUserInfo
);

typedef NTSTATUS (NTAPI SpGetRemoteCredGuardLogonBufferFn)(
    LSA_SEC_HANDLE CredHandle,
    LSA_SEC_HANDLE ContextHandle,
    const UNICODE_STRING *TargetName,
    PHANDLE RedirectedLogonHandle,
    PLSA_REDIRECTED_LOGON_CALLBACK *Callback,
    PLSA_REDIRECTED_LOGON_CLEANUP_CALLBACK *CleanupCallback,
    PULONG LogonBufferSize,
    PVOID *LogonBuffer
);

typedef NTSTATUS (NTAPI SpGetRemoteCredGuardSupplementalCredsFn)(
    LSA_SEC_HANDLE CredHandle,
    const UNICODE_STRING *TargetName,
    PHANDLE RedirectedLogonHandle,
    PLSA_REDIRECTED_LOGON_CALLBACK *Callback,
...
typedef NTSTATUS (NTAPI SpGetTbalSupplementalCredsFn)(
    LUID LogonId,
    PULONG SupplementalCredsSize,
    PVOID *SupplementalCreds
);
...
typedef NTSTATUS (NTAPI SpFormatCredentialsFn)(
    PSecBuffer Credentials,
    PSecBuffer FormattedCredentials
);

typedef NTSTATUS (NTAPI SpMarshallSupplementalCredsFn)(
    ULONG CredentialSize,
    PUCHAR Credentials,
    PULONG MarshalledCredSize,
    PVOID *MarshalledCreds
);
...
typedef NTSTATUS (NTAPI SpMarshalAttributeDataFn)(
    DWORD AttributeInfo,
    ULONG Attribute,
    ULONG AttributeDataSize,
    PBYTE AttributeData,
    PULONG MarshaledAttributeDataSize,
    PBYTE *MarshaledAttributeData);
...
typedef NTSTATUS (SEC_ENTRY KSEC_SERIALIZE_SCHANNEL_AUTH_DATA)(
    PVOID pvAuthData,
    PULONG Size,
    PVOID *SerializedData);
...
typedef PVOID (SEC_ENTRY KSEC_LOCATE_PKG_BY_ID)(
    ULONG PackageId
);
