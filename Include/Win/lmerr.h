...
#define NERR_CannotUpdateAadHostName       (NERR_BASE + 628)   
#define NERR_DuplicateHostName             (NERR_BASE + 629)   
#define NERR_HostNameTooLong               (NERR_BASE + 630)   
#define NERR_TooManyHostNames              (NERR_BASE + 631)   
#define NERR_AccountReuseBlockedByPolicy   (NERR_BASE + 632)   
