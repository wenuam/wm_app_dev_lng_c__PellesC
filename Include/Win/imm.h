...
UINT WINAPI ImmGetDescriptionA(HKL, LPSTR lpszDescription, UINT uBufLen);
UINT WINAPI ImmGetDescriptionW(HKL, LPWSTR lpszDescription, UINT uBufLen);
#ifdef UNICODE
...
UINT WINAPI ImmGetIMEFileNameA(HKL, LPSTR lpszFileName, UINT uBufLen);
UINT WINAPI ImmGetIMEFileNameW(HKL, LPWSTR lpszFileName, UINT uBufLen);
#ifdef UNICODE
...
LONG WINAPI ImmGetCompositionStringA(HIMC, DWORD, LPVOID lpBuf, DWORD dwBufLen);
LONG WINAPI ImmGetCompositionStringW(HIMC, DWORD, LPVOID lpBuf, DWORD dwBufLen);
#ifdef UNICODE
...
BOOL WINAPI ImmSetCompositionStringA(HIMC, DWORD dwIndex, LPVOID lpComp, DWORD dwCompLen, LPVOID lpRead, DWORD dwReadLen);
BOOL WINAPI ImmSetCompositionStringW(HIMC, DWORD dwIndex, LPVOID lpComp, DWORD dwCompLen, LPVOID lpRead, DWORD dwReadLen);
#ifdef UNICODE
...
DWORD WINAPI ImmGetCandidateListA(HIMC, DWORD deIndex, LPCANDIDATELIST lpCandList, DWORD dwBufLen);
DWORD WINAPI ImmGetCandidateListW(HIMC, DWORD deIndex, LPCANDIDATELIST lpCandList, DWORD dwBufLen);
#ifdef UNICODE
...
BOOL WINAPI ImmGetCompositionFontA(HIMC, LPLOGFONTA lplf);
BOOL WINAPI ImmGetCompositionFontW(HIMC, LPLOGFONTW lplf);
#ifdef UNICODE
...
BOOL WINAPI ImmSetCompositionFontA(HIMC, LPLOGFONTA lplf);
BOOL WINAPI ImmSetCompositionFontW(HIMC, LPLOGFONTW lplf);
#ifdef UNICODE
...
DWORD WINAPI ImmGetConversionListA(HKL, HIMC, LPCSTR lpSrc, LPCANDIDATELIST lpDst, DWORD dwBufLen, UINT uFlag);
DWORD WINAPI ImmGetConversionListW(HKL, HIMC, LPCWSTR lpSrc, LPCANDIDATELIST lpDst, DWORD dwBufLen, UINT uFlag);
#ifdef UNICODE
...
BOOL WINAPI ImmGetStatusWindowPos(HIMC, LPPOINT lpptPos);
BOOL WINAPI ImmSetStatusWindowPos(HIMC, LPPOINT lpptPos);
BOOL WINAPI ImmGetCompositionWindow(HIMC, LPCOMPOSITIONFORM lpCompForm);
BOOL WINAPI ImmSetCompositionWindow(HIMC, LPCOMPOSITIONFORM lpCompForm);
BOOL WINAPI ImmGetCandidateWindow(HIMC, DWORD, LPCANDIDATEFORM lpCandidate);
BOOL WINAPI ImmSetCandidateWindow(HIMC, LPCANDIDATEFORM lpCandidate);
...
UINT WINAPI ImmGetRegisterWordStyleA(HKL, UINT nItem, LPSTYLEBUFA lpStyleBuf);
UINT WINAPI ImmGetRegisterWordStyleW(HKL, UINT nItem, LPSTYLEBUFW lpStyleBuf);
#ifdef UNICODE
...
DWORD WINAPI ImmGetImeMenuItemsA(HIMC, DWORD, DWORD, LPIMEMENUITEMINFOA lpImeParentMenu, LPIMEMENUITEMINFOA lpImeMenu, DWORD dwSize);
DWORD WINAPI ImmGetImeMenuItemsW(HIMC, DWORD, DWORD, LPIMEMENUITEMINFOW lpImeParentMenu, LPIMEMENUITEMINFOW lpImeMenu, DWORD dwSize);
#ifdef UNICODE
