...
DECLARE_INTERFACE_(IPrintAsyncNotifyDataObject, IUnknown)
{
    ...
    STDMETHOD(AcquireData)(THIS_ BYTE **ppNotificationData,
        ULONG *pSize, PrintAsyncNotificationType **ppSchema) PURE;
...
DECLARE_INTERFACE_(IPrintAsyncNotifyChannel, IUnknown)
{
    ...
    STDMETHOD(SendNotification)(THIS_ IPrintAsyncNotifyDataObject *pData) PURE;
    STDMETHOD(CloseChannel)(THIS_ IPrintAsyncNotifyDataObject *pData) PURE;
};
...
DECLARE_INTERFACE_(IPrintAsyncNotifyCallback, IUnknown)
{
    ...
    STDMETHOD(OnEventNotify)(THIS_ IPrintAsyncNotifyChannel *pChannel,
        IPrintAsyncNotifyDataObject *pData) PURE;
    STDMETHOD(ChannelClosed)(THIS_ IPrintAsyncNotifyChannel *pChannel,
        IPrintAsyncNotifyDataObject *pData) PURE;
};

#undef INTERFACE

HRESULT WINAPI RegisterForPrintAsyncNotifications(
    PCWSTR pszName,
...
HRESULT WINAPI UnRegisterForPrintAsyncNotifications(
    HANDLE
);

HRESULT WINAPI CreatePrintAsyncNotifyChannel(
    PCWSTR pszName,
    PrintAsyncNotificationType *pNotificationType,
    PrintAsyncNotifyUserFilter eUserFilter,
    PrintAsyncNotifyConversationStyle eConversationStyle,
