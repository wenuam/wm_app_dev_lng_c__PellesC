...
/* Common Cryptographic Dialog API definitions */
...
CRYPTDLGAPI BOOL WINAPI CertSelectCertificateA(
    PCERT_SELECT_STRUCT_A pCertSelectInfo
);
CRYPTDLGAPI BOOL WINAPI CertSelectCertificateW(
    PCERT_SELECT_STRUCT_W pCertSelectInfo
);
#ifdef UNICODE
...
CRYPTDLGAPI BOOL WINAPI CertViewPropertiesA(
    PCERT_VIEWPROPERTIES_STRUCT_A pCertViewInfo
);
CRYPTDLGAPI BOOL WINAPI CertViewPropertiesW(
...
CRYPTDLGAPI DWORD WINAPI GetFriendlyNameOfCertA(
    PCCERT_CONTEXT pccert,
    LPSTR pch,
    DWORD cch
);
CRYPTDLGAPI DWORD WINAPI GetFriendlyNameOfCertW(
    PCCERT_CONTEXT pccert,
    LPWSTR pwch,
    DWORD cwch
);
...
CRYPTDLGAPI HRESULT WINAPI CertModifyCertificatesToTrust(
    int cCerts,
