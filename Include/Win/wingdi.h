...
#else /* (_WIN32_WINNT < _WIN32_WINNT_WIN2K) */
...
WINGDIAPI HDC WINAPI CreateICA(
    LPCSTR pszDriver,
    LPCSTR pszDevice,
    LPCSTR pszPort,
    CONST DEVMODEA *pdm
);
WINGDIAPI HDC WINAPI CreateICW(
    LPCWSTR pszDriver,
    LPCWSTR pszDevice,
    LPCWSTR pszPort,
    CONST DEVMODEW *pdm
...
WINSPOOLAPI int WINAPI DeviceCapabilitiesA(
    LPCSTR pDevice,
    LPCSTR pPort,
    WORD fwCapability,
    LPSTR pOutput,
...
WINSPOOLAPI int WINAPI DeviceCapabilitiesW(
    LPCWSTR pDevice,
    LPCWSTR pPort,
    WORD fwCapability,
    LPWSTR pOutput,
...
#ifndef NOTEXTMETRIC
WINGDIAPI UINT APIENTRY GetOutlineTextMetricsA(
    HDC hdc,
    UINT cjCopy,
    LPOUTLINETEXTMETRICA potm
);
WINGDIAPI UINT APIENTRY GetOutlineTextMetricsW(
    HDC hdc,
    UINT cjCopy,
...
WINGDIAPI BOOL WINAPI GetCharWidthI(HDC hdc,
    UINT giFirst,
    UINT cgi,
    LPWORD pgi,
    LPINT piWidths
...
WINGDIAPI BOOL WINAPI GetCharABCWidthsI(HDC hdc,
    UINT giFirst,
    UINT cgi,
    LPWORD pgi,
    LPABC pabc
...
typedef HRESULT (WINAPI *DDRAWMARSHCALLBACKMARSHAL)(HGDIOBJ hGdiObj, LPVOID pGdiRef, LPVOID *ppDDrawRef);
...
WINGDIAPI BOOL WINAPI GdiAlphaBlend(
    HDC hdcDest,
    int xoriginDest,
    int yoriginDest,
    int wDest,
...
WINGDIAPI BOOL WINAPI GdiTransparentBlt(
    HDC hdcDest,
    int xoriginDest,
    int yoriginDest,
    int wDest,
...
WINGDIAPI BOOL WINAPI GdiGradientFill(
    HDC hdc,
    PTRIVERTEX pVertex,
    ULONG nVertex,
    PVOID pMesh,
...
typedef int (CALLBACK *ENHMFENUMPROC)(HDC hdc, HANDLETABLE *lpht, CONST ENHMETARECORD *lpmr, int nHandles, LPARAM data);
...
WINGDIAPI BOOL WINAPI CheckColorsInGamut(HDC hdc, LPRGBTRIPLE lpRGBTriple, LPVOID dlpBuffer, DWORD nCount);
