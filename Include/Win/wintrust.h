...
#else /* WIN_CERT_REVISION_1_0 */
#undef WT_DEFINE_ALL_APIS
#endif /* WIN_CERT_REVISION_1_0 */
...
typedef BOOL (*PFN_CPD_ADD_STORE)(
    struct _CRYPT_PROVIDER_DATA *pProvData,
    HCERTSTORE hStore2Add
);

typedef BOOL (*PFN_CPD_ADD_SGNR)(
    struct _CRYPT_PROVIDER_DATA *pProvData,
    BOOL fCounterSigner,
    DWORD idxSigner,
    struct _CRYPT_PROVIDER_SGNR *pSgnr2Add
);

typedef BOOL ( *PFN_CPD_ADD_CERT)(
    struct _CRYPT_PROVIDER_DATA *pProvData,
    DWORD idxSigner,
    BOOL fCounterSigner,
...
typedef BOOL (*PFN_CPD_ADD_PRIVDATA)(
    struct _CRYPT_PROVIDER_DATA *pProvData,
...
typedef BOOL ( *PFN_ALLOCANDFILLDEFUSAGE)(
    const char *pszUsageOID,
    struct _CRYPT_PROVIDER_DEFUSAGE *psDefUsage
);

typedef BOOL ( *PFN_FREEDEFUSAGE)(
    const char *pszUsageOID,
    struct _CRYPT_PROVIDER_DEFUSAGE *psDefUsage
);
...
extern BOOL WINAPI WintrustAddActionID(
    GUID *pgActionID,
    DWORD fdwFlags,
...
extern BOOL WINAPI WintrustLoadFunctionPointers(
    GUID *pgActionID,
    CRYPT_PROVIDER_FUNCTIONS *pPfns
);

extern BOOL WINAPI WintrustAddDefaultForUsage(
    const char *pszUsageOID,
...
extern BOOL WINAPI WintrustGetDefaultForUsage(DWORD dwAction,
    const char *pszUsageOID,
    CRYPT_PROVIDER_DEFUSAGE *psUsage
);

extern CRYPT_PROVIDER_SGNR * WINAPI WTHelperGetProvSignerFromChain(
...
extern CRYPT_PROVIDER_CERT * WINAPI WTHelperGetProvCertFromChain(
...
extern CRYPT_PROVIDER_PRIVDATA * WINAPI WTHelperGetProvPrivateDataFromChain(
    CRYPT_PROVIDER_DATA *pProvData,
    GUID *pgProviderID
);
...
#define WIN_TRUST_SUBJTYPE_CABINET \
    { 0xd17c5374, 0xa392, 0x11cf, { 0x9d, 0xf5, 0x0, 0xaa, 0x0, 0xc1, 0x84, 0xe0 } }
...
extern void WINAPI WintrustSetDefaultIncludePEPageHashes(
