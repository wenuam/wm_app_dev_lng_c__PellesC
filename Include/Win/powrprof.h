...
typedef BOOLEAN CALLBACK PWRSCHEMESENUMPROC_V1(
    UINT Index,
    DWORD NameSize,
    LPTSTR Name,
...
typedef BOOLEAN CALLBACK PWRSCHEMESENUMPROC_V2(
    UINT Index,
    DWORD NameSize,
    LPWSTR Name,
    DWORD DescriptionSize,
...
STDAPI_(BOOLEAN) GetPwrDiskSpindownRange(
    PUINT puiMax,
    PUINT puiMin
);

STDAPI_(BOOLEAN) EnumPwrSchemes(
    PWRSCHEMESENUMPROC lpfn,
    LPARAM lParam
);

STDAPI_(BOOLEAN) ReadGlobalPwrPolicy(
    PGLOBAL_POWER_POLICY pGlobalPowerPolicy
);

STDAPI_(BOOLEAN) ReadPwrScheme(
    UINT uiID,
    PPOWER_POLICY pPowerPolicy
);

STDAPI_(BOOLEAN) WritePwrScheme(
    PUINT puiID,
...
STDAPI_(BOOLEAN) WriteGlobalPwrPolicy(
    PGLOBAL_POWER_POLICY pGlobalPowerPolicy
);

STDAPI_(BOOLEAN) DeletePwrScheme(
    UINT uiID
);

STDAPI_(BOOLEAN) GetActivePwrScheme(
    PUINT puiID
);

STDAPI_(BOOLEAN) SetActivePwrScheme(
    UINT uiID,
    PGLOBAL_POWER_POLICY pGlobalPowerPolicy,
    PPOWER_POLICY pPowerPolicy
);

STDAPI_(BOOLEAN) IsPwrSuspendAllowed(
    void
);

STDAPI_(BOOLEAN) IsPwrHibernateAllowed(
    void
);

STDAPI_(BOOLEAN) IsPwrShutdownAllowed(
    void
);

STDAPI_(BOOLEAN) IsAdminOverrideActive(
    PADMINISTRATOR_POWER_POLICY papp
);

STDAPI_(BOOLEAN) SetSuspendState(
    BOOLEAN bHibernate,
    BOOLEAN bForce,
    BOOLEAN bWakeupEventsDisabled
);

STDAPI_(BOOLEAN) GetCurrentPowerPolicies(
    PGLOBAL_POWER_POLICY pGlobalPowerPolicy,
    PPOWER_POLICY pPowerPolicy
);

STDAPI_(BOOLEAN) CanUserWritePwrScheme(
    void
);

#if (NTDDI_VERSION >= NTDDI_WINXP)
STDAPI_(BOOLEAN) ReadProcessorPwrScheme(
    UINT uiID,
...
#if (NTDDI_VERSION >= NTDDI_WINXP)
STDAPI_(BOOLEAN) WriteProcessorPwrScheme(
    UINT uiID,
    PMACHINE_PROCESSOR_POWER_POLICY pMachineProcessorPowerPolicy
);
#endif /* (NTDDI_VERSION >= NTDDI_WINXP) */

STDAPI_(BOOLEAN) ValidatePowerPolicies(
    PGLOBAL_POWER_POLICY pGlobalPowerPolicy,
    PPOWER_POLICY pPowerPolicy
);
...
STDAPI_(BOOLEAN) PowerIsSettingRangeDefined(
...
#if (NTDDI_VERSION >= NTDDI_WIN7)
STDAPI_(DWORD) PowerSettingAccessCheckEx (
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerSettingAccessCheck(
    POWER_DATA_ACCESSOR AccessFlags,
    CONST GUID *PowerGuid
);
#endif /* (NTDDI_VERSION >= NTDDI_VISTA) */
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadACValueIndex(
    HKEY RootPowerKey,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadDCValueIndex(
    HKEY RootPowerKey,
    CONST GUID *SchemeGuid,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadFriendlyName(
    HKEY RootPowerKey,
    CONST GUID *SchemeGuid,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadDescription(
    HKEY RootPowerKey,
    CONST GUID *SchemeGuid,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadPossibleValue(
    HKEY RootPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
    PULONG Type,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadPossibleFriendlyName(
    HKEY RootPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
    ULONG PossibleSettingIndex,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadPossibleDescription(
    HKEY RootPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
    ULONG PossibleSettingIndex,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadValueMin(
    HKEY RootPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadValueMax(
    HKEY RootPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadValueIncrement(
    HKEY RootPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadValueUnitsSpecifier(
    HKEY RootPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
    UCHAR *Buffer,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadACDefaultIndex(
    HKEY RootPowerKey,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadDCDefaultIndex(
    HKEY RootPowerKey,
    CONST GUID *SchemePersonalityGuid,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadIconResourceSpecifier(
    HKEY RootPowerKey,
    CONST GUID *SchemeGuid,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReadSettingAttributes(
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerWriteFriendlyName(
    HKEY RootPowerKey,
    CONST GUID *SchemeGuid,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerWriteDescription(
    HKEY RootPowerKey,
    CONST GUID *SchemeGuid,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerWritePossibleValue(
    HKEY RootPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
    ULONG Type,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerWritePossibleFriendlyName(
    HKEY RootPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
    ULONG PossibleSettingIndex,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerWritePossibleDescription(
    HKEY RootPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
    ULONG PossibleSettingIndex,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerWriteValueMin(
    HKEY RootPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
    DWORD ValueMinimum
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerWriteValueMax(
    HKEY RootPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
    DWORD ValueMaximum
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerWriteValueIncrement(
    HKEY RootPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerWriteValueUnitsSpecifier(
    HKEY RootPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
    UCHAR *Buffer,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerWriteACDefaultIndex(
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerWriteDCDefaultIndex(
    HKEY RootSystemPowerKey,
    CONST GUID *SchemePersonalityGuid,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerWriteIconResourceSpecifier(
    HKEY RootPowerKey,
    CONST GUID *SchemeGuid,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerWriteSettingAttributes(
    CONST GUID *SubGroupGuid,
    CONST GUID *PowerSettingGuid,
    DWORD Attributes
);
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerDuplicateScheme(
    HKEY RootPowerKey,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerImportPowerScheme(
    HKEY RootPowerKey,
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerDeleteScheme(
    HKEY RootPowerKey,
    CONST GUID *SchemeGuid
);
#endif /* (NTDDI_VERSION >= NTDDI_VISTA) */
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerRemovePowerSetting(
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerCreateSetting(
    HKEY RootSystemPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid
);
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerCreatePossibleSetting(
    HKEY RootSystemPowerKey,
    CONST GUID *SubGroupOfPowerSettingsGuid,
    CONST GUID *PowerSettingGuid,
    ULONG PossibleSettingIndex
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerOpenUserPowerKey(
    HKEY *phUserPowerKey,
    REGSAM Access,
    BOOL OpenExisting
);
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerOpenSystemPowerKey(
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerCanRestoreIndividualDefaultPowerScheme(
    CONST GUID *SchemeGuid
);
#endif

#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerRestoreIndividualDefaultPowerScheme(
    CONST GUID *SchemeGuid
);
#endif /* (NTDDI_VERSION >= NTDDI_VISTA) */

#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerRestoreDefaultPowerSchemes(
    void
);
#endif /* (NTDDI_VERSION >= NTDDI_VISTA) */

#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(DWORD) PowerReplaceDefaultPowerSchemes(
    void
);
#endif /* (NTDDI_VERSION >= NTDDI_VISTA) */

#if (NTDDI_VERSION >= NTDDI_VISTA)
STDAPI_(POWER_PLATFORM_ROLE) PowerDeterminePlatformRole(
    void
);
#endif /* (NTDDI_VERSION >= NTDDI_VISTA) */
...
STDAPI_(BOOLEAN) DevicePowerEnumDevices(
    ULONG QueryIndex,
...
#if (NTDDI_VERSION >= NTDDI_WS03)
STDAPI_(DWORD) DevicePowerSetDeviceState(
...
#if (NTDDI_VERSION >= NTDDI_WS03)
STDAPI_(BOOLEAN) DevicePowerOpen(
    ULONG DebugMask
);
#endif /* (NTDDI_VERSION >= NTDDI_WS03) */

#if (NTDDI_VERSION >= NTDDI_WS03)
STDAPI_(BOOLEAN) DevicePowerClose(
    void
);
#endif /* (NTDDI_VERSION >= NTDDI_WS03) */
...
STDAPI_(DWORD) PowerReportThermalEvent(
