...
STDAPI MFCreateDXGISurfaceBuffer(
    REFIID riid,
    IUnknown *punkSurface,
...
STDAPI MFCreateDXGIDeviceManager(
    UINT *resetToken,
    IMFDXGIDeviceManager **ppDeviceManager
);

#define MF_E_DXGI_DEVICE_NOT_INITIALIZED ((HRESULT)0x80041000L)
#define MF_E_DXGI_NEW_VIDEO_DEVICE       ((HRESULT)0x80041001L)
#define MF_E_DXGI_VIDEO_DEVICE_LOCKED    ((HRESULT)0x80041002L)
...
DEFINE_GUID(MFSampleExtension_MaxDecodeFrameSize, 0xd3cc654f, 0xf9f3, 0x4a13, 0x88, 0x9f, 0xf0, 0x4e, 0xb2, 0xb5, 0xb9, 0x57);
DEFINE_GUID(MFSampleExtension_AccumulatedNonRefPicPercent, 0x79ea74df, 0xa740, 0x445b, 0xbc, 0x98, 0xc9, 0xed, 0x1f, 0x26, 0xe, 0xee);
DEFINE_GUID(MFSampleExtension_Encryption_ProtectionScheme, 0xd054d096, 0x28bb, 0x45da, 0x87, 0xec, 0x74, 0xf3, 0x51, 0x87, 0x14, 0x6);
...
DEFINE_GUID(MFSampleExtension_Encryption_CryptByteBlock, 0x9d84289b, 0xc7f, 0x4713, 0xab, 0x95, 0x10, 0x8a, 0xb4, 0x2a, 0xd8, 0x1);
DEFINE_GUID(MFSampleExtension_Encryption_SkipByteBlock, 0xd550548, 0x8317, 0x4ab1, 0x84, 0x5f, 0xd0, 0x63, 0x6, 0xe2, 0x93, 0xe3);
DEFINE_GUID(MFSampleExtension_Encryption_SubSample_Mapping, 0x8444F27A, 0x69A1, 0x48DA, 0xBD, 0x08, 0x11, 0xCE, 0xF3, 0x68, 0x30, 0xD2);
DEFINE_GUID(MFSampleExtension_Encryption_ClearSliceHeaderData, 0x5509a4f4, 0x320d, 0x4e6c, 0x8d, 0x1a, 0x94, 0xc6, 0x6d, 0xd2, 0xc, 0xb0);
DEFINE_GUID(MFSampleExtension_Encryption_HardwareProtection_KeyInfoID, 0x8cbfcceb, 0x94a5, 0x4de1, 0x82, 0x31, 0xa8, 0x5e, 0x47, 0xcf, 0x81, 0xe7);
DEFINE_GUID(MFSampleExtension_Encryption_HardwareProtection_KeyInfo, 0xb2372080, 0x455b, 0x4dd7, 0x99, 0x89, 0x1a, 0x95, 0x57, 0x84, 0xb7, 0x54);
DEFINE_GUID(MFSampleExtension_Encryption_HardwareProtection_VideoDecryptorContext, 0x693470c8, 0xe837, 0x47a0, 0x88, 0xcb, 0x53, 0x5b, 0x90, 0x5e, 0x35, 0x82);
DEFINE_GUID(MFSampleExtension_Encryption_Opaque_Data, 0x224d77e5, 0x1391, 0x4ffb, 0x9f, 0x41, 0xb4, 0x32, 0xf6, 0x8c, 0x61, 0x1d);
DEFINE_GUID(MFSampleExtension_NALULengthInfo, 0x19124E7C, 0xAD4B, 0x465F, 0xBB, 0x18, 0x20, 0x18, 0x62, 0x87, 0xB6, 0xAF);
DEFINE_GUID(MFSampleExtension_Encryption_ResumeVideoOutput, 0xa435aba5, 0xafde, 0x4cf5, 0xbc, 0x1c, 0xf6, 0xac, 0xaf, 0x13, 0x94, 0x9d);
DEFINE_GUID(MFSampleExtension_Encryption_NALUTypes, 0xb0f067c7, 0x714c, 0x416c, 0x8d, 0x59, 0x5f, 0x4d, 0xdf, 0x89, 0x13, 0xb6);
DEFINE_GUID(MFSampleExtension_Encryption_SPSPPSData, 0xaede0fa2, 0xe0c, 0x453c, 0xb7, 0xf3, 0xde, 0x86, 0x93, 0x36, 0x4d, 0x11);
DEFINE_GUID(MFSampleExtension_Encryption_SEIData, 0x3cf0e972, 0x4542, 0x4687, 0x99, 0x99, 0x58, 0x5f, 0x56, 0x5f, 0xba, 0x7d);
DEFINE_GUID(MFSampleExtension_Encryption_HardwareProtection, 0x9a2b2d2b, 0x8270, 0x43e3, 0x84, 0x48, 0x99, 0x4f, 0x42, 0x6e, 0x88, 0x86);
...
DEFINE_GUID(MFSampleExtension_DirtyRects, 0x9ba70225, 0xb342, 0x4e97, 0x91, 0x26, 0x0b, 0x56, 0x6a, 0xb7, 0xea, 0x7e);
DEFINE_GUID(MFSampleExtension_MoveRegions, 0xe2a6c693, 0x3a8b, 0x4b8d, 0x95, 0xd0, 0xf6, 0x02, 0x81, 0xa1, 0x2f, 0xb7);
...
DEFINE_GUID(MFSampleExtension_HDCP_OptionalHeader, 0x9a2e7390, 0x121f, 0x455f, 0x83, 0x76, 0xc9, 0x74, 0x28, 0xe0, 0xb5, 0x40);
DEFINE_GUID(MFSampleExtension_HDCP_FrameCounter, 0x9d389c60, 0xf507, 0x4aa6, 0xa4, 0xa, 0x71, 0x2, 0x7a, 0x2, 0xf3, 0xde);
DEFINE_GUID(MFSampleExtension_HDCP_StreamID, 0x177e5d74, 0xc370, 0x4a7a, 0x95, 0xa2, 0x36, 0x83, 0x3c, 0x01, 0xd0, 0xaf);
DEFINE_GUID(MFSampleExtension_Timestamp, 0x1e436999, 0x69be, 0x4c7a, 0x93, 0x69, 0x70, 0x06, 0x8c, 0x02, 0x60, 0xcb);
DEFINE_GUID(MFSampleExtension_RepeatFrame, 0x88be738f, 0x711, 0x4f42, 0xb4, 0x58, 0x34, 0x4a, 0xed, 0x42, 0xec, 0x2f);
DEFINE_GUID(MFT_ENCODER_ERROR, 0xc8d1eda4, 0x98e4, 0x41d5, 0x92, 0x97, 0x44, 0xf5, 0x38, 0x52, 0xf9, 0x0e);
DEFINE_GUID(MFT_GFX_DRIVER_VERSION_ID_Attribute, 0xf34b9093, 0x05e0, 0x4b16, 0x99, 0x3d, 0x3e, 0x2a, 0x2c, 0xde, 0x6a, 0xd3);
...
DEFINE_GUID(MFSampleExtension_LastSlice, 0x2b5d5457, 0x5547, 0x4f07, 0xb8, 0xc8, 0xb4, 0xa3, 0xa9, 0xa1, 0xda, 0xac);
...
DEFINE_GUID(MFSampleExtension_FeatureMap, 0xa032d165, 0x46fc, 0x400a, 0xb4, 0x49, 0x49, 0xde, 0x53, 0xe6, 0x2a, 0x6e);
DEFINE_GUID(MFSampleExtension_ChromaOnly, 0x1eb9179c, 0xa01f, 0x4845, 0x8c, 0x04, 0x0e, 0x65, 0xa2, 0x6e, 0xb0, 0x4f);
...
DEFINE_GUID(MFSampleExtension_MDLCacheCookie, 0x5F002AF9, 0xD8F9, 0x41A3, 0xB6, 0xC3, 0xA2, 0xAD, 0x43, 0xF6, 0x47, 0xAD);
DEFINE_GUID(MF_CAPTURE_METADATA_PHOTO_FRAME_FLASH, 0x0F9DD6C6, 0x6003, 0x45D8, 0xBD, 0x59, 0xF1, 0xF5, 0x3E, 0x3D, 0x04, 0xE8);
DEFINE_GUID(MF_CAPTURE_METADATA_FRAME_RAWSTREAM, 0x9252077B, 0x2680, 0x49B9, 0xAE, 0x02, 0xB1, 0x90, 0x75, 0x97, 0x3B, 0x70);
DEFINE_GUID(MF_CAPTURE_METADATA_FOCUSSTATE, 0xa87ee154, 0x997f, 0x465d, 0xb9, 0x1f, 0x29, 0xd5, 0x3b, 0x98, 0x2b, 0x88);
DEFINE_GUID(MF_CAPTURE_METADATA_REQUESTED_FRAME_SETTING_ID, 0xbb3716d9, 0x8a61, 0x47a4, 0x81, 0x97, 0x45, 0x9c, 0x7f, 0xf1, 0x74, 0xd5);
DEFINE_GUID(MF_CAPTURE_METADATA_EXPOSURE_TIME, 0x16b9ae99, 0xcd84, 0x4063, 0x87, 0x9d, 0xa2, 0x8c, 0x76, 0x33, 0x72, 0x9e);
DEFINE_GUID(MF_CAPTURE_METADATA_EXPOSURE_COMPENSATION, 0xd198aa75, 0x4b62, 0x4345, 0xab, 0xf3, 0x3c, 0x31, 0xfa, 0x12, 0xc2, 0x99);
DEFINE_GUID(MF_CAPTURE_METADATA_ISO_SPEED, 0xe528a68f, 0xb2e3, 0x44fe, 0x8b, 0x65, 0x7, 0xbf, 0x4b, 0x5a, 0x13, 0xff);
DEFINE_GUID(MF_CAPTURE_METADATA_LENS_POSITION, 0xb5fc8e86, 0x11d1, 0x4e70, 0x81, 0x9b, 0x72, 0x3a, 0x89, 0xfa, 0x45, 0x20);
DEFINE_GUID(MF_CAPTURE_METADATA_SCENE_MODE, 0x9cc3b54d, 0x5ed3, 0x4bae, 0xb3, 0x88, 0x76, 0x70, 0xae, 0xf5, 0x9e, 0x13);
DEFINE_GUID(MF_CAPTURE_METADATA_FLASH, 0x4a51520b, 0xfb36, 0x446c, 0x9d, 0xf2, 0x68, 0x17, 0x1b, 0x9a, 0x3, 0x89);
DEFINE_GUID(MF_CAPTURE_METADATA_FLASH_POWER, 0x9c0e0d49, 0x205, 0x491a, 0xbc, 0x9d, 0x2d, 0x6e, 0x1f, 0x4d, 0x56, 0x84);
DEFINE_GUID(MF_CAPTURE_METADATA_WHITEBALANCE, 0xc736fd77, 0xfb9, 0x4e2e, 0x97, 0xa2, 0xfc, 0xd4, 0x90, 0x73, 0x9e, 0xe9);
DEFINE_GUID(MF_CAPTURE_METADATA_ZOOMFACTOR, 0xe50b0b81, 0xe501, 0x42c2, 0xab, 0xf2, 0x85, 0x7e, 0xcb, 0x13, 0xfa, 0x5c);
DEFINE_GUID(MF_CAPTURE_METADATA_FACEROIS, 0x864f25a6, 0x349f, 0x46b1, 0xa3, 0xe, 0x54, 0xcc, 0x22, 0x92, 0x8a, 0x47);
DEFINE_GUID(MF_CAPTURE_METADATA_FACEROITIMESTAMPS, 0xe94d50cc, 0x3da0, 0x44d4, 0xbb, 0x34, 0x83, 0x19, 0x8a, 0x74, 0x18, 0x68);
DEFINE_GUID(MF_CAPTURE_METADATA_FACEROICHARACTERIZATIONS, 0xb927a1a8, 0x18ef, 0x46d3, 0xb3, 0xaf, 0x69, 0x37, 0x2f, 0x94, 0xd9, 0xb2);
DEFINE_GUID(MF_CAPTURE_METADATA_ISO_GAINS, 0x5802ac9, 0xe1d, 0x41c7, 0xa8, 0xc8, 0x7e, 0x73, 0x69, 0xf8, 0x4e, 0x1e);
DEFINE_GUID(MF_CAPTURE_METADATA_SENSORFRAMERATE, 0xdb51357e, 0x9d3d, 0x4962, 0xb0, 0x6d, 0x7, 0xce, 0x65, 0xd, 0x9a, 0xa);
DEFINE_GUID(MF_CAPTURE_METADATA_WHITEBALANCE_GAINS, 0xe7570c8f, 0x2dcb, 0x4c7c, 0xaa, 0xce, 0x22, 0xec, 0xe7, 0xcc, 0xe6, 0x47);
DEFINE_GUID(MF_CAPTURE_METADATA_HISTOGRAM, 0x85358432, 0x2ef6, 0x4ba9, 0xa3, 0xfb, 0x6, 0xd8, 0x29, 0x74, 0xb8, 0x95);
DEFINE_GUID(MF_CAPTURE_METADATA_EXIF, 0x2e9575b8, 0x8c31, 0x4a02, 0x85, 0x75, 0x42, 0xb1, 0x97, 0xb7, 0x15, 0x92);
DEFINE_GUID(MF_CAPTURE_METADATA_FRAME_ILLUMINATION, 0x6D688FFC, 0x63D3, 0x46FE, 0xBA, 0xDA, 0x5B, 0x94, 0x7D, 0xB0, 0xD0, 0x80);
DEFINE_GUID(MF_CAPTURE_METADATA_UVC_PAYLOADHEADER, 0xf9f88a87, 0xe1dd, 0x441e, 0x95, 0xcb, 0x42, 0xe2, 0x1a, 0x64, 0xf1, 0xd9);
DEFINE_GUID(MFSampleExtension_Depth_MinReliableDepth, 0x5f8582b2, 0xe36b, 0x47c8, 0x9b, 0x87, 0xfe, 0xe1, 0xca, 0x72, 0xc5, 0xb0);
DEFINE_GUID(MFSampleExtension_Depth_MaxReliableDepth, 0xe45545d1, 0x1f0f, 0x4a32, 0xa8, 0xa7, 0x61, 0x1, 0xa2, 0x4e, 0xa8, 0xbe);
DEFINE_GUID(MF_CAPTURE_METADATA_FIRST_SCANLINE_START_TIME_QPC, 0x6a2c49f1, 0xe052, 0x46b6, 0xb2, 0xd9, 0x73, 0xc1, 0x55, 0x87, 0x09, 0xaf);
DEFINE_GUID(MF_CAPTURE_METADATA_LAST_SCANLINE_END_TIME_QPC, 0xdccadecb, 0xc4d4, 0x400d, 0xb4, 0x18, 0x10, 0xe8, 0x85, 0x25, 0xe1, 0xf6);
DEFINE_GUID(MF_CAPTURE_METADATA_SCANLINE_TIME_QPC_ACCURACY, 0x4cd79c51, 0xf765, 0x4b09, 0xb1, 0xe1, 0x27, 0xd1, 0xf7, 0xeb, 0xea, 0x09);
DEFINE_GUID(MF_CAPTURE_METADATA_SCANLINE_DIRECTION, 0x6496a3ba, 0x1907, 0x49e6, 0xb0, 0xc3, 0x12, 0x37, 0x95, 0xf3, 0x80, 0xa9);
...
DEFINE_GUID(MF_CAPTURE_METADATA_DIGITALWINDOW, 0x276f72a2, 0x59c8, 0x4f69, 0x97, 0xb4, 0x6, 0x8b, 0x8c, 0xe, 0xc0, 0x44);
...
DEFINE_GUID(MF_CAPTURE_METADATA_FRAME_BACKGROUND_MASK, 0x3f14dd3, 0x75dd, 0x433a, 0xa8, 0xe2, 0x1e, 0x3f, 0x5f, 0x2a, 0x50, 0xa0);
...
STDAPI MFCreateAttributes(
    IMFAttributes **ppMFAttributes,
    UINT32 cInitialSize
);

STDAPI MFInitAttributesFromBlob(
    IMFAttributes *pAttributes,
    const UINT8 *pBuf,
    UINT cbBufSize
);

STDAPI MFGetAttributesAsBlobSize(
    IMFAttributes *pAttributes,
    UINT32 *pcbBufSize
);

STDAPI MFGetAttributesAsBlob(
    IMFAttributes *pAttributes,
    UINT8 *pBuf,
    UINT cbBufSize
);
...
DEFINE_GUID(MFT_CATEGORY_ENCRYPTOR, 0xb0c687be, 0x01cd, 0x44b5, 0xb8, 0xb2, 0x7c, 0x1d, 0x7e, 0x05, 0x8b, 0x1f);
#endif /* (NTDDI_VERSION >= NTDDI_WIN10_RS1) */
#if (NTDDI_VERSION >= NTDDI_WIN10_RS2)
DEFINE_GUID(MFT_CATEGORY_VIDEO_RENDERER_EFFECT, 0x145cd8b4, 0x92f4, 0x4b23, 0x8a, 0xe7, 0xe0, 0xdf, 0x6, 0xc2, 0xda, 0x95);
...
STDAPI MFTUnregister(
    CLSID clsidMFT
);

#if (WINVER >= _WIN32_WINNT_WIN7)

STDAPI MFTRegisterLocal(
    IClassFactory *pClassFactory,
    REFGUID guidCategory,
    LPCWSTR pszName,
    UINT32 Flags,
    UINT32 cInputTypes,
    const MFT_REGISTER_TYPE_INFO *pInputTypes,
    UINT32 cOutputTypes,
    const MFT_REGISTER_TYPE_INFO *pOutputTypes
);

STDAPI MFTUnregisterLocal(
    IClassFactory *pClassFactory
);

STDAPI MFTRegisterLocalByCLSID(
    REFCLSID clisdMFT,
    REFGUID guidCategory,
    LPCWSTR pszName,
    UINT32 Flags,
...
STDAPI MFTUnregisterLocalByCLSID(
    CLSID clsidMFT
);
...
#if (NTDDI_VERSION >= NTDDI_WIN10_RS2)
DEFINE_GUID(MFT_ENUM_VIDEO_RENDERER_EXTENSION_PROFILE, 0x62c56928, 0x9a4e, 0x443b, 0xb9, 0xdc, 0xca, 0xc8, 0x30, 0xc2, 0x41, 0x0);
#endif /* (NTDDI_VERSION >= NTDDI_WIN10_RS2) */
...
STDAPI MFGetPluginControl(
    IMFPluginControl **ppPluginControl
);

STDAPI MFGetMFTMerit(
    IUnknown *pMFT,
    UINT32 cbVerifier,
    const BYTE *verifier,
    DWORD *merit
...
STDAPI MFRegisterLocalSchemeHandler(
    PCWSTR szScheme,
    IMFActivate *pActivate
);

STDAPI MFRegisterLocalByteStreamHandler(
    PCWSTR szFileExtension,
    PCWSTR szMimeType,
    IMFActivate *pActivate
);

STDAPI MFCreateMFByteStreamWrapper(
...
STDAPI MFCreateMediaExtensionActivate(
...
#endif /* (WDK_NTDDI_VERSION >= NTDDI_WIN10) */
...
DEFINE_GUID(MFSubtitleFormat_XML, 0x2006f94f, 0x29ca, 0x4195, 0xb8, 0xdb, 0x00, 0xde, 0xd8, 0xff, 0x0c, 0x97);
DEFINE_GUID(MFSubtitleFormat_TTML, 0x73e73992, 0x9a10, 0x4356, 0x95, 0x57, 0x71, 0x94, 0xe9, 0x1e, 0x3e, 0x54);
DEFINE_GUID(MFSubtitleFormat_ATSC, 0x7fa7faa3, 0xfeae, 0x4e16, 0xae, 0xdf, 0x36, 0xb9, 0xac, 0xfb, 0xb0, 0x99);
DEFINE_GUID(MFSubtitleFormat_WebVTT, 0xc886d215, 0xf485, 0x40bb, 0x8d, 0xb6, 0xfa, 0xdb, 0xc6, 0x19, 0xa4, 0x5d);
DEFINE_GUID(MFSubtitleFormat_SRT, 0x5e467f2e, 0x77ca, 0x4ca5, 0x83, 0x91, 0xd1, 0x42, 0xed, 0x4b, 0x76, 0xc8);
DEFINE_GUID(MFSubtitleFormat_SSA, 0x57176a1b, 0x1a9e, 0x4eea, 0xab, 0xef, 0xc6, 0x17, 0x60, 0x19, 0x8a, 0xc4);
DEFINE_GUID(MFSubtitleFormat_CustomUserData, 0x1bb3d849, 0x6614, 0x4d80, 0x88, 0x82, 0xed, 0x24, 0xaa, 0x82, 0xda, 0x92);
#if (NTDDI_VERSION >= NTDDI_WIN10_VB)
DEFINE_GUID(MFSubtitleFormat_PGS, 0x71f40e4a, 0x1278, 0x4442, 0xb3, 0x0d, 0x39, 0xdd, 0x1d, 0x77, 0x22, 0xbc);
DEFINE_GUID(MFSubtitleFormat_VobSub, 0x6b8e40f4, 0x8d2c, 0x4ced, 0xad, 0x91, 0x59, 0x60, 0xe4, 0x5b, 0x44, 0x33);
#endif /* (NTDDI_VERSION >= NTDDI_WIN10_VB) */

#ifndef DEFINE_BINARY_MEDIATYPE_GUID
#define DEFINE_BINARY_MEDIATYPE_GUID(name, format) \
    DEFINE_GUID(name, format, 0xbf10, 0x48b4, 0xbc, 0x18, 0x59, 0x3d, 0xc1, 0xdb, 0x95, 0xf)
#endif
...
#if (NTDDI_VERSION >= NTDDI_WIN10_RS2)
DEFINE_GUID(MF_DEVICESTREAM_MULTIPLEXED_MANAGER, 0x6ea542b0, 0x281f, 0x4231, 0xa4, 0x64, 0xfe, 0x2f, 0x50, 0x22, 0x50, 0x1c);
DEFINE_GUID(MF_MEDIATYPE_MULTIPLEXED_MANAGER, 0x13c78fb5, 0xf275, 0x4ea0, 0xbb, 0x5f, 0x2, 0x49, 0x83, 0x2b, 0xd, 0x6e);
DEFINE_GUID(MFSampleExtension_MULTIPLEXED_MANAGER, 0x8dcdee79, 0x6b5a, 0x4c45, 0x8d, 0xb9, 0x20, 0xb3, 0x95, 0xf0, 0x2f, 0xcf);
...
DEFINE_GUID(MF_DEVICESTREAM_ATTRIBUTE_FRAMESOURCE_TYPES, 0x17145fd1, 0x1b2b, 0x423c, 0x80, 0x1, 0x2b, 0x68, 0x33, 0xed, 0x35, 0x88);
...
DEFINE_GUID(MF_MT_DEPTH_MEASUREMENT, 0xfd5ac489, 0x917, 0x4bb6, 0x9d, 0x54, 0x31, 0x22, 0xbf, 0x70, 0x14, 0x4b);
DEFINE_GUID(MF_MT_DEPTH_VALUE_UNIT, 0x21a800f5, 0x3189, 0x4797, 0xbe, 0xba, 0xf1, 0x3c, 0xd9, 0xa3, 0x1a, 0x5e);

#endif /* (WINVER >= _WIN32_WINNT_WINTHRESHOLD) */

DEFINE_GUID(MF_MT_VIDEO_NO_FRAME_ORDERING, 0x3f5b106f, 0x6bc2, 0x4ee3, 0xb7, 0xed, 0x89, 0x2, 0xc1, 0x8f, 0x53, 0x51);
...
DEFINE_GUID(MFSampleExtension_ForwardedDecodeUnits, 0x424c754c, 0x97c8, 0x48d6, 0x87, 0x77, 0xfc, 0x41, 0xf7, 0xb6, 0x8, 0x79);
DEFINE_GUID(MFSampleExtension_TargetGlobalLuminance, 0x3f60ef36, 0x31ef, 0x4daf, 0x83, 0x60, 0x94, 0x3, 0x97, 0xe4, 0x1e, 0xf3);
...
DEFINE_GUID(MFSampleExtension_ForwardedDecodeUnitType, 0x89e57c7, 0x47d3, 0x4a26, 0xbf, 0x9c, 0x4b, 0x64, 0xfa, 0xfb, 0x5d, 0x1e);
...
#if (NTDDI_VERSION >= NTDDI_WIN10_VB)
DEFINE_GUID(MF_VIDEO_RENDERER_EFFECT_APP_SERVICE_NAME, 0xc6052a80, 0x6d9c, 0x40a3, 0x9d, 0xb8, 0xf0, 0x27, 0xa2, 0x5c, 0x9a, 0xb9);
#endif /* (NTDDI_VERSION >= NTDDI_WIN10_VB) */
...
DEFINE_GUID(MF_MT_AUDIO_FLAC_MAX_BLOCK_SIZE, 0x8b81adae, 0x4b5a, 0x4d40, 0x80, 0x22, 0xf3, 0x8d, 0x9, 0xca, 0x3c, 0x5c);
...
DEFINE_GUID(MF_MT_SPATIAL_AUDIO_OBJECT_METADATA_LENGTH, 0x94ba8be, 0xd723, 0x489f, 0x92, 0xfa, 0x76, 0x67, 0x77, 0xb3, 0x47, 0x26 );
DEFINE_GUID(MF_MT_SPATIAL_AUDIO_MAX_METADATA_ITEMS, 0x11aa80b4, 0xe0da, 0x47c6, 0x80, 0x60, 0x96, 0xc1, 0x25, 0x9a, 0xe5, 0xd );
DEFINE_GUID(MF_MT_SPATIAL_AUDIO_MIN_METADATA_ITEM_OFFSET_SPACING, 0x83e96ec9, 0x1184, 0x417e, 0x82, 0x54, 0x9f, 0x26, 0x91, 0x58, 0xfc, 0x6 );
...
DEFINE_GUID(MF_MT_DECODER_MAX_DPB_COUNT, 0x67be144c, 0x88b7, 0x4ca9, 0x96, 0x28, 0xc8, 0x8, 0xd5, 0x26, 0x22, 0x17);
#endif /* (WINVER >= _WIN32_WINNT_WIN10) */
...
DEFINE_GUID(MF_MT_CONTAINER_RATE_SCALING, 0x83877f5e, 0x444, 0x4e28, 0x84, 0x79, 0x6d, 0xb0, 0x98, 0x9b, 0x8c, 0x9);
...
#if (NTDDI_VERSION >= NTDDI_WIN10_RS4)
DEFINE_GUID(MF_SD_AMBISONICS_SAMPLE3D_DESCRIPTION, 0xf715cf3e, 0xa964, 0x4c3f, 0x94, 0xae, 0x9d, 0x6b, 0xa7, 0x26, 0x46, 0x41);
#endif /* (NTDDI_VERSION >= NTDDI_WIN10_RS4) */
...
DEFINE_GUID(MFStreamExtension_CameraExtrinsics, 0x686196d0, 0x13e2, 0x41d9, 0x96, 0x38, 0xef, 0x3, 0x2c, 0x27, 0x2a, 0x52);
DEFINE_GUID(MFSampleExtension_CameraExtrinsics, 0x6b761658, 0xb7ec, 0x4c3b, 0x82, 0x25, 0x86, 0x23, 0xca, 0xbe, 0xc3, 0x1d);
...
DEFINE_GUID(MFStreamExtension_PinholeCameraIntrinsics, 0xdbac0455, 0xec8, 0x4aef, 0x9c, 0x32, 0x7a, 0x3e, 0xe3, 0x45, 0x6f, 0x53);
DEFINE_GUID(MFSampleExtension_PinholeCameraIntrinsics, 0x4ee3b6c5, 0x6a15, 0x4e72, 0x97, 0x61, 0x70, 0xc1, 0xdb, 0x8b, 0x9f, 0xe3);
...
#if (WINVER >= _WIN32_WINNT_WIN10)
DEFINE_GUID(MFMediaType_Perception, 0x597ff6f9, 0x6ea2, 0x4670, 0x85, 0xb4, 0xea, 0x84, 0x7, 0x3f, 0xe9, 0x40);
#endif /* (WINVER >= _WIN32_WINNT_WIN10) */
...
DEFINE_GUID(MFMediaType_Metadata, 0x2c8fa20c, 0x82bb, 0x4782, 0x90, 0xa0, 0x98, 0xa2, 0xa5, 0xbd, 0x8e, 0xf8);
...
STDAPI MFValidateMediaTypeSize(
    GUID FormatType,
    UINT8 *pBlock,
    UINT32 cbSize
);
...
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP | WINAPI_PARTITION_GAMES)
STDAPI MFCreateMediaType(
    IMFMediaType **ppMFType
);
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP | WINAPI_PARTITION_GAMES) */

#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP | WINAPI_PARTITION_GAMES)
STDAPI MFCreateMFVideoFormatFromMFMediaType(
...
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP | WINAPI_PARTITION_GAMES)
STDAPI MFCreateWaveFormatExFromMFMediaType(
    IMFMediaType *pMFType,
    WAVEFORMATEX **ppWF,
    UINT32 *pcbSize,
    UINT32 Flags
...
STDAPI MFInitMediaTypeFromVideoInfoHeader(
    IMFMediaType *pMFType,
...
STDAPI MFInitMediaTypeFromVideoInfoHeader2(
    IMFMediaType *pMFType,
...
STDAPI MFInitMediaTypeFromMPEG1VideoInfo(
    IMFMediaType *pMFType,
...
STDAPI MFInitMediaTypeFromMPEG2VideoInfo(
    IMFMediaType *pMFType,
...
#ifndef NOBITMAP
STDAPI MFCalculateBitmapImageSize(
...
STDAPI MFFrameRateToAverageTimePerFrame(
    UINT32 unNumerator,
    UINT32 unDenominator,
    UINT64 *punAverageTimePerFrame
);

STDAPI MFAverageTimePerFrameToFrameRate(
    UINT64 unAverageTimePerFrame,
    UINT32 *punNumerator,
    UINT32 *punDenominator
);

STDAPI MFInitMediaTypeFromMFVideoFormat(
    IMFMediaType *pMFType,
...
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP | WINAPI_PARTITION_GAMES)
STDAPI MFInitMediaTypeFromWaveFormatEx(
    IMFMediaType *pMFType,
...
STDAPI MFInitMediaTypeFromAMMediaType(
    IMFMediaType *pMFType,
    const AM_MEDIA_TYPE *pAMType
);

STDAPI MFInitAMMediaTypeFromMFMediaType(
    IMFMediaType *pMFType,
    GUID guidFormatBlockType,
    AM_MEDIA_TYPE *pAMType
);

STDAPI MFCreateAMMediaTypeFromMFMediaType(
    IMFMediaType *pMFType,
    GUID guidFormatBlockType,
    AM_MEDIA_TYPE **ppAMType
);

STDAPI_(BOOL) MFCompareFullToPartialMediaType(
...
STDAPI MFInitVideoFormat(
    MFVIDEOFORMAT *pVideoFormat,
    MFStandardVideoFormat type
);

STDAPI MFInitVideoFormat_RGB(
    MFVIDEOFORMAT *pVideoFormat,
    DWORD dwWidth,
    DWORD dwHeight,
    DWORD D3Dfmt
...
STDAPI MFConvertColorInfoToDXVA(
    DWORD *pdwToDXVA,
    const MFVIDEOFORMAT *pFromFormat
);
STDAPI MFConvertColorInfoFromDXVA(
...
STDAPI MFGetContentProtectionSystemCLSID(
    REFGUID guidProtectionSystemID,
    CLSID *pclsid);
#endif /* WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP | WINAPI_PARTITION_GAMES) */

#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP)

DEFINE_GUID(MF_DEVICESTREAM_ATTRIBUTE_FACEAUTH_CAPABILITY, 0xCB6FD12A, 0x2248, 0x4E41, 0xAD, 0x46, 0xE7, 0x8B, 0xB9, 0x0A, 0xB9, 0xFC);
DEFINE_GUID(MF_DEVICESTREAM_ATTRIBUTE_SECURE_CAPABILITY, 0x940FD626, 0xEA6E, 0x4684, 0x98, 0x40, 0x36, 0xBD, 0x6E, 0xC9, 0xFB, 0xEF);

#if (NTDDI_VERSION >= NTDDI_WIN10_VB)
STDAPI MFCombineSamples(IMFSample *pSample, IMFSample *pSampleToAdd, DWORD dwMaxMergedDurationInMS, BOOL *pMerged);
STDAPI MFSplitSample(IMFSample *pSample, IMFSample **pOutputSamples, DWORD dwOutputSampleMaxCount, DWORD *pdwOutputSampleCount);
#endif /* (NTDDI_VERSION >= NTDDI_WIN10_VB) */
