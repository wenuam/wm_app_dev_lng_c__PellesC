...
UINT WINAPI MsiProcessAdvertiseScriptW(
    LPCWSTR szScriptFile,
    LPCWSTR szIconFolder,
    HKEY hRegData,
    BOOL fShortcuts,
    BOOL fRemoveItems);
#ifdef UNICODE
...
UINT WINAPI MsiGetProductInfoFromScriptA(
    LPCSTR szScriptFile,
    LPSTR lpProductBuf39,
    LANGID *plgidLanguage,
    LPDWORD pdwVersion,
    LPSTR lpNameBuf,
    LPDWORD pcchNameBuf,
    LPSTR lpPackageBuf,
    LPDWORD pcchPackageBuf);
UINT WINAPI MsiGetProductInfoFromScriptW(
    LPCWSTR szScriptFile,
    LPWSTR lpProductBuf39,
    LANGID *plgidLanguage,
    LPDWORD pdwVersion,
    LPWSTR lpNameBuf,
    LPDWORD pcchNameBuf,
...
UINT WINAPI MsiEnumPatchesExW(
    ...
    DWORD dwFilter,
    DWORD dwIndex,
    WCHAR szPatchCode[39],
    WCHAR szTargetProductCode[39],
    MSIINSTALLCONTEXT *pdwTargetProductContext,
...
UINT WINAPI MsiEnumProductsExA(
    ...
    DWORD dwContext,
    DWORD dwIndex,
    CHAR szInstalledProductCode[39],
...
UINT WINAPI MsiEnumProductsExW(
    ...
    DWORD dwContext,
    DWORD dwIndex,
    WCHAR szInstalledProductCode[39],
    MSIINSTALLCONTEXT *pdwInstalledContext,
    LPWSTR szSid,
    LPDWORD pcchSid);
#ifdef UNICODE
...
UINT WINAPI MsiEnumComponentsExA(
    ...
    DWORD dwContext,
    DWORD dwIndex,
    CHAR szInstalledComponentCode[39],
    MSIINSTALLCONTEXT * pdwInstalledContext,
    LPSTR szSid,
    LPDWORD pcchSid);
UINT WINAPI MsiEnumComponentsExW(
    ...
    DWORD dwContext,
    DWORD dwIndex,
    WCHAR szInstalledComponentCode[39],
    MSIINSTALLCONTEXT * pdwInstalledContext,
    LPWSTR szSid,
    LPDWORD pcchSid);
#ifdef UNICODE
...
#define ERROR_ROLLBACK_DISABLED     1653L
#endif
