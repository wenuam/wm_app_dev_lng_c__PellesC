/* Generated from transact.idl by POIDL version 0.80 - Do not edit */
...
/*****************************************************************************
 * BasicTransactionTypes interface (v0.0)
 */
...
interface IKernelTransaction {
    CONST_VTBL IKernelTransactionVtbl* lpVtbl;
};
