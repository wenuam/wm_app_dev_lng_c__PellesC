...
DWORD APIENTRY TraceRegisterExA(
    LPCSTR lpszCallerName,
    DWORD dwFlags
);

DWORD APIENTRY TraceDeregisterA(
    DWORD dwTraceID
);
...
DWORD APIENTRY TraceGetConsoleA(
    DWORD dwTraceID,
    LPHANDLE lphConsole
);

DWORD __cdecl TracePrintfA(
    DWORD dwTraceID,
    LPCSTR lpszFormat,
    ...
);

DWORD __cdecl TracePrintfExA(
    DWORD dwTraceID,
    DWORD dwFlags,
    LPCSTR lpszFormat,
    ...
...
DWORD APIENTRY TraceVprintfExA(
    DWORD dwTraceID,
    DWORD dwFlags,
    LPCSTR lpszFormat,
    va_list arglist
...
DWORD APIENTRY TracePutsExA(
    DWORD dwTraceID,
    DWORD dwFlags,
    LPCSTR lpszString
);

DWORD APIENTRY TraceDumpExA(
    DWORD dwTraceID,
    DWORD dwFlags,
    LPBYTE lpbBytes,
    DWORD dwByteCount,
...
DWORD APIENTRY TraceRegisterExW(
    LPCWSTR lpszCallerName,
    DWORD dwFlags
);

DWORD APIENTRY TraceDeregisterW(
    DWORD dwTraceID
);
...
DWORD APIENTRY TraceGetConsoleW(
    DWORD dwTraceID,
    LPHANDLE lphConsole
);

DWORD __cdecl TracePrintfW(
    DWORD dwTraceID,
    LPCWSTR lpszFormat,
    ...
);

DWORD __cdecl TracePrintfExW(
    DWORD dwTraceID,
    DWORD dwFlags,
    LPCWSTR lpszFormat,
    ...
...
DWORD APIENTRY TraceVprintfExW(
    DWORD dwTraceID,
    DWORD dwFlags,
    LPCWSTR lpszFormat,
    va_list arglist
...
DWORD APIENTRY TracePutsExW(
    DWORD dwTraceID,
    DWORD dwFlags,
    LPCWSTR lpszString
);

DWORD APIENTRY TraceDumpExW(
    DWORD dwTraceID,
    DWORD dwFlags,
    LPBYTE lpbBytes,
    DWORD dwByteCount,
...
DWORD APIENTRY MprSetupProtocolEnum(
    DWORD dwTransportId,
    LPBYTE * lplpBuffer,
    LPDWORD lpdwEntriesRead
);

DWORD APIENTRY MprSetupProtocolFree(
    LPVOID lpBuffer
);
