...
extern HANDLE WINAPI CryptCATOpen(
    LPWSTR pwszFileName,
    DWORD fdwOpenFlags,
    HCRYPTPROV hProv,
    DWORD dwPublicVersion,
...
extern CRYPTCATATTRIBUTE * WINAPI CryptCATPutCatAttrInfo(HANDLE hCatalog,
    LPWSTR pwszReferenceTag,
    DWORD dwAttrTypeAndAction,
    DWORD cbData,
    BYTE *pbData);

extern CRYPTCATATTRIBUTE * WINAPI CryptCATEnumerateCatAttr(HANDLE hCatalog,
    CRYPTCATATTRIBUTE *pPrevAttr);

extern CRYPTCATMEMBER * WINAPI CryptCATGetMemberInfo(HANDLE hCatalog,
    LPWSTR pwszReferenceTag);

extern CRYPTCATMEMBER * WINAPI CryptCATAllocSortedMemberInfo(HANDLE hCatalog,
    LPWSTR pwszReferenceTag);

extern void WINAPI CryptCATFreeSortedMemberInfo(HANDLE hCatalog,
    CRYPTCATMEMBER *pCatMember);

extern CRYPTCATATTRIBUTE * WINAPI CryptCATGetAttrInfo(HANDLE hCatalog,
    CRYPTCATMEMBER *pCatMember,
    LPWSTR pwszReferenceTag);

extern CRYPTCATMEMBER * WINAPI CryptCATPutMemberInfo(HANDLE hCatalog,
    LPWSTR pwszFileName,
    LPWSTR pwszReferenceTag,
    GUID *pgSubjectType,
    DWORD dwCertVersion,
...
extern CRYPTCATATTRIBUTE * WINAPI CryptCATPutAttrInfo(HANDLE hCatalog,
    CRYPTCATMEMBER *pCatMember,
    LPWSTR pwszReferenceTag,
    DWORD dwAttrTypeAndAction,
    DWORD cbData,
...
extern CRYPTCATMEMBER * WINAPI CryptCATEnumerateMember(HANDLE hCatalog,
    CRYPTCATMEMBER *pPrevMember);

extern CRYPTCATATTRIBUTE * WINAPI CryptCATEnumerateAttr(HANDLE hCatalog,
    CRYPTCATMEMBER *pCatMember,
    CRYPTCATATTRIBUTE *pPrevAttr);

extern CRYPTCATCDF * WINAPI CryptCATCDFOpen(LPWSTR pwszFilePath,
...
extern CRYPTCATMEMBER * WINAPI CryptCATCDFEnumMembers(CRYPTCATCDF *pCDF,
    CRYPTCATMEMBER *pPrevMember,
    PFN_CDF_PARSE_ERROR_CALLBACK pfnParseError);

extern CRYPTCATATTRIBUTE *WINAPI CryptCATCDFEnumAttributes(CRYPTCATCDF *pCDF,
...
extern BOOL WINAPI CryptCATAdminReleaseCatalogContext(
    HCATADMIN hCatAdmin,
    HCATINFO hCatInfo,
    DWORD dwFlags
);
...
extern BOOL WINAPI CryptCATAdminRemoveCatalog(
    HCATADMIN hCatAdmin,
...
extern BOOL WINAPI CryptCATAdminPauseServiceForBackup(
    DWORD dwFlags,
    BOOL fResume
);
