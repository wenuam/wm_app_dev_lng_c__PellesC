...
NET_API_STATUS NET_API_FUNCTION NetServerEnumEx (
    LMCSTR ServerName,
    DWORD Level,
    LPBYTE *Bufptr,
    DWORD PrefMaxlen,
...
NET_API_STATUS NET_API_FUNCTION NetServerTransportAddForInstance(
    LMSTR servername,
    DWORD level,
    LPBYTE bufptr,
...
NET_API_STATUS NET_API_FUNCTION NetServerTransportDelForInstance(
    LMSTR servername,
    DWORD level,
    LPBYTE bufptr,
    LPDWORD InstanceHandle
