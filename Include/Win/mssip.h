...
#if (NTDDI_VERSION >= NTDDI_WIN8)
extern BOOL WINAPI CryptSIPGetCaps(SIP_SUBJECTINFO * pSubjInfo, SIP_CAP_SET *pCaps);
typedef BOOL (WINAPI *pCryptSIPGetCaps)(SIP_SUBJECTINFO * pSubjInfo, SIP_CAP_SET *pCaps);
#endif /* (NTDDI_VERSION >= NTDDI_WIN8) */

#if (NTDDI_VERSION >= NTDDI_WINBLUE)
extern BOOL WINAPI CryptSIPGetSealedDigest(SIP_SUBJECTINFO *pSubjectInfo, const BYTE *pSig, DWORD dwSig, BYTE *pbDigest, DWORD *pcbDigest);
typedef BOOL (WINAPI *pCryptSIPGetSealedDigest)(SIP_SUBJECTINFO *pSubjectInfo, const BYTE *pSig, DWORD dwSig, BYTE *pbDigest, DWORD *pcbDigest);
#endif /* (NTDDI_VERSION >= NTDDI_WINBLUE) */
