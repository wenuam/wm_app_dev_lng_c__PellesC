...
#else /* !(yada,yada) */
#define SetDlgMsgResult(hwnd,msg,result)  __SetDlgMsgResult((hwnd),(msg),(INT_PTR)(result))
static inline INT_PTR __SetDlgMsgResult(HWND hwnd, UINT msg, INT_PTR result) {
    switch (msg) {
