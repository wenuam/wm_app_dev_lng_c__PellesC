...
#define DS_KEY_LIST_FLAG       0x00020000
...
DSGETDCAPI DWORD WINAPI DsGetDcNameA(
    LPCSTR ComputerName,
    LPCSTR DomainName,
    GUID *DomainGuid,
    LPCSTR SiteName,
...
DSGETDCAPI DWORD WINAPI DsGetDcNameW(
...
DSGETDCAPI DWORD WINAPI DsGetSiteNameA(
    LPCSTR ComputerName,
    LPSTR *SiteName
);
DSGETDCAPI DWORD WINAPI DsGetSiteNameW(
    LPCWSTR ComputerName,
    LPWSTR *SiteName
);
#ifdef UNICODE
...
DSGETDCAPI DWORD WINAPI DsValidateSubnetNameW(
    LPCWSTR SubnetName
);
DSGETDCAPI DWORD WINAPI DsValidateSubnetNameA(
    LPCSTR SubnetName
);
#ifdef UNICODE
...
DSGETDCAPI DWORD WINAPI DsAddressToSiteNamesW(
    LPCWSTR ComputerName,
    DWORD EntryCount,
    PSOCKET_ADDRESS SocketAddresses,
    LPWSTR **SiteNames
);
DSGETDCAPI DWORD WINAPI DsAddressToSiteNamesA(
    LPCSTR ComputerName,
    DWORD EntryCount,
    PSOCKET_ADDRESS SocketAddresses,
    LPSTR **SiteNames
...
DSGETDCAPI DWORD WINAPI DsAddressToSiteNamesExW(
    LPCWSTR ComputerName,
    DWORD EntryCount,
    PSOCKET_ADDRESS SocketAddresses,
    LPWSTR **SiteNames,
...
DSGETDCAPI DWORD WINAPI DsAddressToSiteNamesExA(
    LPCSTR ComputerName,
    DWORD EntryCount,
    PSOCKET_ADDRESS SocketAddresses,
    LPSTR **SiteNames,
...
DSGETDCAPI DWORD WINAPI DsEnumerateDomainTrustsW(
    LPWSTR ServerName,
    ULONG Flags,
    PDS_DOMAIN_TRUSTSW *Domains,
    PULONG DomainCount
);
DSGETDCAPI DWORD WINAPI DsEnumerateDomainTrustsA(
    LPSTR ServerName,
    ULONG Flags,
...
#if defined(_NTLSA_H) || defined(_NTSECAPI_H)

DSGETDCAPI DWORD WINAPI DsGetForestTrustInformationW(
    LPCWSTR ServerName,
...
DSGETDCAPI DWORD WINAPI DsMergeForestTrustInformationW(
    LPCWSTR DomainName,
...
#endif /* _NTLSA_H || _NTSECAPI_H */

DSGETDCAPI DWORD WINAPI DsGetDcSiteCoverageW(
    LPCWSTR ServerName,
    PULONG EntryCount,
    LPWSTR * *SiteNames
);
...
DSGETDCAPI DWORD WINAPI DsDeregisterDnsHostRecordsW(
    LPWSTR ServerName,
    LPWSTR DnsDomainName,
    GUID *DomainGuid,
    GUID *DsaGuid,
...
DSGETDCAPI DWORD WINAPI DsDeregisterDnsHostRecordsA(
    LPSTR ServerName,
    LPSTR DnsDomainName,
    GUID *DomainGuid,
    GUID *DsaGuid,
...
DSGETDCAPI DWORD WINAPI DsGetDcOpenW(
    LPCWSTR DnsName,
    ULONG OptionFlags,
    LPCWSTR SiteName,
    GUID *DomainGuid,
...
DSGETDCAPI DWORD WINAPI DsGetDcOpenA(
    LPCSTR DnsName,
    ULONG OptionFlags,
    LPCSTR SiteName,
    GUID *DomainGuid,
...
DSGETDCAPI void WINAPI DsGetDcCloseW(
    HANDLE GetDcContextHandle
);
#ifdef UNICODE
