...
typedef BOOL (CALLBACK *PFN_AUTHZ_GET_CENTRAL_ACCESS_POLICY)(
    ...
    PSID capid,
    PVOID pArgs,
    PBOOL pCentralAccessPolicyApplicable,
    PVOID *ppCentralAccessPolicy
);

typedef void (CALLBACK *PFN_AUTHZ_FREE_CENTRAL_ACCESS_POLICY)(
    PVOID pCentralAccessPolicy
);
...
AUTHZAPI BOOL WINAPI AuthzAccessCheck(
    DWORD Flags,
    AUTHZ_CLIENT_CONTEXT_HANDLE hAuthzClientContext,
...
AUTHZAPI BOOL WINAPI AuthzCachedAccessCheck(
    DWORD Flags,
...
AUTHZAPI BOOL WINAPI AuthzOpenObjectAudit(
    DWORD Flags,
    AUTHZ_CLIENT_CONTEXT_HANDLE hAuthzClientContext,
    PAUTHZ_ACCESS_REQUEST pRequest,
    AUTHZ_AUDIT_EVENT_HANDLE hAuditEvent,
...
AUTHZAPI BOOL WINAPI AuthzFreeHandle(
    AUTHZ_ACCESS_CHECK_RESULTS_HANDLE hAccessCheckResults
);
...
AUTHZAPI BOOL WINAPI AuthzInitializeResourceManagerEx(
    DWORD Flags,
    PAUTHZ_INIT_INFO pAuthzInitInfo,
    PAUTHZ_RESOURCE_MANAGER_HANDLE phAuthzResourceManager
);

AUTHZAPI BOOL WINAPI AuthzInitializeRemoteResourceManager(
...
AUTHZAPI BOOL WINAPI AuthzFreeResourceManager(
    AUTHZ_RESOURCE_MANAGER_HANDLE hAuthzResourceManager
);

AUTHZAPI BOOL WINAPI AuthzInitializeContextFromToken(
    DWORD Flags,
    HANDLE TokenHandle,
    AUTHZ_RESOURCE_MANAGER_HANDLE hAuthzResourceManager,
...
AUTHZAPI BOOL WINAPI AuthzInitializeContextFromAuthzContext(
    DWORD Flags,
    AUTHZ_CLIENT_CONTEXT_HANDLE hAuthzClientContext,
    PLARGE_INTEGER pExpirationTime,
    LUID Identifier,
...
AUTHZAPI BOOL WINAPI AuthzInitializeCompoundContext(
...
AUTHZAPI BOOL WINAPI AuthzAddSidsToContext(
    AUTHZ_CLIENT_CONTEXT_HANDLE hAuthzClientContext,
...
AUTHZAPI BOOL WINAPI AuthzModifySecurityAttributes(
    AUTHZ_CLIENT_CONTEXT_HANDLE hAuthzClientContext,
...
#if (_WIN32_WINNT >= _WIN32_WINNT_WIN8)
AUTHZAPI BOOL WINAPI AuthzModifyClaims(
    AUTHZ_CLIENT_CONTEXT_HANDLE hAuthzClientContext,
...
AUTHZAPI BOOL WINAPI AuthzModifySids(
    AUTHZ_CLIENT_CONTEXT_HANDLE hAuthzClientContext,
...
AUTHZAPI BOOL WINAPI AuthzSetAppContainerInformation(
    AUTHZ_CLIENT_CONTEXT_HANDLE hAuthzClientContext,
...
AUTHZAPI BOOL WINAPI AuthzGetInformationFromContext(
    AUTHZ_CLIENT_CONTEXT_HANDLE hAuthzClientContext,
...
AUTHZAPI BOOL WINAPI AuthzFreeContext(
    AUTHZ_CLIENT_CONTEXT_HANDLE hAuthzClientContext
);
...
#define AUTHZ_VALID_OBJECT_ACCESS_AUDIT_FLAGS \
    (AUTHZ_NO_SUCCESS_AUDIT | \
     AUTHZ_NO_FAILURE_AUDIT | \
     AUTHZ_NO_ALLOC_STRINGS | \
     AUTHZ_WPD_CATEGORY_FLAG)

AUTHZAPI BOOL WINAPIV AuthzInitializeObjectAccessAuditEvent(
    DWORD Flags,
...
AUTHZAPI BOOL WINAPIV AuthzInitializeObjectAccessAuditEvent2(
    DWORD Flags,
    AUTHZ_AUDIT_EVENT_TYPE_HANDLE hAuditEventType,
    PWSTR szOperationType,
    PWSTR szObjectType,
...
AUTHZAPI BOOL WINAPI AuthzFreeAuditEvent(
    AUTHZ_AUDIT_EVENT_HANDLE hAuditEvent
);

AUTHZAPI BOOL WINAPI AuthzEvaluateSacl(
    AUTHZ_CLIENT_CONTEXT_HANDLE AuthzClientContext,
    PAUTHZ_ACCESS_REQUEST pRequest,
    PACL Sacl,
    ACCESS_MASK GrantedAccess,
    BOOL AccessGranted,
    PBOOL pbGenerateAudit
);
...
AUTHZAPI BOOL WINAPI AuthzInstallSecurityEventSource(
    DWORD dwFlags,
    PAUTHZ_SOURCE_SCHEMA_REGISTRATION pRegistration
);

AUTHZAPI BOOL WINAPI AuthzUninstallSecurityEventSource(
    DWORD dwFlags,
    PCWSTR szEventSourceName
);

AUTHZAPI BOOL WINAPI AuthzEnumerateSecurityEventSources(
    DWORD dwFlags,
...
AUTHZAPI BOOL WINAPI AuthzRegisterSecurityEventSource(
    DWORD dwFlags,
    PCWSTR szEventSourceName,
    PAUTHZ_SECURITY_EVENT_PROVIDER_HANDLE phEventProvider
);

AUTHZAPI BOOL WINAPI AuthzUnregisterSecurityEventSource(
    DWORD dwFlags,
    PAUTHZ_SECURITY_EVENT_PROVIDER_HANDLE phEventProvider
);

AUTHZAPI BOOL WINAPIV AuthzReportSecurityEvent(
    DWORD dwFlags,
...
AUTHZAPI BOOL WINAPI AuthzReportSecurityEventFromParams(
    DWORD dwFlags,
    AUTHZ_SECURITY_EVENT_PROVIDER_HANDLE hEventProvider,
    DWORD dwAuditId,
    PSID pUserSid,
...
#if (_WIN32_WINNT >= _WIN32_WINNT_WIN8)
AUTHZAPI BOOL WINAPI AuthzRegisterCapChangeNotification(
    PAUTHZ_CAP_CHANGE_SUBSCRIPTION_HANDLE phCapChangeSubscription,
    LPTHREAD_START_ROUTINE pfnCapChangeCallback,
    PVOID pCallbackContext
);

AUTHZAPI BOOL WINAPI AuthzUnregisterCapChangeNotification(
