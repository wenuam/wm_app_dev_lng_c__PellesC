...
typedef HRESULT(STDMETHODCALLTYPE *LPOPENTNEFSTREAM)(
    LPVOID lpvSupport,
    LPSTREAM lpStream,
    LPTSTR lpszStreamName,
    ULONG ulFlags,
...
typedef HRESULT (STDMETHODCALLTYPE *LPOPENTNEFSTREAMEX)(
    LPVOID lpvSupport,
    LPSTREAM lpStream,
    LPTSTR lpszStreamName,
    ULONG ulFlags,
...
typedef HRESULT (STDMETHODCALLTYPE * LPGETTNEFSTREAMCODEPAGE)(
    LPSTREAM lpStream,
    ULONG *lpulCodepage,
    ULONG *lpulSubCodepage);
