...
#define PT_ROAMING_PREEXISTING  0x00000008      
...
USERENVAPI HRESULT WINAPI CreateProfile(
    LPCWSTR pszUserSid,
    LPCWSTR pszUserName,
...
USERENVAPI BOOL WINAPI GetGPOListA(
    HANDLE hToken,
    LPCSTR lpName,
    LPCSTR lpHostName,
...
USERENVAPI BOOL WINAPI GetGPOListW(
    HANDLE hToken,
    LPCWSTR lpName,
    LPCWSTR lpHostName,
    LPCWSTR lpComputerName,
    DWORD dwFlags,
    PGROUP_POLICY_OBJECTW *pGPOList
);
#ifdef UNICODE
...
USERENVAPI DWORD WINAPI GetAppliedGPOListA(
    DWORD dwFlags,
    LPCSTR pMachineName,
    PSID pSidUser,
    GUID *pGuidExtension,
    PGROUP_POLICY_OBJECTA *ppGPOList
);
USERENVAPI DWORD WINAPI GetAppliedGPOListW(
    DWORD dwFlags,
...
USERENVAPI DWORD WINAPI ProcessGroupPolicyCompleted(
...
USERENVAPI HRESULT WINAPI RsopAccessCheckByType(
...
USERENVAPI HRESULT WINAPI RsopFileAccessCheck(
    LPWSTR pszFileName,
    PRSOPTOKEN pRsopToken,
    DWORD dwDesiredAccessMask,
    LPDWORD pdwGrantedAccessMask,
...
USERENVAPI HRESULT WINAPI RsopSetPolicySettingStatus(DWORD dwFlags,
    IWbemServices *pServices,
    IWbemClassObject *pSettingInstance,
    DWORD nInfo,
    POLICYSETTINGSTATUSINFO *pStatus);

USERENVAPI HRESULT WINAPI RsopResetPolicySettingStatus(DWORD dwFlags,
    IWbemServices *pServices,
    IWbemClassObject *pSettingInstance);
...
USERENVAPI DWORD WINAPI GenerateGPNotification(
    BOOL bMachine,
...
USERENVAPI HRESULT WINAPI CreateAppContainerProfile(
...
USERENVAPI HRESULT WINAPI DeleteAppContainerProfile(
    PCWSTR pszAppContainerName);
...
USERENVAPI HRESULT WINAPI GetAppContainerRegistryLocation(
...
USERENVAPI HRESULT WINAPI GetAppContainerFolderPath(
...
USERENVAPI HRESULT WINAPI  DeriveRestrictedAppContainerSidFromAppContainerSidAndRestrictedName(
    PSID psidAppContainerSid,
    PCWSTR pszRestrictedAppContainerName,
...
USERENVAPI HRESULT WINAPI DeriveAppContainerSidFromAppContainerName(
    PCWSTR pszAppContainerName,
    PSID *ppsidAppContainerSid);
