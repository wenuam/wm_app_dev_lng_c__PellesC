...
SNMPAPI_STATUS SNMPAPI_CALL SnmpGetTimeout(
    ...
    smiLPTIMETICKS nPolicyTimeout,
    smiLPTIMETICKS nActualTimeout);
...
SNMPAPI_STATUS SNMPAPI_CALL SnmpGetRetry(
    HSNMP_ENTITY hEntity,
    smiLPUINT32 nPolicyRetry,
    smiLPUINT32 nActualRetry);
...
SNMPAPI_STATUS SNMPAPI_CALL SnmpRecvMsg(
    HSNMP_SESSION session,
    LPHSNMP_ENTITY srcEntity,
    LPHSNMP_ENTITY dstEntity,
...
SNMPAPI_STATUS SNMPAPI_CALL SnmpListen(
    HSNMP_ENTITY hEntity,
    SNMPAPI_STATUS lStatus);

SNMPAPI_STATUS SNMPAPI_CALL SnmpListenEx(
    HSNMP_ENTITY hEntity,
    SNMPAPI_STATUS lStatus,
    smiUINT32 nUseEntityAddr);
...
typedef SNMPAPI_STATUS (SNMPAPI_CALL *PFNSNMPSTARTUPEX)(
    smiLPUINT32,
    smiLPUINT32,
    smiLPUINT32,
    smiLPUINT32,
...
SNMPAPI_STATUS SNMPAPI_CALL SnmpGetPduData(
    HSNMP_PDU PDU,
    smiLPINT PDU_type,
    smiLPINT32 request_id,
    smiLPINT error_status,
    smiLPINT error_index,
    LPHSNMP_VBL varbindlist);

SNMPAPI_STATUS SNMPAPI_CALL SnmpSetPduData(
    HSNMP_PDU PDU,
    const smiINT *PDU_type,
    const smiINT32 *request_id,
    const smiINT *non_repeaters,
    const smiINT *max_repetitions,
    const HSNMP_VBL *varbindlist);
