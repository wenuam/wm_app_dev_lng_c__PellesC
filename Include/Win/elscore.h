...
typedef void (CALLBACK *PFN_MAPPINGCALLBACKPROC)(
    struct _MAPPING_PROPERTY_BAG *pBag,
    LPVOID data,
    DWORD dwDataSize,
    HRESULT Result
);
...
HRESULT WINAPI MappingDoAction(
    PMAPPING_PROPERTY_BAG pBag,
    DWORD dwRangeIndex,
    LPCWSTR pszActionId
);
...
HRESULT WINAPI MappingFreePropertyBag(
    PMAPPING_PROPERTY_BAG pBag
);
