...
typedef NTSTATUS (BCLASS_QUERY_TAG_CALLBACK)(
    PVOID Context,
    PULONG BatteryTag
);
...
typedef NTSTATUS (BCLASS_QUERY_INFORMATION_CALLBACK)(
    PVOID Context,
    ULONG BatteryTag,
...
typedef NTSTATUS (BCLASS_QUERY_STATUS_CALLBACK)(
    PVOID Context,
    ULONG BatteryTag,
...
typedef NTSTATUS (BCLASS_SET_STATUS_NOTIFY_CALLBACK)(
    PVOID Context,
    ULONG BatteryTag,
...
typedef NTSTATUS (BCLASS_SET_INFORMATION_CALLBACK)(
    PVOID Context,
    ULONG BatteryTag,
...
typedef NTSTATUS (BCLASS_DISABLE_STATUS_NOTIFY_CALLBACK)(
    PVOID Context
);
...
NTSTATUS BATTERYCLASSAPI BatteryClassInitializeDevice(
    PBATTERY_MINIPORT_INFO MiniportInfo,
    PVOID *ClassData
);
