...
typedef struct ISideShowContentManagerVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *GetDeviceCapabilities )(
        ISideShowContentManager * This,
        ISideShowCapabilitiesCollection * *out_ppCollection);
...
typedef struct ISideShowCapabilitiesCollectionVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *GetAt )(
        ISideShowCapabilitiesCollection * This,
        DWORD in_dwIndex,
        ISideShowCapabilities * *out_ppCapabilities);
...
typedef struct ISideShowBulkCapabilitiesVtbl {
    ...
    HRESULT(STDMETHODCALLTYPE *QueryInterface)(
        ISideShowBulkCapabilities * This,
        REFIID riid,
        void * *ppvObject);
    ...
    HRESULT (STDMETHODCALLTYPE *GetCapabilities )(
        ISideShowBulkCapabilities * This,
        ISideShowKeyCollection *in_keyCollection,
        ISideShowPropVariantCollection * *inout_pValues);
...
typedef struct ISideShowPropVariantCollectionVtbl {
    ...
    HRESULT(STDMETHODCALLTYPE *QueryInterface)(
        ISideShowPropVariantCollection * This,
        REFIID riid,
        void * *ppvObject);
