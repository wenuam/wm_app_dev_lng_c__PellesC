...
#define HTTPSPROV_ACTION                                        \
    { 0x573e31f8, 0xaaba, 0x11d0, { 0x8c, 0xcb, 0x0, 0xc0, 0x4f, 0xc2, 0x95, 0xee } }
...
#define OFFICESIGN_ACTION_VERIFY                                    \
    { 0x5555c2cd, 0x17fb, 0x11d1, { 0x85, 0xc4, 0x0, 0xc0, 0x4f, 0xc2, 0x95, 0xee } }
...
#define CONFIG_CI_ACTION_VERIFY  \
    { 0x6078065b, 0x8f22, 0x4b13, {0xbd, 0x9b, 0x5b, 0x76, 0x27, 0x76, 0xf3, 0x86} }
...
typedef struct CONFIG_CI_PROV_INFO_RESULT2_ {
    DWORD cbSize;
    HRESULT hr;
    DWORD dwResult;
    DWORD dwPolicyIndex;
