...
typedef struct IAzScope2Vtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *CreateRoleDefinition )(
        IAzScope2 * This,
        BSTR bstrRoleDefinitionName,
        IAzRoleDefinition * *ppRoleDefinitions);
    ...
    HRESULT (STDMETHODCALLTYPE *CreateRoleAssignment )(
        IAzScope2 * This,
        BSTR bstrRoleAssignmentName,
        IAzRoleAssignment * *ppRoleAssignment);
