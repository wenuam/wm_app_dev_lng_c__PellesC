...
#define WAB_IWABOBJECT_METHODS(IPURE) \
    ...
    MAPIMETHOD(AllocateBuffer)(THIS_ ULONG cbSize, LPVOID *lppBuffer) IPURE; \
    MAPIMETHOD(AllocateMore)(THIS_ ULONG cbSize, LPVOID lpObject, LPVOID *lppBuffer) IPURE; \
    MAPIMETHOD(FreeBuffer)(THIS_ LPVOID lpBuffer) IPURE; \
    MAPIMETHOD(Backup)(THIS_ LPSTR lpFileName) IPURE; \
    MAPIMETHOD(Import)(THIS_ LPSTR lpWIP) IPURE; \
    MAPIMETHOD(Find)(THIS_ LPADRBOOK lpIAB, HWND hWnd) IPURE; \
    MAPIMETHOD(VCardDisplay)(THIS_ LPADRBOOK lpIAB, HWND hWnd, LPSTR lpszFileName) IPURE; \
    MAPIMETHOD(LDAPUrl)(THIS_ LPADRBOOK lpIAB, HWND hWnd, ULONG ulFlags, LPSTR lpszURL, LPMAILUSER *lppMailUser) IPURE; \
    MAPIMETHOD(VCardCreate)(THIS_ LPADRBOOK lpIAB, ULONG ulFlags, LPSTR lpszVCard, LPMAILUSER lpMailUser) IPURE; \
    MAPIMETHOD(VCardRetrieve)(THIS_ LPADRBOOK lpIAB, ULONG ulFlags, LPSTR lpszVCard, LPMAILUSER *lppMailUser) IPURE; \
    MAPIMETHOD(GetMe)(THIS_ LPADRBOOK lpIAB, ULONG ulFlags, DWORD *lpdwAction, SBinary *lpsbEID, HWND hwnd) IPURE; \
    MAPIMETHOD(SetMe)(THIS_ LPADRBOOK lpIAB, ULONG ulFlags, SBinary sbEID, HWND hwnd) IPURE;
...
#define WAB_IWABEXTINIT_METHODS(IPURE) \
    MAPIMETHOD(Initialize)(THIS_ LPWABEXTDISPLAY lpWABExtDisplay) IPURE;
