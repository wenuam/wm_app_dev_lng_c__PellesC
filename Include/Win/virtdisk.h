...
DWORD WINAPI GetAllAttachedVirtualDiskPhysicalPaths(
...
DWORD WINAPI GetVirtualDiskMetadata(
    HANDLE VirtualDiskHandle,
    const GUID *Item,
    PULONG MetaDataSize,
    PVOID MetaData
...
DWORD WINAPI DeleteVirtualDiskMetadata(
    HANDLE VirtualDiskHandle,
    const GUID *Item
);
...
DWORD WINAPI ResizeVirtualDisk(
    HANDLE VirtualDiskHandle,
...
DWORD WINAPI BreakMirrorVirtualDisk(
    HANDLE VirtualDiskHandle
);
...
DWORD WINAPI AddVirtualDiskParent(
    HANDLE VirtualDiskHandle,
    PCWSTR ParentPath
);
...
DWORD WINAPI QueryChangesVirtualDisk(
    HANDLE VirtualDiskHandle,
...
DWORD WINAPI RawSCSIVirtualDisk(
    HANDLE VirtualDiskHandle,
...
DWORD WINAPI CompleteForkVirtualDisk(
    HANDLE VirtualDiskHandle
);
...
#endif /* ((WINVER >= _WIN32_WINNT_WIN7) || defined(VIRTDISK_DEFINE_FLAGS)) */
