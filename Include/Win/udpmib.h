...
#define SIZEOF_UDPTABLE(X) \
    (FIELD_OFFSET(MIB_UDPTABLE, table[0]) + \
...
#define SIZEOF_UDPTABLE_OWNER_PID(X) \
    (FIELD_OFFSET(MIB_UDPTABLE_OWNER_PID, table[0]) + \
...
#define SIZEOF_UDPTABLE_OWNER_MODULE(X) \
    (FIELD_OFFSET(MIB_UDPTABLE_OWNER_MODULE, table[0]) + \
...
#define SIZEOF_UDPTABLE2(X) \
    (FIELD_OFFSET(MIB_UDPTABLE2, table[0]) + \
...
#define SIZEOF_UDP6TABLE(X) \
    (FIELD_OFFSET(MIB_UDP6TABLE, table[0]) + \
...
#define SIZEOF_UDP6TABLE_OWNER_PID(X) \
    (FIELD_OFFSET(MIB_UDP6TABLE_OWNER_PID, table[0]) + \
...
#define SIZEOF_UDP6TABLE_OWNER_MODULE(X) \
    (FIELD_OFFSET(MIB_UDP6TABLE_OWNER_MODULE, table[0]) + \
...
#define SIZEOF_UDP6TABLE2(X) \
    (FIELD_OFFSET(MIB_UDP6TABLE2, table[0]) + \
