...
struct sqlite3_api_routines {
  ...
  char * (SQLITE_CDECL /*SQLITE_APICALL*/ *mprintf)(const char*,...);
  ...
  char * (SQLITE_CDECL /*SQLITE_APICALL*/ *xsnprintf)(int,char*,const char*,...);
  ...
  int (SQLITE_CDECL /*SQLITE_APICALL*/ *test_control)(int, ...);
  ...
  int (SQLITE_APICALL *create_function_v2)(sqlite3*,const char*,int,int,void*,
                            ...
                            void (SQLITE_APICALL *xFinal)(sqlite3_context*),
                            void(SQLITE_APICALL *xDestroy)(void*));
  int (SQLITE_CDECL /*SQLITE_APICALL*/ *db_config)(sqlite3*,int,...);
  ...
  void (SQLITE_CDECL /*SQLITE_APICALL*/ *log)(int,const char*,...);
  ...
  int (SQLITE_CDECL /*SQLITE_APICALL*/ *vtab_config)(sqlite3*,int op,...);
  ...
  void (SQLITE_CDECL /*SQLITE_APICALL*/ *str_appendf)(sqlite3_str*, const char *zFormat, ...);
