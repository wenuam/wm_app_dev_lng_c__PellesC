...
WINLDAPAPI LDAP * LDAPAPI ldap_openW(const PWSTR HostName, ULONG PortNumber);
WINLDAPAPI LDAP * LDAPAPI ldap_openA(const PSTR HostName, ULONG PortNumber);

WINLDAPAPI LDAP * LDAPAPI ldap_initW(const PWSTR HostName, ULONG PortNumber);
WINLDAPAPI LDAP * LDAPAPI ldap_initA(const PSTR HostName, ULONG PortNumber);

WINLDAPAPI LDAP * LDAPAPI ldap_sslinitW(PWSTR HostName, ULONG PortNumber, int secure);
WINLDAPAPI LDAP * LDAPAPI ldap_sslinitA(PSTR HostName, ULONG PortNumber, int secure);
...
WINLDAPAPI LDAP * LDAPAPI ldap_open(PSTR HostName, ULONG PortNumber);
WINLDAPAPI LDAP * LDAPAPI ldap_init(PSTR HostName, ULONG PortNumber);
WINLDAPAPI LDAP * LDAPAPI ldap_sslinit(PSTR HostName, ULONG PortNumber, int secure);

#endif

WINLDAPAPI LDAP * LDAPAPI cldap_openW(PWSTR HostName, ULONG PortNumber);
WINLDAPAPI LDAP * LDAPAPI cldap_openA(PSTR HostName, ULONG PortNumber);
...
WINLDAPAPI LDAP * LDAPAPI cldap_open(PSTR HostName, ULONG PortNumber);
...
WINLDAPAPI ULONG LDAPAPI ldap_simple_bindW(LDAP *ld, PWSTR dn, PWSTR passwd);
WINLDAPAPI ULONG LDAPAPI ldap_simple_bindA(LDAP *ld, PSTR dn, PSTR passwd);
WINLDAPAPI ULONG LDAPAPI ldap_simple_bind_sW(LDAP *ld, PWSTR dn, PWSTR passwd);
WINLDAPAPI ULONG LDAPAPI ldap_simple_bind_sA(LDAP *ld, PSTR dn, PSTR passwd);

WINLDAPAPI ULONG LDAPAPI ldap_bindW(LDAP *ld, PWSTR dn, PWCHAR cred, ULONG method);
WINLDAPAPI ULONG LDAPAPI ldap_bindA(LDAP *ld, PSTR dn, PCHAR cred, ULONG method);
WINLDAPAPI ULONG LDAPAPI ldap_bind_sW(LDAP *ld, PWSTR dn, PWCHAR cred, ULONG method);
WINLDAPAPI ULONG LDAPAPI ldap_bind_sA(LDAP *ld, PSTR dn, PCHAR cred, ULONG method);

WINLDAPAPI INT LDAPAPI ldap_sasl_bindA(
    LDAP *ExternalHandle,
    const PSTR DistName,
    const PSTR AuthMechanism,
    const BERVAL *cred,
...
WINLDAPAPI INT LDAPAPI ldap_sasl_bindW(
    LDAP *ExternalHandle,
    const PWSTR DistName,
    const PWSTR AuthMechanism,
    const BERVAL *cred,
...
WINLDAPAPI ULONG LDAPAPI ldap_simple_bind_s(LDAP *ld, const PSTR dn, const PSTR passwd);

WINLDAPAPI ULONG LDAPAPI ldap_bind(LDAP *ld, const PSTR dn, const PCHAR cred, ULONG method);
...
WINLDAPAPI ULONG LDAPAPI ldap_modifyW(LDAP *ld, PWSTR dn, LDAPModW *mods[]);
WINLDAPAPI ULONG LDAPAPI ldap_modifyA(LDAP *ld, PSTR dn, LDAPModA *mods[]);

WINLDAPAPI ULONG LDAPAPI ldap_modify_sW(LDAP *ld, PWSTR dn, LDAPModW *mods[]);
WINLDAPAPI ULONG LDAPAPI ldap_modify_sA(LDAP *ld, PSTR dn, LDAPModA *mods[]);
...
WINLDAPAPI ULONG LDAPAPI ldap_modify(LDAP *ld, PSTR dn, LDAPModA *mods[]);
WINLDAPAPI ULONG LDAPAPI ldap_modify_s(LDAP *ld, PSTR dn, LDAPModA *mods[]);
...
WINLDAPAPI ULONG LDAPAPI ldap_addW(LDAP *ld, PWSTR dn, LDAPModW *attrs[]);
WINLDAPAPI ULONG LDAPAPI ldap_addA(LDAP *ld, PSTR dn, LDAPModA *attrs[]);

WINLDAPAPI ULONG LDAPAPI ldap_add_sW(LDAP *ld, PWSTR dn, LDAPModW *attrs[]);
WINLDAPAPI ULONG LDAPAPI ldap_add_sA(LDAP *ld, PSTR dn, LDAPModA *attrs[]);
...
WINLDAPAPI ULONG LDAPAPI ldap_add(LDAP *ld, PSTR dn, LDAPMod *attrs[]);
WINLDAPAPI ULONG LDAPAPI ldap_add_s(LDAP *ld, PSTR dn, LDAPMod *attrs[]);
...
WINLDAPAPI ULONG LDAPAPI ldap_compareW(LDAP *ld, const PWSTR dn, const PWSTR attr, PWSTR value);
WINLDAPAPI ULONG LDAPAPI ldap_compareA(LDAP *ld, const PSTR dn, const PSTR attr, PSTR value);

WINLDAPAPI ULONG LDAPAPI ldap_compare_sW(LDAP *ld, const PWSTR dn, const PWSTR attr, PWSTR value);
WINLDAPAPI ULONG LDAPAPI ldap_compare_sA(LDAP *ld, const PSTR dn, const PSTR attr, PSTR value);
...
WINLDAPAPI ULONG LDAPAPI ldap_compare(LDAP *ld, const PSTR dn, const PSTR attr, PSTR value);
WINLDAPAPI ULONG LDAPAPI ldap_compare_s(LDAP *ld, const PSTR dn, const PSTR attr, PSTR value);
...
WINLDAPAPI ULONG LDAPAPI ldap_deleteW(LDAP *ld, const PWSTR dn);
WINLDAPAPI ULONG LDAPAPI ldap_deleteA(LDAP *ld, const PSTR dn);

WINLDAPAPI ULONG LDAPAPI ldap_delete_sW(LDAP *ld, const PWSTR dn);
WINLDAPAPI ULONG LDAPAPI ldap_delete_sA(LDAP *ld, const PSTR dn);
...
WINLDAPAPI ULONG LDAPAPI ldap_delete(LDAP *ld, PSTR dn);
WINLDAPAPI ULONG LDAPAPI ldap_delete_s(LDAP *ld, PSTR dn);
...
WINLDAPAPI PWCHAR *LDAPAPI ldap_explode_dnW( const PWSTR dn, ULONG notypes );
WINLDAPAPI PCHAR *LDAPAPI ldap_explode_dnA( const PSTR dn, ULONG notypes );
...
WINLDAPAPI PCHAR *LDAPAPI ldap_explode_dn( const PSTR dn, ULONG notypes );

#endif

WINLDAPAPI PWCHAR LDAPAPI ldap_dn2ufnW( const PWSTR dn );
WINLDAPAPI PCHAR LDAPAPI ldap_dn2ufnA( const PSTR dn );
...
WINLDAPAPI PCHAR LDAPAPI ldap_dn2ufn( const PSTR dn );
