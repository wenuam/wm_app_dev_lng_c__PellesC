...
WINADVAPI BOOL WINAPI ChangeServiceConfig2A(
    SC_HANDLE hService,
    DWORD dwInfoLevel,
    LPVOID lpInfo
);

WINADVAPI BOOL WINAPI ChangeServiceConfig2W(
    SC_HANDLE hService,
    DWORD dwInfoLevel,
    LPVOID lpInfo
);
...
WINADVAPI BOOL WINAPI CloseServiceHandle(
    SC_HANDLE hSCObject
);
...
WINADVAPI BOOL WINAPI DeleteService(
    SC_HANDLE hService
);
...
WINADVAPI BOOL WINAPI GetServiceKeyNameA(
    SC_HANDLE hSCManager,
    LPCSTR lpDisplayName,
    LPSTR lpServiceName,
    LPDWORD lpcchBuffer
...
WINADVAPI BOOL WINAPI GetServiceKeyNameW(
    SC_HANDLE hSCManager,
    LPCWSTR lpDisplayName,
    LPWSTR lpServiceName,
    LPDWORD lpcchBuffer
...
WINADVAPI BOOL WINAPI GetServiceDisplayNameA(
    SC_HANDLE hSCManager,
    LPCSTR lpServiceName,
    LPSTR lpDisplayName,
    LPDWORD lpcchBuffer
...
WINADVAPI BOOL WINAPI GetServiceDisplayNameW(
    SC_HANDLE hSCManager,
    LPCWSTR lpServiceName,
    LPWSTR lpDisplayName,
    LPDWORD lpcchBuffer
...
WINADVAPI SC_LOCK WINAPI LockServiceDatabase(
    SC_HANDLE hSCManager
);

WINADVAPI BOOL WINAPI NotifyBootConfigStatus(
    BOOL BootAcceptable
);
...
WINADVAPI SC_HANDLE WINAPI OpenSCManagerA(
...
WINADVAPI SC_HANDLE WINAPI OpenServiceA(
    SC_HANDLE hSCManager,
    LPCSTR lpServiceName,
    DWORD dwDesiredAccess
);

WINADVAPI SC_HANDLE WINAPI OpenServiceW(
    SC_HANDLE hSCManager,
    LPCWSTR lpServiceName,
    DWORD dwDesiredAccess
);
...
WINADVAPI BOOL WINAPI QueryServiceStatus(
    SC_HANDLE hService,
    LPSERVICE_STATUS lpServiceStatus
);
...
WINADVAPI BOOL WINAPI SetServiceStatus(
    SERVICE_STATUS_HANDLE hServiceStatus,
    LPSERVICE_STATUS lpServiceStatus
);

WINADVAPI BOOL WINAPI StartServiceCtrlDispatcherA(
...
WINADVAPI BOOL WINAPI StartServiceA(
    SC_HANDLE hService,
...
WINADVAPI BOOL WINAPI UnlockServiceDatabase(
    SC_LOCK ScLock
);
...
WINADVAPI DWORD WINAPI NotifyServiceStatusChangeA(
    SC_HANDLE hService,
    DWORD dwNotifyMask,
    PSERVICE_NOTIFYA pNotifyBuffer
);

WINADVAPI DWORD WINAPI NotifyServiceStatusChangeW(
    SC_HANDLE hService,
    DWORD dwNotifyMask,
...
WINADVAPI BOOL WINAPI ControlServiceExA(
    SC_HANDLE hService,
    DWORD dwControl,
    DWORD dwInfoLevel,
...
WINADVAPI BOOL WINAPI ControlServiceExW(
    SC_HANDLE hService,
    DWORD dwControl,
    DWORD dwInfoLevel,
    PVOID pControlParams
...
WINADVAPI BOOL WINAPI QueryServiceDynamicInformation(
    SERVICE_STATUS_HANDLE hServiceStatus,
    DWORD dwInfoLevel,
    PVOID *ppDynamicInfo
);
...
WINADVAPI DWORD WINAPI SubscribeServiceChangeNotifications(
    SC_HANDLE hService,
...
WINADVAPI VOID WINAPI UnsubscribeServiceChangeNotifications(
    PSC_NOTIFICATION_REGISTRATION pSubscription
);

WINADVAPI DWORD WINAPI WaitServiceState(
    SC_HANDLE hService,
    DWORD dwNotify,
    DWORD dwTimeout,
    HANDLE hCancelEvent
...
DWORD WINAPI GetServiceRegistryStateKey(
...
DWORD WINAPI GetServiceDirectory(
    SERVICE_STATUS_HANDLE hServiceStatus,
...
DWORD WINAPI GetSharedServiceRegistryStateKey(
...
DWORD WINAPI GetSharedServiceDirectory(
    SC_HANDLE ServiceHandle,
