...
typedef struct _RAS_PORT_2 {
    ...
    ULONGLONG ullFramesXmited;
    ULONGLONG ullFramesRcved;
    ULONGLONG ullBytesTxUncompressed;
    ULONGLONG ullBytesTxCompressed;
    ULONGLONG ullBytesRcvUncompressed;
    ULONGLONG ullBytesRcvCompressed;
...
DWORD APIENTRY MprAdminUpdateConnection(
    RAS_SERVER_HANDLE hRasServer,
    HANDLE hRasConnection,
    PRAS_UPDATE_CONNECTION pRasUpdateConnection);
...
DWORD APIENTRY MprAdminIsServiceInitialized(
    ...
    BOOL *fIsServiceInitialized
);

#if (NTDDI_VERSION >= NTDDI_WIN8)

DWORD APIENTRY MprAdminInterfaceSetCustomInfoEx(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    PMPR_IF_CUSTOMINFOEX pCustomInfo
);

DWORD APIENTRY MprAdminInterfaceGetCustomInfoEx(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    PMPR_IF_CUSTOMINFOEX pCustomInfo
);

DWORD APIENTRY MprConfigInterfaceGetCustomInfoEx(
    HANDLE hMprConfig,
    HANDLE hRouterInterface,
    PMPR_IF_CUSTOMINFOEX pCustomInfo
);

DWORD APIENTRY MprConfigInterfaceSetCustomInfoEx(
    HANDLE hMprConfig,
    HANDLE hRouterInterface,
    PMPR_IF_CUSTOMINFOEX pCustomInfo
);
...
DWORD APIENTRY MprAdminConnectionEnum(
    RAS_SERVER_HANDLE hRasServer,
    DWORD dwLevel,
    LPBYTE *lplpbBuffer,
    DWORD dwPrefMaxLen,
...
DWORD APIENTRY MprAdminPortEnum(
    RAS_SERVER_HANDLE hRasServer,
    DWORD dwLevel,
    HANDLE hRasConnection,
    LPBYTE *lplpbBuffer,
...
DWORD APIENTRY MprAdminConnectionGetInfo(
    RAS_SERVER_HANDLE hRasServer,
    DWORD dwLevel,
    HANDLE hRasConnection,
    LPBYTE *lplpbBuffer
...
DWORD APIENTRY MprAdminPortGetInfo(
    RAS_SERVER_HANDLE hRasServer,
    DWORD dwLevel,
    HANDLE hPort,
    LPBYTE *lplpbBuffer
...
DWORD APIENTRY MprAdminConnectionClearStats(
    RAS_SERVER_HANDLE hRasServer,
    HANDLE hRasConnection
);

DWORD APIENTRY MprAdminPortClearStats(
    RAS_SERVER_HANDLE hRasServer,
    HANDLE hPort
);

DWORD APIENTRY MprAdminPortReset(
    RAS_SERVER_HANDLE hRasServer,
    HANDLE hPort
);

DWORD APIENTRY MprAdminPortDisconnect(
    RAS_SERVER_HANDLE hRasServer,
    HANDLE hPort
);

BOOL APIENTRY MprAdminAcceptNewConnection(
    RAS_CONNECTION_0 *pRasConnection0,
    RAS_CONNECTION_1 *pRasConnection1
);

#if (WINVER >= 0x0500)
BOOL APIENTRY MprAdminAcceptNewConnection2(
    RAS_CONNECTION_0 *pRasConnection0,
    RAS_CONNECTION_1 *pRasConnection1,
...
#if (WINVER >= 0x0600)
BOOL APIENTRY MprAdminAcceptNewConnection3(
    RAS_CONNECTION_0 *pRasConnection0,
    RAS_CONNECTION_1 *pRasConnection1,
    RAS_CONNECTION_2 *pRasConnection2,
...
BOOL APIENTRY MprAdminAcceptReauthentication(
    RAS_CONNECTION_0 *pRasConnection0,
    RAS_CONNECTION_1 *pRasConnection1,
    RAS_CONNECTION_2 *pRasConnection2,
    RAS_CONNECTION_3 *pRasConnection3
...
BOOL APIENTRY MprAdminAcceptNewLink(
...
#if (WINVER >= 0x0500)
void APIENTRY MprAdminConnectionHangupNotification2(
    RAS_CONNECTION_0 *pRasConnection0,
    RAS_CONNECTION_1 *pRasConnection1,
    RAS_CONNECTION_2 *pRasConnection2
);
...
#if (WINVER >= 0x0600)
void APIENTRY MprAdminConnectionHangupNotification3(
    RAS_CONNECTION_0 *pRasConnection0,
    RAS_CONNECTION_1 *pRasConnection1,
    RAS_CONNECTION_2 *pRasConnection2,
    RAS_CONNECTION_3 *pRasConnection3
...
#if (WINVER >= 0x501)
DWORD APIENTRY MprAdminConnectionRemoveQuarantine(
    HANDLE hRasServer,
    HANDLE hRasConnection,
    BOOL fIsIpAddress
);
...
void APIENTRY MprAdminLinkHangupNotification(
    RAS_PORT_0 *pRasPort0,
    RAS_PORT_1 *pRasPort1
);

DWORD APIENTRY MprAdminGetIpAddressForUser(
    WCHAR *lpwszUserName,
    WCHAR *lpwszPortName,
    DWORD *lpdwIpAddress,
    BOOL *bNotifyRelease
...
void APIENTRY MprAdminReleaseIpAddress(
    WCHAR *lpszUserName,
    WCHAR *lpszPortName,
    DWORD *lpdwIpAddress
);
...
#if (WINVER >= 0x0600)
DWORD APIENTRY MprAdminGetIpv6AddressForUser(
    WCHAR *lpwszUserName,
    WCHAR *lpwszPortName,
...
DWORD APIENTRY MprAdminTerminateDll(
    void
);
#endif /* (WINVER >= 0x0500) */

DWORD APIENTRY MprAdminUserGetInfo(
    LPCWSTR lpszServer,
    LPCWSTR lpszUser,
    DWORD dwLevel,
    LPBYTE lpbBuffer
...
DWORD APIENTRY MprAdminUserSetInfo(
    LPCWSTR lpszServer,
    LPCWSTR lpszUser,
    DWORD dwLevel,
...
#if (WINVER >= 0x0500)
DWORD APIENTRY MprAdminSendUserMessage(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hConnection,
    LPWSTR lpwszMessage
);
...
DWORD APIENTRY MprAdminGetPDCServer(
    LPCWSTR lpszDomain,
    LPCWSTR lpszServer,
    LPWSTR lpszPDCServer
);

BOOL APIENTRY MprAdminIsServiceRunning(
    LPWSTR lpwsServerName
);

DWORD APIENTRY MprAdminServerConnect(
    LPWSTR lpwsServerName,
    MPR_SERVER_HANDLE *phMprServer
);

void APIENTRY MprAdminServerDisconnect(
    MPR_SERVER_HANDLE hMprServer
);

#if (WINVER >= 0x501)
DWORD APIENTRY MprAdminServerGetCredentials(
    MPR_SERVER_HANDLE hMprServer,
    DWORD dwLevel,
    LPBYTE *lplpbBuffer
);

DWORD APIENTRY MprAdminServerSetCredentials(
    MPR_SERVER_HANDLE hMprServer,
    DWORD dwLevel,
    LPBYTE lpbBuffer
);
...
DWORD APIENTRY MprAdminBufferFree(
    LPVOID pBuffer
);
...
DWORD APIENTRY MprAdminServerGetInfo(
    MPR_SERVER_HANDLE hMprServer,
    DWORD dwLevel,
    LPBYTE *lplpbBuffer
);
...
#if (WINVER >= 0x501)
DWORD APIENTRY MprAdminServerSetInfo(
    MPR_SERVER_HANDLE hMprServer,
    DWORD dwLevel,
    LPBYTE lpbBuffer
);

DWORD APIENTRY MprAdminEstablishDomainRasServer(
    LPWSTR pszDomain,
    LPWSTR pszMachine,
    BOOL bEnable
);

DWORD APIENTRY MprAdminIsDomainRasServer(
    LPWSTR pszDomain,
    LPWSTR pszMachine,
    PBOOL pbIsRasServer
);
...
#if (WINVER >= 0x0500)
DWORD APIENTRY MprAdminTransportCreate(
    MPR_SERVER_HANDLE hMprServer,
    DWORD dwTransportId,
...
DWORD APIENTRY MprAdminTransportSetInfo(
    MPR_SERVER_HANDLE hMprServer,
    DWORD dwTransportId,
    LPBYTE pGlobalInfo,
    DWORD dwGlobalInfoSize,
...
DWORD APIENTRY MprAdminTransportGetInfo(
    MPR_SERVER_HANDLE hMprServer,
    DWORD dwTransportId,
    LPBYTE *ppGlobalInfo,
...
#if (WINVER >= 0x0500)
DWORD APIENTRY MprAdminDeviceEnum(
    MPR_SERVER_HANDLE hMprServer,
    DWORD dwLevel,
    LPBYTE *lplpbBuffer,
    LPDWORD lpdwTotalEntries
...
DWORD APIENTRY MprAdminInterfaceGetHandle(
    MPR_SERVER_HANDLE hMprServer,
...
DWORD APIENTRY MprAdminInterfaceCreate(
    MPR_SERVER_HANDLE hMprServer,
    DWORD dwLevel,
    LPBYTE lpbBuffer,
    HANDLE *phInterface
...
DWORD APIENTRY MprAdminInterfaceGetInfo(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    DWORD dwLevel,
    LPBYTE *lplpbBuffer
...
DWORD APIENTRY MprAdminInterfaceSetInfo(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    DWORD dwLevel,
    LPBYTE lpbBuffer
...
DWORD APIENTRY MprAdminInterfaceDelete(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface
);

#if (WINVER >= 0x0500)
DWORD APIENTRY MprAdminInterfaceDeviceGetInfo(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    DWORD dwIndex,
    DWORD dwLevel,
...
DWORD APIENTRY MprAdminInterfaceDeviceSetInfo(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    DWORD dwIndex,
    DWORD dwLevel,
...
DWORD APIENTRY MprAdminInterfaceTransportRemove(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    DWORD dwTransportId
);

DWORD APIENTRY MprAdminInterfaceTransportAdd(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    DWORD dwTransportId,
...
DWORD APIENTRY MprAdminInterfaceTransportGetInfo(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    DWORD dwTransportId,
...
DWORD APIENTRY MprAdminInterfaceTransportSetInfo(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    DWORD dwTransportId,
    LPBYTE pInterfaceInfo,
...
DWORD APIENTRY MprAdminInterfaceEnum(
    MPR_SERVER_HANDLE hMprServer,
    DWORD dwLevel,
    LPBYTE *lplpbBuffer,
    DWORD dwPrefMaxLen,
...
DWORD APIENTRY MprSetupIpInIpInterfaceFriendlyNameEnum(
    PWCHAR pwszMachineName,
    LPBYTE *lplpBuffer,
    LPDWORD lpdwEntriesRead
);

DWORD APIENTRY MprSetupIpInIpInterfaceFriendlyNameFree(
    LPVOID lpBuffer
);

DWORD APIENTRY MprSetupIpInIpInterfaceFriendlyNameCreate(
    PWCHAR pwszMachineName,
    PMPR_IPINIP_INTERFACE_0 pNameInformation
);

DWORD APIENTRY MprSetupIpInIpInterfaceFriendlyNameDelete(
    PWCHAR pwszMachineName,
    GUID *pGuid
);

DWORD APIENTRY MprAdminInterfaceSetCredentials(
    LPWSTR lpwsServer,
    LPWSTR lpwsInterfaceName,
    LPWSTR lpwsUserName,
...
DWORD APIENTRY MprAdminInterfaceGetCredentials(
    LPWSTR lpwsServer,
    LPWSTR lpwsInterfaceName,
    LPWSTR lpwsUserName,
    LPWSTR lpwsPassword,
...
#if (WINVER >= 0x0500)
DWORD APIENTRY MprAdminInterfaceSetCredentialsEx(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    DWORD dwLevel,
    LPBYTE lpbBuffer
...
DWORD APIENTRY MprAdminInterfaceGetCredentialsEx(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    DWORD dwLevel,
    LPBYTE *lplpbBuffer
...
DWORD APIENTRY MprAdminInterfaceConnect(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    HANDLE hEvent,
    BOOL fSynchronous
...
DWORD APIENTRY MprAdminInterfaceDisconnect(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface
);

DWORD APIENTRY MprAdminInterfaceUpdateRoutes(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    DWORD dwProtocolId,
    HANDLE hEvent
...
DWORD APIENTRY MprAdminInterfaceQueryUpdateResult(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface,
    DWORD dwProtocolId,
...
DWORD APIENTRY MprAdminInterfaceUpdatePhonebookInfo(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hInterface
);

#if (WINVER >= 0x0500)
DWORD APIENTRY MprAdminRegisterConnectionNotification(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hEventNotification
);

DWORD APIENTRY MprAdminDeregisterConnectionNotification(
    MPR_SERVER_HANDLE hMprServer,
    HANDLE hEventNotification
);
#endif /* WINVER >= 0x0500 */

DWORD APIENTRY MprAdminMIBServerConnect(
    LPWSTR lpwsServerName,
...
DWORD APIENTRY MprAdminMIBEntryCreate(
    MIB_SERVER_HANDLE hMibServer,
    DWORD dwPid,
    DWORD dwRoutingPid,
    LPVOID lpEntry,
...
DWORD APIENTRY MprAdminMIBEntryDelete(
    MIB_SERVER_HANDLE hMibServer,
    DWORD dwProtocolId,
    DWORD dwRoutingPid,
    LPVOID lpEntry,
...
DWORD APIENTRY MprAdminMIBEntrySet(
    MIB_SERVER_HANDLE hMibServer,
    DWORD dwProtocolId,
    DWORD dwRoutingPid,
    LPVOID lpEntry,
...
DWORD APIENTRY MprAdminMIBEntryGet(
    MIB_SERVER_HANDLE hMibServer,
    DWORD dwProtocolId,
    DWORD dwRoutingPid,
    LPVOID lpInEntry,
...
DWORD APIENTRY MprAdminMIBEntryGetFirst(
    MIB_SERVER_HANDLE hMibServer,
    DWORD dwProtocolId,
    DWORD dwRoutingPid,
    LPVOID lpInEntry,
...
DWORD APIENTRY MprAdminMIBEntryGetNext(
    MIB_SERVER_HANDLE hMibServer,
    DWORD dwProtocolId,
    DWORD dwRoutingPid,
    LPVOID lpInEntry,
...
DWORD APIENTRY MprAdminMIBGetTrapInfo(
    MIB_SERVER_HANDLE hMibServer,
    DWORD dwProtocolId,
    DWORD dwRoutingPid,
    LPVOID lpInData,
...
DWORD APIENTRY MprAdminMIBSetTrapInfo(
    DWORD dwProtocolId,
    DWORD dwRoutingPid,
    HANDLE hEvent,
    LPVOID lpInData,
...
DWORD APIENTRY MprAdminMIBBufferFree(
    LPVOID pBuffer
);

DWORD APIENTRY MprConfigServerInstall(
    DWORD dwLevel,
    PVOID pBuffer
);
...
void APIENTRY MprConfigServerDisconnect(
    HANDLE hMprConfig
);

DWORD APIENTRY MprConfigServerRefresh(
    HANDLE hMprConfig
);

DWORD APIENTRY MprConfigBufferFree(
    LPVOID pBuffer
);

DWORD APIENTRY MprConfigServerGetInfo(
    HANDLE hMprConfig,
    DWORD dwLevel,
    LPBYTE *lplpbBuffer
);
...
DWORD APIENTRY MprConfigServerBackup(
    HANDLE hMprConfig,
    LPWSTR lpwsPath
);

DWORD APIENTRY MprConfigServerRestore(
    HANDLE hMprConfig,
    LPWSTR lpwsPath
);

DWORD APIENTRY MprConfigTransportCreate(
    HANDLE hMprConfig,
    DWORD dwTransportId,
    LPWSTR lpwsTransportName,
    LPBYTE pGlobalInfo,
...
DWORD APIENTRY MprConfigTransportDelete(
    HANDLE hMprConfig,
    HANDLE hRouterTransport
);

DWORD APIENTRY MprConfigTransportGetHandle(
    HANDLE hMprConfig,
    DWORD dwTransportId,
    HANDLE *phRouterTransport
);

DWORD APIENTRY MprConfigTransportSetInfo(
    HANDLE hMprConfig,
    HANDLE hRouterTransport,
    LPBYTE pGlobalInfo,
    DWORD dwGlobalInfoSize,
...
DWORD APIENTRY MprConfigTransportGetInfo(
    HANDLE hMprConfig,
    HANDLE hRouterTransport,
    LPBYTE *ppGlobalInfo,
    LPDWORD lpdwGlobalInfoSize,
...
DWORD APIENTRY MprConfigTransportEnum(
    HANDLE hMprConfig,
    DWORD dwLevel,
    LPBYTE *lplpBuffer,
    DWORD dwPrefMaxLen,
...
DWORD APIENTRY MprConfigInterfaceCreate(
    HANDLE hMprConfig,
    DWORD dwLevel,
    LPBYTE lpbBuffer,
...
DWORD APIENTRY MprConfigInterfaceDelete(
    HANDLE hMprConfig,
    HANDLE hRouterInterface
);

DWORD APIENTRY MprConfigInterfaceGetHandle(
    HANDLE hMprConfig,
    LPWSTR lpwsInterfaceName,
    HANDLE *phRouterInterface
);

DWORD APIENTRY MprConfigInterfaceGetInfo(
    HANDLE hMprConfig,
    HANDLE hRouterInterface,
    DWORD dwLevel,
    LPBYTE *lplpBuffer,
...
DWORD APIENTRY MprConfigInterfaceSetInfo(
    HANDLE hMprConfig,
    HANDLE hRouterInterface,
    DWORD dwLevel,
    LPBYTE lpbBuffer
...
DWORD APIENTRY MprConfigInterfaceEnum(
    HANDLE hMprConfig,
    DWORD dwLevel,
    LPBYTE *lplpBuffer,
    DWORD dwPrefMaxLen,
...
DWORD APIENTRY MprConfigInterfaceTransportAdd(
    HANDLE hMprConfig,
    HANDLE hRouterInterface,
    DWORD dwTransportId,
    LPWSTR lpwsTransportName,
...
DWORD APIENTRY MprConfigInterfaceTransportRemove(
    HANDLE hMprConfig,
    HANDLE hRouterInterface,
    HANDLE hRouterIfTransport
);

DWORD APIENTRY MprConfigInterfaceTransportGetHandle(
    HANDLE hMprConfig,
    HANDLE hRouterInterface,
    DWORD dwTransportId,
    HANDLE *phRouterIfTransport
...
DWORD APIENTRY MprConfigInterfaceTransportGetInfo(
    HANDLE hMprConfig,
    HANDLE hRouterInterface,
    HANDLE hRouterIfTransport,
    LPBYTE *ppInterfaceInfo,
...
DWORD APIENTRY MprConfigInterfaceTransportSetInfo(
    HANDLE hMprConfig,
    HANDLE hRouterInterface,
    HANDLE hRouterIfTransport,
    LPBYTE pInterfaceInfo,
...
DWORD APIENTRY MprConfigInterfaceTransportEnum(
    HANDLE hMprConfig,
    HANDLE hRouterInterface,
    DWORD dwLevel,
    LPBYTE *lplpBuffer,
...
DWORD APIENTRY MprConfigGetFriendlyName(
    HANDLE hMprConfig,
    PWSTR pszGuidName,
    PWCHAR pszBuffer,
    DWORD dwBufferSize);

DWORD APIENTRY MprConfigGetGuidName(
    HANDLE hMprConfig,
    PWSTR pszFriendlyName,
    PWCHAR pszBuffer,
    DWORD dwBufferSize);

#if (WINVER >= 0x0600)
DWORD APIENTRY MprConfigFilterGetInfo(
    HANDLE hMprConfig,
    DWORD dwLevel,
    DWORD dwTransportId,
    LPBYTE lpBuffer);

DWORD APIENTRY MprConfigFilterSetInfo(
    HANDLE hMprConfig,
    DWORD dwLevel,
    DWORD dwTransportId,
    LPBYTE lpBuffer);
...
DWORD APIENTRY MprInfoCreate(
    DWORD dwVersion,
    LPVOID *lplpNewHeader
);

DWORD APIENTRY MprInfoDelete(
    LPVOID lpHeader
);

DWORD APIENTRY MprInfoRemoveAll(
    LPVOID lpHeader,
    LPVOID *lplpNewHeader
);

DWORD APIENTRY MprInfoDuplicate(
    LPVOID lpHeader,
    LPVOID *lplpNewHeader
);

DWORD APIENTRY MprInfoBlockAdd(
    LPVOID lpHeader,
    DWORD dwInfoType,
    DWORD dwItemSize,
    DWORD dwItemCount,
...
DWORD APIENTRY MprInfoBlockRemove(
    LPVOID lpHeader,
    DWORD dwInfoType,
    LPVOID *lplpNewHeader
);

DWORD APIENTRY MprInfoBlockSet(
    LPVOID lpHeader,
    DWORD dwInfoType,
    DWORD dwItemSize,
    DWORD dwItemCount,
...
DWORD APIENTRY MprInfoBlockFind(
    LPVOID lpHeader,
    DWORD dwInfoType,
...
DWORD APIENTRY MprInfoBlockQuerySize(
    LPVOID lpHeader
);
