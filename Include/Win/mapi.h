...
typedef ULONG (PASCAL MAPILOGON)(
    ULONG_PTR ulUIParam,
...
typedef ULONG (PASCAL MAPILOGOFF)(
    LHANDLE lhSession,
    ULONG_PTR ulUIParam,
    FLAGS flFlags,
    ULONG ulReserved
...
typedef ULONG (PASCAL MAPISENDMAIL)(
    LHANDLE lhSession,
    ULONG_PTR ulUIParam,
...
typedef ULONG (PASCAL MAPISENDMAILW)(
    LHANDLE lhSession,
    ULONG_PTR ulUIParam,
...
typedef ULONG (PASCAL MAPISENDDOCUMENTS)(
    ULONG_PTR ulUIParam,
    LPSTR lpszDelimChar,
    LPSTR lpszFilePaths,
    LPSTR lpszFileNames,
...
typedef ULONG (PASCAL MAPIFINDNEXT)(
    LHANDLE lhSession,
    ULONG_PTR ulUIParam,
    LPSTR lpszMessageType,
...
typedef ULONG (PASCAL MAPIREADMAIL)(
    LHANDLE lhSession,
    ULONG_PTR ulUIParam,
    LPSTR lpszMessageID,
    FLAGS flFlags,
...
typedef ULONG (PASCAL MAPISAVEMAIL)(
    LHANDLE lhSession,
    ULONG_PTR ulUIParam,
    lpMapiMessage lpMessage,
    FLAGS flFlags,
...
typedef ULONG (PASCAL MAPIDELETEMAIL)(
    LHANDLE lhSession,
    ULONG_PTR ulUIParam,
    LPSTR lpszMessageID,
    FLAGS flFlags,
...
typedef ULONG (EXPORT PASCAL *LPMAPIFREEBUFFER)(LPVOID pv);
ULONG PASCAL MAPIFreeBuffer(LPVOID pv);

typedef ULONG (PASCAL MAPIADDRESS)(
    LHANDLE lhSession,
    ULONG_PTR ulUIParam,
    LPSTR lpszCaption,
    ULONG nEditFields,
...
typedef ULONG (PASCAL MAPIDETAILS)(
    LHANDLE lhSession,
    ULONG_PTR ulUIParam,
...
typedef ULONG (PASCAL MAPIRESOLVENAME)(
    LHANDLE lhSession,
    ULONG_PTR ulUIParam,
    LPSTR lpszName,
    FLAGS flFlags,
...
#ifdef MAPIX_H
STDMETHODIMP_(SCODE) ScMAPIXFromSMAPI(
