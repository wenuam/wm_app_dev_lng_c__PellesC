...
#define SIZEOF_TCPTABLE(X) \
    (FIELD_OFFSET(MIB_TCPTABLE,table[0]) + \
...
#define SIZEOF_TCPTABLE2(X) \
    (FIELD_OFFSET(MIB_TCPTABLE2,table[0]) + \
...
#define SIZEOF_TCPTABLE_OWNER_PID(X) \
    (FIELD_OFFSET(MIB_TCPTABLE_OWNER_PID, table[0]) + \
...
#define SIZEOF_TCPTABLE_OWNER_MODULE(X) \
    (FIELD_OFFSET(MIB_TCPTABLE_OWNER_MODULE, table[0]) + \
...
#define SIZEOF_TCP6TABLE(X) \
    (FIELD_OFFSET(MIB_TCP6TABLE,table[0]) + \
...
#define SIZEOF_TCP6TABLE2(X) \
    (FIELD_OFFSET(MIB_TCP6TABLE2,table[0]) + \
...
#define SIZEOF_TCP6TABLE_OWNER_PID(X) \
    (FIELD_OFFSET(MIB_TCP6TABLE_OWNER_PID, table[0]) + \
