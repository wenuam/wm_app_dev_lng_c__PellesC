...
#define MQ_LOOKUP_RECEIVE_ALLOW_PEEK  0x40000120 
...
HRESULT APIENTRY MQMgmtGetInfo(
    LPCWSTR pComputerName,
    LPCWSTR pObjectName,
    MQMGMTPROPS *pMgmtProps
);

HRESULT APIENTRY MQMgmtAction(
    LPCWSTR pComputerName,
    LPCWSTR pObjectName,
    LPCWSTR pAction
);
...
HRESULT APIENTRY MQMoveMessage(
    QUEUEHANDLE hSourceQueue,
    QUEUEHANDLE hDestinationQueue,
    ULONGLONG ullLookupId,
    ITransaction *pTransaction
);
