...
WINOLEAUTAPI_(BSTR) SysAllocString( const OLECHAR * psz);
WINOLEAUTAPI_(INT) SysReAllocString( BSTR* pbstr, const OLECHAR * psz);
WINOLEAUTAPI_(BSTR) SysAllocStringLen( const OLECHAR * strIn, UINT ui);
WINOLEAUTAPI_(INT) SysReAllocStringLen( BSTR* pbstr, const OLECHAR * psz, unsigned int len);
WINOLEAUTAPI SysAddRefString(BSTR bstrString);
WINOLEAUTAPI_(void) SysReleaseString( BSTR bstrString);
WINOLEAUTAPI_(void) SysFreeString( BSTR bstrString);
WINOLEAUTAPI_(UINT) SysStringLen( BSTR pbstr);
...
WINOLEAUTAPI_(void) SafeArrayReleaseDescriptor( SAFEARRAY * psa);
WINOLEAUTAPI SafeArrayDestroyDescriptor(SAFEARRAY * psa);
WINOLEAUTAPI_(void) SafeArrayReleaseData( PVOID pData);
WINOLEAUTAPI SafeArrayDestroyData(SAFEARRAY * psa);
WINOLEAUTAPI SafeArrayAddRef(SAFEARRAY * psa, PVOID *ppDataToRelease);
...
WINOLEAUTAPI SafeArrayAccessData(SAFEARRAY * psa, void ** ppvData);
...
WINOLEAUTAPI VariantCopy(VARIANTARG * pvargDest, const VARIANTARG * pvargSrc);
WINOLEAUTAPI VariantCopyInd(VARIANT * pvarDest, const VARIANTARG * pvargSrc);
WINOLEAUTAPI VariantChangeType(VARIANTARG * pvargDest, const VARIANTARG * pvarSrc, USHORT wFlags, VARTYPE vt);
WINOLEAUTAPI VariantChangeTypeEx(VARIANTARG * pvargDest, const VARIANTARG * pvarSrc, LCID lcid, USHORT wFlags, VARTYPE vt);
...
WINOLEAUTAPI VarUI1FromDec(const DECIMAL *pdecIn, BYTE *pbOut);
...
WINOLEAUTAPI VarI2FromDec(const DECIMAL *pdecIn, SHORT *psOut);
...
WINOLEAUTAPI VarI4FromDec(const DECIMAL *pdecIn, LONG *plOut);
...
WINOLEAUTAPI VarI8FromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags, LONG64 * pi64Out);
...
WINOLEAUTAPI VarI8FromDec(const DECIMAL *pdecIn, LONG64 * pi64Out);
...
WINOLEAUTAPI VarR4FromDec(const DECIMAL *pdecIn, FLOAT *pfltOut);
...
WINOLEAUTAPI VarR8FromDec(const DECIMAL *pdecIn, DOUBLE *pdblOut);
...
WINOLEAUTAPI VarDateFromDec(const DECIMAL *pdecIn, DATE *pdateOut);
...
WINOLEAUTAPI VarCyFromDec(const DECIMAL *pdecIn, CY *pcyOut);
...
WINOLEAUTAPI VarBstrFromI8(LONG64 i64In, LCID lcid, ULONG dwFlags, BSTR * pbstrOut);
...
WINOLEAUTAPI VarBstrFromUI8(ULONG64 ui64In, LCID lcid, ULONG dwFlags, BSTR * pbstrOut);
WINOLEAUTAPI VarBstrFromDec(const DECIMAL *pdecIn, LCID lcid, ULONG dwFlags, BSTR *pbstrOut);
...
WINOLEAUTAPI VarBoolFromDec(const DECIMAL *pdecIn, VARIANT_BOOL *pboolOut);

WINOLEAUTAPI VarI1FromUI1(
    BYTE bIn,
    CHAR *pcOut
);

WINOLEAUTAPI VarI1FromI2(
    SHORT uiIn,
    CHAR *pcOut
);

WINOLEAUTAPI VarI1FromI4(
    LONG lIn,
    CHAR *pcOut
);

WINOLEAUTAPI VarI1FromI8(
    LONG64 i64In,
    CHAR *pcOut
);

WINOLEAUTAPI VarI1FromR4(
    FLOAT fltIn,
    CHAR *pcOut
);

WINOLEAUTAPI VarI1FromR8(
    DOUBLE dblIn,
    CHAR *pcOut
);

WINOLEAUTAPI VarI1FromDate(
    DATE dateIn,
    CHAR *pcOut
);

WINOLEAUTAPI VarI1FromCy(
    CY cyIn,
    CHAR *pcOut
);

WINOLEAUTAPI VarI1FromStr(
    LPCOLESTR strIn,
    LCID lcid,
    ULONG dwFlags,
    CHAR *pcOut
...
WINOLEAUTAPI VarI1FromDisp(
    IDispatch *pdispIn,
    LCID lcid,
    CHAR *pcOut
);

WINOLEAUTAPI VarI1FromBool(
    VARIANT_BOOL boolIn,
    CHAR *pcOut
);

WINOLEAUTAPI VarI1FromUI2(
    USHORT uiIn,
    CHAR *pcOut
);

WINOLEAUTAPI VarI1FromUI4(
    ULONG ulIn,
    CHAR *pcOut
);

WINOLEAUTAPI VarI1FromUI8(
    ULONG64 i64In,
    CHAR *pcOut
);

WINOLEAUTAPI VarI1FromDec(
...
WINOLEAUTAPI VarUI2FromDec(const DECIMAL *pdecIn, USHORT *puiOut);
...
WINOLEAUTAPI VarUI4FromDec(const DECIMAL *pdecIn, ULONG *pulOut);
...
WINOLEAUTAPI VarUI8FromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags, ULONG64 * pi64Out);
...
WINOLEAUTAPI VarUI8FromDec(const DECIMAL *pdecIn, ULONG64 * pi64Out);
...
WINOLEAUTAPI RegisterTypeLib(ITypeLib * ptlib, LPCOLESTR szFullPath,
    LPCOLESTR szHelpDir);
...
WINOLEAUTAPI DispGetIDsOfNames(ITypeInfo * ptinfo, LPOLESTR * rgszNames,
