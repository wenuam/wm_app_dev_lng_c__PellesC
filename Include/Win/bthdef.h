...
#define BTH_EIR_OOB_OPT_DATA_LEN_ID  (0x0B)
#define BTH_EIR_OOB_BD_ADDR_ID  (0x0C)
#define BTH_EIR_OOB_COD_ID  (0x0D)
#define BTH_EIR_OOB_SP_HASH_ID  (0x0E)
#define BTH_EIR_OOB_SP_RANDOMIZER_ID  (0x0F)
...
#else /* (NTDDI_VERSION < NTDDI_WIN10_19H1) */
