...
#define CREDUIWIN_IGNORE_CLOUDAUTHORITY_NAME            0x00040000
#endif
#if (NTDDI_VERSION >= NTDDI_WIN10_RS5)
#define CREDUIWIN_DOWNLEVEL_HELLO_AS_SMART_CARD         0x80000000
#endif
...
WINADVAPI BOOL WINAPI CredWriteW(
    PCREDENTIALW Credential,
    DWORD Flags
);

WINADVAPI BOOL WINAPI CredWriteA(
...
WINADVAPI BOOL WINAPI CredReadW(
    LPCWSTR TargetName,
    DWORD Type,
    DWORD Flags,
    PCREDENTIALW *Credential
...
WINADVAPI BOOL WINAPI CredReadA(
    LPCSTR TargetName,
    DWORD Type,
    DWORD Flags,
    PCREDENTIALA *Credential
...
WINADVAPI BOOL WINAPI CredEnumerateW(
    LPCWSTR Filter,
    DWORD Flags,
    DWORD *Count,
    PCREDENTIALW * *Credential
...
WINADVAPI BOOL WINAPI CredEnumerateA(
    LPCSTR Filter,
    DWORD Flags,
    DWORD *Count,
    PCREDENTIALA * *Credential
...
WINADVAPI BOOL WINAPI CredWriteDomainCredentialsW(
    PCREDENTIAL_TARGET_INFORMATIONW TargetInfo,
    PCREDENTIALW Credential,
    DWORD Flags
);

WINADVAPI BOOL WINAPI CredWriteDomainCredentialsA(
...
WINADVAPI BOOL WINAPI CredReadDomainCredentialsW(
    PCREDENTIAL_TARGET_INFORMATIONW TargetInfo,
    DWORD Flags,
    DWORD *Count,
    PCREDENTIALW * *Credential
...
WINADVAPI BOOL WINAPI CredReadDomainCredentialsA(
    PCREDENTIAL_TARGET_INFORMATIONA TargetInfo,
    DWORD Flags,
    DWORD *Count,
    PCREDENTIALA * *Credential
...
WINADVAPI BOOL WINAPI CredDeleteW(
    LPCWSTR TargetName,
    DWORD Type,
    DWORD Flags
);

WINADVAPI BOOL WINAPI CredDeleteA(
    LPCSTR TargetName,
    DWORD Type,
    DWORD Flags
);
...
WINADVAPI BOOL WINAPI CredRenameW(
...
WINADVAPI BOOL WINAPI CredRenameA(
...
WINADVAPI BOOL WINAPI CredGetTargetInfoW(
    LPCWSTR TargetName,
    DWORD Flags,
    PCREDENTIAL_TARGET_INFORMATIONW *TargetInfo
);

WINADVAPI BOOL WINAPI CredGetTargetInfoA(
    LPCSTR TargetName,
    DWORD Flags,
    PCREDENTIAL_TARGET_INFORMATIONA *TargetInfo
);
...
WINADVAPI BOOL WINAPI CredMarshalCredentialW(
...
WINADVAPI BOOL WINAPI CredUnmarshalCredentialW(
    LPCWSTR MarshaledCredential,
    PCRED_MARSHAL_TYPE CredType,
    PVOID *Credential
);

WINADVAPI BOOL WINAPI CredUnmarshalCredentialA(
...
WINADVAPI BOOL WINAPI CredIsMarshaledCredentialW(
    LPCWSTR MarshaledCredential
);
...
CREDUIAPI BOOL WINAPI CredUnPackAuthenticationBufferW(
    DWORD dwFlags,
    PVOID pAuthBuffer,
    DWORD cbAuthBuffer,
    LPWSTR pszUserName,
...
CREDUIAPI BOOL WINAPI CredUnPackAuthenticationBufferA(
    DWORD dwFlags,
    PVOID pAuthBuffer,
    DWORD cbAuthBuffer,
    LPSTR pszUserName,
...
CREDUIAPI BOOL WINAPI CredPackAuthenticationBufferW(
    DWORD dwFlags,
    LPWSTR pszUserName,
    LPWSTR pszPassword,
...
CREDUIAPI BOOL WINAPI CredPackAuthenticationBufferA(
    DWORD dwFlags,
    LPSTR pszUserName,
    LPSTR pszPassword,
    PBYTE pPackedCredentials,
...
WINADVAPI BOOL WINAPI CredProtectW(
    BOOL fAsSelf,
...
WINADVAPI BOOL WINAPI CredProtectEx(
    ULONG Flags,
    LPWSTR pszCredentials,
    DWORD cchCredentials,
    LPWSTR pszProtectedCredentials,
...
WINADVAPI BOOL WINAPI CredProtectA(
    BOOL fAsSelf,
...
WINADVAPI BOOL WINAPI CredUnprotectW(
    BOOL fAsSelf,
    LPWSTR pszProtectedCredentials,
...
WINADVAPI BOOL WINAPI CredUnprotectEx(
    ULONG Flags,
    LPWSTR pszProtectedCredentials,
    DWORD cchProtectedCredentials,
    LPWSTR pszCredentials,
...
WINADVAPI BOOL WINAPI CredUnprotectA(
    BOOL fAsSelf,
    LPSTR pszProtectedCredentials,
    DWORD cchProtectedCredentials,
    LPSTR pszCredentials,
...
WINADVAPI BOOL WINAPI CredIsProtectedW(
    LPWSTR pszProtectedCredentials,
    CRED_PROTECTION_TYPE * pProtectionType
);

WINADVAPI BOOL WINAPI CredIsProtectedA(
    LPSTR pszProtectedCredentials,
    CRED_PROTECTION_TYPE * pProtectionType
);
...
WINADVAPI BOOL WINAPI CredFindBestCredentialW(
    LPCWSTR TargetName,
    DWORD Type,
    DWORD Flags,
    PCREDENTIALW *Credential
...
WINADVAPI BOOL WINAPI CredFindBestCredentialA(
    LPCSTR TargetName,
    DWORD Type,
    DWORD Flags,
    PCREDENTIALA *Credential
...
WINADVAPI BOOL WINAPI CredGetSessionTypes(
    DWORD MaximumPersistCount,
    LPDWORD MaximumPersist
);

WINADVAPI void WINAPI CredFree(
    PVOID Buffer
);
...
CREDUIAPI DWORD WINAPI CredUIPromptForCredentialsW(
...
CREDUIAPI DWORD WINAPI CredUIPromptForCredentialsA(
...
CREDUIAPI DWORD WINAPI CredUIParseUserNameW(
    PCWSTR UserName,
    WCHAR *user,
...
CREDUIAPI DWORD WINAPI CredUIParseUserNameA(
    PCSTR userName,
    CHAR *user,
    ULONG userBufferSize,
    CHAR *domain,
...
CREDUIAPI DWORD WINAPI CredUICmdLinePromptForCredentialsW(
    PCWSTR pszTargetName,
    PCtxtHandle pContext,
    DWORD dwAuthError,
    PWSTR UserName,
...
CREDUIAPI DWORD WINAPI CredUIConfirmCredentialsW(
    PCWSTR pszTargetName,
    BOOL bConfirm
);

CREDUIAPI DWORD WINAPI CredUIConfirmCredentialsA(
    PCSTR pszTargetName,
    BOOL bConfirm
);
...
CREDUIAPI DWORD WINAPI CredUIStoreSSOCredW(
    PCWSTR pszRealm,
    PCWSTR pszUsername,
    PCWSTR pszPassword,
    BOOL bPersist
...
CREDUIAPI DWORD WINAPI CredUIReadSSOCredW(
    PCWSTR pszRealm,
    PWSTR * ppszUsername
);
