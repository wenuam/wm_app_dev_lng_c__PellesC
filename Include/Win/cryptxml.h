...
HRESULT WINAPI CryptXmlOpenToEncode(
...
HRESULT WINAPI CryptXmlOpenToDecode(
    const CRYPT_XML_TRANSFORM_CHAIN_CONFIG *pConfig,
    DWORD dwFlags,
    const CRYPT_XML_PROPERTY *rgProperty,
    ULONG cProperty,
...
HRESULT WINAPI CryptXmlAddObject(
...
HRESULT WINAPI CryptXmlCreateReference(
    HCRYPTXML hCryptXml,
    DWORD dwFlags,
    LPCWSTR wszId,
    LPCWSTR wszURI,
...
HRESULT WINAPI CryptXmlDigestReference(
    HCRYPTXML hReference,
    DWORD dwFlags,
...
HRESULT WINAPI CryptXmlImportPublicKey(
    DWORD dwFlags,
    const CRYPT_XML_KEY_VALUE *pKeyValue,
    BCRYPT_KEY_HANDLE *phKey
);

HRESULT WINAPI CryptXmlVerifySignature(
    HCRYPTXML hSignature,
...
HRESULT WINAPI CryptXmlGetStatus(
    HCRYPTXML hCryptXml,
    CRYPT_XML_STATUS *pStatus
);

HRESULT WINAPI CryptXmlEncode(
    HCRYPTXML hCryptXml,
    CRYPT_XML_CHARSET dwCharset,
    const CRYPT_XML_PROPERTY *rgProperty,
    ULONG cProperty,
...
const CRYPT_XML_ALGORITHM_INFO * WINAPI CryptXmlFindAlgorithmInfo(
    DWORD dwFindByType,
    const void *pvFindBy,
    DWORD dwGroupId,
    DWORD dwFlags
...
typedef BOOL (WINAPI *PFN_CRYPT_XML_ENUM_ALG_INFO)(
    const CRYPT_XML_ALGORITHM_INFO *pInfo,
    void *pvArg
);

HRESULT WINAPI CryptXmlEnumAlgorithmInfo(
    DWORD dwGroupId,
    DWORD dwFlags,
    void *pvArg,
...
typedef HRESULT (WINAPI *CryptXmlDllEncodeAlgorithm)(
    const CRYPT_XML_ALGORITHM_INFO *pAlgInfo,
    CRYPT_XML_CHARSET dwCharset,
    void *pvCallbackState,
    PFN_CRYPT_XML_WRITE_CALLBACK pfnWrite
);
