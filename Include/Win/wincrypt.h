...
/* Windows Cryptographic API definitions (FUBAR edition) */
...
#endif /* !szKEY_CRYPTOAPI_PRIVATE_KEY_OPTIONS */
...
WINCRYPT32API BOOL WINAPI CryptFormatObject(
...
WINCRYPT32API BOOL WINAPI CryptEncodeObjectEx(
    DWORD dwCertEncodingType,
    LPCSTR lpszStructType,
...
WINCRYPT32API BOOL WINAPI CryptEncodeObject(
    DWORD dwCertEncodingType,
    LPCSTR lpszStructType,
    const void *pvStructInfo,
    BYTE *pbEncoded,
...
#define CRYPT_ENCODE_ENABLE_IA5CONVERSION_FLAG \
...
WINCRYPT32API BOOL WINAPI CryptDecodeObjectEx(
    DWORD dwCertEncodingType,
    LPCSTR lpszStructType,
    const BYTE *pbEncoded,
    DWORD cbEncoded,
...
WINCRYPT32API BOOL WINAPI CryptDecodeObject(
    DWORD dwCertEncodingType,
    LPCSTR lpszStructType,
    const BYTE *pbEncoded,
    DWORD cbEncoded,
...
#define CRYPT_DECODE_ENABLE_IA5CONVERSION_FLAG \
...
#define wszURI_NTDS_OBJECTSID_PREFIX L"tag:microsoft.com,2022-09-14:sid:"
...
WINCRYPT32API BOOL WINAPI CryptInstallOIDFunctionAddress(
    HMODULE hModule,
...
WINCRYPT32API HCRYPTOIDFUNCSET WINAPI CryptInitOIDFunctionSet(
    LPCSTR pszFuncName,
    DWORD dwFlags
);

WINCRYPT32API BOOL WINAPI CryptGetOIDFunctionAddress(
...
WINCRYPT32API BOOL WINAPI CryptGetDefaultOIDDllList(
    HCRYPTOIDFUNCSET hFuncSet,
    DWORD dwEncodingType,
    WCHAR *pwszDllList,
    DWORD *pcchDllList
...
WINCRYPT32API BOOL WINAPI CryptGetDefaultOIDFunctionAddress(
    HCRYPTOIDFUNCSET hFuncSet,
    DWORD dwEncodingType,
    LPCWSTR pwszDll,
    DWORD dwFlags,
...
WINCRYPT32API BOOL WINAPI CryptFreeOIDFunctionAddress(
...
WINCRYPT32API BOOL WINAPI CryptRegisterOIDFunction(
    DWORD dwEncodingType,
    LPCSTR pszFuncName,
    LPCSTR pszOID,
    LPCWSTR pwszDll,
...
WINCRYPT32API BOOL WINAPI CryptUnregisterOIDFunction(
    DWORD dwEncodingType,
    LPCSTR pszFuncName,
    LPCSTR pszOID
);

WINCRYPT32API BOOL WINAPI CryptRegisterDefaultOIDFunction(
    DWORD dwEncodingType,
    LPCSTR pszFuncName,
    DWORD dwIndex,
    LPCWSTR pwszDll
...
WINCRYPT32API BOOL WINAPI CryptUnregisterDefaultOIDFunction(
    DWORD dwEncodingType,
    LPCSTR pszFuncName,
    LPCWSTR pwszDll
);

WINCRYPT32API BOOL WINAPI CryptSetOIDFunctionValue(
    DWORD dwEncodingType,
    LPCSTR pszFuncName,
    LPCSTR pszOID,
...
WINCRYPT32API BOOL WINAPI CryptGetOIDFunctionValue(
    DWORD dwEncodingType,
    LPCSTR pszFuncName,
    LPCSTR pszOID,
    LPCWSTR pwszValueName,
...
WINCRYPT32API BOOL WINAPI CryptEnumOIDFunction(
    DWORD dwEncodingType,
    LPCSTR pszFuncName,
    LPCSTR pszOID,
    DWORD dwFlags,
...
WINCRYPT32API BOOL WINAPI CryptRegisterOIDInfo(
...
WINCRYPT32API BOOL WINAPI CryptUnregisterOIDInfo(
    PCCRYPT_OID_INFO pInfo
);
...
WINCRYPT32API BOOL WINAPI CryptEnumOIDInfo(
    DWORD dwGroupId,
    DWORD dwFlags,
    void *pvArg,
...
WINCRYPT32API LPCWSTR WINAPI CryptFindLocalizedName(
...
#endif /* CMSG_SIGNER_ENCODE_INFO_HAS_IUM_FIELDS */
    } DUMMYUNIONNAME;
    DWORD dwKeySpec;
    CRYPT_ALGORITHM_IDENTIFIER HashAlgorithm;
    void *pvHashAuxInfo;
...
WINCRYPT32API HCRYPTMSG WINAPI CryptMsgOpenToEncode(
...
WINCRYPT32API HCRYPTMSG WINAPI CryptMsgOpenToDecode(
    DWORD dwMsgEncodingType,
    DWORD dwFlags,
    DWORD dwMsgType,
    HCRYPTPROV_LEGACY hCryptProv,
...
WINCRYPT32API HCRYPTMSG WINAPI CryptMsgDuplicate(
    HCRYPTMSG hCryptMsg
);

WINCRYPT32API BOOL WINAPI CryptMsgClose(
    HCRYPTMSG hCryptMsg
);

WINCRYPT32API BOOL WINAPI CryptMsgUpdate(
    HCRYPTMSG hCryptMsg,
    const BYTE *pbData,
    DWORD cbData,
    BOOL fFinal
...
WINCRYPT32API BOOL WINAPI CryptMsgGetParam(
    HCRYPTMSG hCryptMsg,
    DWORD dwParamType,
    DWORD dwIndex,
    void *pvData,
...
WINCRYPT32API HCERTSTORE WINAPI CertDuplicateStore(
    HCERTSTORE hCertStore
);
...
WINCRYPT32API BOOL WINAPI CertSaveStore(
    HCERTSTORE hCertStore,
    DWORD dwEncodingType,
    DWORD dwSaveAs,
    DWORD dwSaveTo,
...
WINCRYPT32API BOOL WINAPI CertCloseStore(
    HCERTSTORE hCertStore,
    DWORD dwFlags
);

WINCRYPT32API PCCERT_CONTEXT WINAPI CertGetSubjectCertificateFromStore(
    HCERTSTORE hCertStore,
    DWORD dwCertEncodingType,
    PCERT_INFO pCertId
...
WINCRYPT32API PCCERT_CONTEXT WINAPI CertEnumCertificatesInStore(
    HCERTSTORE hCertStore,
    PCCERT_CONTEXT pPrevCertContext
);
...
WINCRYPT32API PCCERT_CONTEXT WINAPI CertGetIssuerCertificateFromStore(
    HCERTSTORE hCertStore,
...
WINCRYPT32API BOOL WINAPI CertVerifySubjectCertificateContext(
...
WINCRYPT32API PCCERT_CONTEXT WINAPI CertCreateCertificateContext(
    DWORD dwCertEncodingType,
    const BYTE *pbCertEncoded,
    DWORD cbCertEncoded
);

WINCRYPT32API BOOL WINAPI CertFreeCertificateContext(
    PCCERT_CONTEXT pCertContext
);
...
WINCRYPT32API BOOL WINAPI CertGetCertificateContextProperty(
    PCCERT_CONTEXT pCertContext,
    DWORD dwPropId,
    void *pvData,
    DWORD *pcbData
...
WINCRYPT32API DWORD WINAPI CertEnumCertificateContextProperties(
    PCCERT_CONTEXT pCertContext,
    DWORD dwPropId
);
...
WINCRYPT32API BOOL WINAPI CertCreateCTLEntryFromCertificateContextProperties(
    PCCERT_CONTEXT pCertContext,
    DWORD cOptAttr,
...
WINCRYPT32API BOOL WINAPI CertSetCertificateContextPropertiesFromCTLEntry(
    PCCERT_CONTEXT pCertContext,
    PCTL_ENTRY pCtlEntry,
    DWORD dwFlags
);
...
WINCRYPT32API PCCRL_CONTEXT WINAPI CertGetCRLFromStore(
    HCERTSTORE hCertStore,
...
WINCRYPT32API PCCRL_CONTEXT WINAPI CertEnumCRLsInStore(
    HCERTSTORE hCertStore,
    PCCRL_CONTEXT pPrevCrlContext
);

WINCRYPT32API PCCRL_CONTEXT WINAPI CertFindCRLInStore(
    HCERTSTORE hCertStore,
    DWORD dwCertEncodingType,
    DWORD dwFindFlags,
    DWORD dwFindType,
...
WINCRYPT32API PCCRL_CONTEXT WINAPI CertDuplicateCRLContext(
    PCCRL_CONTEXT pCrlContext
);

WINCRYPT32API PCCRL_CONTEXT WINAPI CertCreateCRLContext(
    DWORD dwCertEncodingType,
    const BYTE *pbCrlEncoded,
    DWORD cbCrlEncoded
);

WINCRYPT32API BOOL WINAPI CertFreeCRLContext(
    PCCRL_CONTEXT pCrlContext
);

WINCRYPT32API BOOL WINAPI CertSetCRLContextProperty(
    PCCRL_CONTEXT pCrlContext,
    DWORD dwPropId,
    DWORD dwFlags,
    const void *pvData
...
WINCRYPT32API BOOL WINAPI CertGetCRLContextProperty(
    PCCRL_CONTEXT pCrlContext,
    DWORD dwPropId,
    void *pvData,
    DWORD *pcbData
...
WINCRYPT32API DWORD WINAPI CertEnumCRLContextProperties(
    PCCRL_CONTEXT pCrlContext,
    DWORD dwPropId
);

WINCRYPT32API BOOL WINAPI CertFindCertificateInCRL(
...
WINCRYPT32API BOOL WINAPI CertIsValidCRLForCertificate(
    PCCERT_CONTEXT pCert,
    PCCRL_CONTEXT pCrl,
    DWORD dwFlags,
    void *pvReserved
...
WINCRYPT32API BOOL WINAPI CertAddEncodedCertificateToStore(
    HCERTSTORE hCertStore,
    DWORD dwCertEncodingType,
    const BYTE *pbCertEncoded,
    DWORD cbCertEncoded,
...
WINCRYPT32API BOOL WINAPI CertAddSerializedElementToStore(
    HCERTSTORE hCertStore,
...
WINCRYPT32API BOOL WINAPI CertDeleteCertificateFromStore(
    PCCERT_CONTEXT pCertContext
);

WINCRYPT32API BOOL WINAPI CertAddEncodedCRLToStore(
    HCERTSTORE hCertStore,
    DWORD dwCertEncodingType,
    const BYTE *pbCrlEncoded,
    DWORD cbCrlEncoded,
...
WINCRYPT32API BOOL WINAPI CertAddCRLContextToStore(
    HCERTSTORE hCertStore,
    PCCRL_CONTEXT pCrlContext,
    DWORD dwAddDisposition,
...
WINCRYPT32API BOOL WINAPI CertDeleteCRLFromStore(
    PCCRL_CONTEXT pCrlContext
);

WINCRYPT32API BOOL WINAPI CertSerializeCertificateStoreElement(
    PCCERT_CONTEXT pCertContext,
    DWORD dwFlags,
    BYTE *pbElement,
    DWORD *pcbElement
...
WINCRYPT32API BOOL WINAPI CertSerializeCRLStoreElement(
    PCCRL_CONTEXT pCrlContext,
    DWORD dwFlags,
    BYTE *pbElement,
    DWORD *pcbElement
...
WINCRYPT32API PCCTL_CONTEXT WINAPI CertDuplicateCTLContext(
    PCCTL_CONTEXT pCtlContext
);

WINCRYPT32API PCCTL_CONTEXT WINAPI CertCreateCTLContext(
    DWORD dwMsgAndCertEncodingType,
    const BYTE *pbCtlEncoded,
    DWORD cbCtlEncoded
);

WINCRYPT32API BOOL WINAPI CertFreeCTLContext(
    PCCTL_CONTEXT pCtlContext
);

WINCRYPT32API BOOL WINAPI CertSetCTLContextProperty(
    PCCTL_CONTEXT pCtlContext,
    DWORD dwPropId,
    DWORD dwFlags,
    const void *pvData
...
WINCRYPT32API BOOL WINAPI CertGetCTLContextProperty(
    PCCTL_CONTEXT pCtlContext,
    DWORD dwPropId,
    void *pvData,
    DWORD *pcbData
...
WINCRYPT32API DWORD WINAPI CertEnumCTLContextProperties(
    PCCTL_CONTEXT pCtlContext,
    DWORD dwPropId
);

WINCRYPT32API PCCTL_CONTEXT WINAPI CertEnumCTLsInStore(
    HCERTSTORE hCertStore,
    PCCTL_CONTEXT pPrevCtlContext
);

WINCRYPT32API PCTL_ENTRY WINAPI CertFindSubjectInCTL(
    DWORD dwEncodingType,
    DWORD dwSubjectType,
    void *pvSubject,
    PCCTL_CONTEXT pCtlContext,
...
WINCRYPT32API PCCTL_CONTEXT WINAPI CertFindCTLInStore(
    HCERTSTORE hCertStore,
    DWORD dwMsgAndCertEncodingType,
    DWORD dwFindFlags,
    DWORD dwFindType,
...
WINCRYPT32API BOOL WINAPI CertAddEncodedCTLToStore(
    HCERTSTORE hCertStore,
    DWORD dwMsgAndCertEncodingType,
    const BYTE *pbCtlEncoded,
    DWORD cbCtlEncoded,
...
WINCRYPT32API BOOL WINAPI CertAddCTLContextToStore(
    HCERTSTORE hCertStore,
    PCCTL_CONTEXT pCtlContext,
    DWORD dwAddDisposition,
...
WINCRYPT32API BOOL WINAPI CertSerializeCTLStoreElement(
    PCCTL_CONTEXT pCtlContext,
    DWORD dwFlags,
    BYTE *pbElement,
    DWORD *pcbElement
...
WINCRYPT32API BOOL WINAPI CertDeleteCTLFromStore(
    PCCTL_CONTEXT pCtlContext
);

WINCRYPT32API BOOL WINAPI CertAddCertificateLinkToStore(
    HCERTSTORE hCertStore,
    PCCERT_CONTEXT pCertContext,
    DWORD dwAddDisposition,
    PCCERT_CONTEXT *ppStoreContext
...
WINCRYPT32API BOOL WINAPI CertAddCRLLinkToStore(
    HCERTSTORE hCertStore,
    PCCRL_CONTEXT pCrlContext,
    DWORD dwAddDisposition,
    PCCRL_CONTEXT *ppStoreContext
...
WINCRYPT32API BOOL WINAPI CertAddCTLLinkToStore(
    HCERTSTORE hCertStore,
    PCCTL_CONTEXT pCtlContext,
    DWORD dwAddDisposition,
    PCCTL_CONTEXT *ppStoreContext
...
WINCRYPT32API BOOL WINAPI CertAddStoreToCollection(
...
WINCRYPT32API void WINAPI CertRemoveStoreFromCollection(
    HCERTSTORE hCollectionStore,
    HCERTSTORE hSiblingStore
);

WINCRYPT32API BOOL WINAPI CertControlStore(
    HCERTSTORE hCertStore,
    DWORD dwFlags,
    DWORD dwCtrlType,
    void const *pvCtrlPara
...
WINCRYPT32API BOOL WINAPI CertSetStoreProperty(
    HCERTSTORE hCertStore,
    DWORD dwPropId,
    DWORD dwFlags,
    const void *pvData
...
WINCRYPT32API BOOL WINAPI CertGetStoreProperty(
    HCERTSTORE hCertStore,
    DWORD dwPropId,
    void *pvData,
    DWORD *pcbData
...
WINCRYPT32API const void *WINAPI CertCreateContext(
    DWORD dwContextType,
    DWORD dwEncodingType,
    const BYTE *pbEncoded,
    DWORD cbEncoded,
...
WINCRYPT32API BOOL WINAPI CertRegisterSystemStore(
...
WINCRYPT32API BOOL WINAPI CertRegisterPhysicalStore(
    const void *pvSystemStore,
    DWORD dwFlags,
...
WINCRYPT32API BOOL WINAPI CertUnregisterSystemStore(
    const void *pvSystemStore,
    DWORD dwFlags
);

WINCRYPT32API BOOL WINAPI CertUnregisterPhysicalStore(
    const void *pvSystemStore,
    DWORD dwFlags,
    LPCWSTR pwszStoreName
);
...
WINCRYPT32API BOOL WINAPI CertEnumSystemStoreLocation(
    DWORD dwFlags,
    void *pvArg,
    PFN_CERT_ENUM_SYSTEM_STORE_LOCATION pfnEnum
);

WINCRYPT32API BOOL WINAPI CertEnumSystemStore(
    DWORD dwFlags,
...
WINCRYPT32API BOOL WINAPI CertEnumPhysicalStore(
    const void *pvSystemStore,
    DWORD dwFlags,
    void *pvArg,
...
WINCRYPT32API BOOL WINAPI CertGetEnhancedKeyUsage(
    PCCERT_CONTEXT pCertContext,
    DWORD dwFlags,
...
WINCRYPT32API BOOL WINAPI CertSetEnhancedKeyUsage(
    PCCERT_CONTEXT pCertContext,
    PCERT_ENHKEY_USAGE pUsage
);

WINCRYPT32API BOOL WINAPI CertAddEnhancedKeyUsageIdentifier(
    PCCERT_CONTEXT pCertContext,
    LPCSTR pszUsageIdentifier
);

WINCRYPT32API BOOL WINAPI CertRemoveEnhancedKeyUsageIdentifier(
    PCCERT_CONTEXT pCertContext,
    LPCSTR pszUsageIdentifier
);
...
WINCRYPT32API BOOL WINAPI CertGetValidUsages(
    DWORD cCerts,
...
WINCRYPT32API BOOL WINAPI CryptMsgSignCTL(
    DWORD dwMsgEncodingType,
    BYTE *pbCtlContent,
    DWORD cbCtlContent,
...
WINCRYPT32API BOOL WINAPI CryptMsgEncodeAndSignCTL(
    DWORD dwMsgEncodingType,
    PCTL_INFO pCtlInfo,
    PCMSG_SIGNED_ENCODE_INFO pSignInfo,
    DWORD dwFlags,
...
WINCRYPT32API BOOL WINAPI CertFindSubjectInSortedCTL(
...
WINCRYPT32API BOOL WINAPI CertEnumSubjectInSortedCTL(
    PCCTL_CONTEXT pCtlContext,
    void **ppvNextSubject,
...
WINCRYPT32API BOOL WINAPI CertVerifyCTLUsage(
    DWORD dwEncodingType,
    DWORD dwSubjectType,
    void *pvSubject,
...
#endif /* CERT_REVOCATION_PARA_HAS_EXTRA_FIELDS */
...
WINCRYPT32API BOOL WINAPI CertVerifyRevocation(
    DWORD dwEncodingType,
    DWORD dwRevType,
    DWORD cContext,
    PVOID rgpvContext[],
...
WINCRYPT32API BOOL WINAPI CertCompareCertificate(
    DWORD dwCertEncodingType,
    PCERT_INFO pCertId1,
    PCERT_INFO pCertId2
);

WINCRYPT32API BOOL WINAPI CertCompareCertificateName(
    DWORD dwCertEncodingType,
...
WINCRYPT32API BOOL WINAPI CertIsRDNAttrsInCertificateName(
    DWORD dwCertEncodingType,
    DWORD dwFlags,
...
WINCRYPT32API BOOL WINAPI CertComparePublicKeyInfo(
    DWORD dwCertEncodingType,
...
WINCRYPT32API DWORD WINAPI CertGetPublicKeyLength(
    DWORD dwCertEncodingType,
...
WINCRYPT32API BOOL WINAPI CryptVerifyCertificateSignature(
    HCRYPTPROV_LEGACY hCryptProv,
    DWORD dwCertEncodingType,
    const BYTE *pbEncoded,
    DWORD cbEncoded,
...
WINCRYPT32API BOOL WINAPI CryptVerifyCertificateSignatureEx(
    HCRYPTPROV_LEGACY hCryptProv,
    DWORD dwCertEncodingType,
    DWORD dwSubjectType,
    void *pvSubject,
...
WINCRYPT32API BOOL WINAPI CertIsStrongHashToSign(
    PCCERT_STRONG_SIGN_PARA pStrongSignPara,
    LPCWSTR pwszCNGHashAlgid,
    PCCERT_CONTEXT pSigningCert
);

WINCRYPT32API BOOL WINAPI CryptHashToBeSigned(
    HCRYPTPROV_LEGACY hCryptProv,
    DWORD dwCertEncodingType,
    const BYTE *pbEncoded,
    DWORD cbEncoded,
...
WINCRYPT32API BOOL WINAPI CryptHashCertificate(
    HCRYPTPROV_LEGACY hCryptProv,
    ALG_ID Algid,
    DWORD dwFlags,
    const BYTE *pbEncoded,
...
WINCRYPT32API BOOL WINAPI CryptSignCertificate(
#ifdef CMSG_SIGNER_ENCODE_INFO_HAS_IUM_FIELDS
    BCRYPT_KEY_HANDLE hBCryptKey,
#else /* !CMSG_SIGNER_ENCODE_INFO_HAS_IUM_FIELDS */
...
WINCRYPT32API BOOL WINAPI CryptSignAndEncodeCertificate(
#ifdef CMSG_SIGNER_ENCODE_INFO_HAS_IUM_FIELDS
    BCRYPT_KEY_HANDLE hBCryptKey,
#else /* !CMSG_SIGNER_ENCODE_INFO_HAS_IUM_FIELDS */
    HCRYPTPROV_OR_NCRYPT_KEY_HANDLE hCryptProvOrNCryptKey,
...
WINCRYPT32API LONG WINAPI CertVerifyTimeValidity(
...
WINCRYPT32API LONG WINAPI CertVerifyCRLTimeValidity(
    LPFILETIME pTimeToVerify,
    PCRL_INFO pCrlInfo
);

WINCRYPT32API BOOL WINAPI CertVerifyValidityNesting(
    PCERT_INFO pSubjectInfo,
    PCERT_INFO pIssuerInfo
);

WINCRYPT32API BOOL WINAPI CertVerifyCRLRevocation(
    DWORD dwCertEncodingType,
    PCERT_INFO pCertId,
    DWORD cCrlInfo,
...
WINCRYPT32API LPCSTR WINAPI CertAlgIdToOID(
    DWORD dwAlgId
);

WINCRYPT32API DWORD WINAPI CertOIDToAlgId(
    LPCSTR pszObjId
);
...
WINCRYPT32API PCERT_EXTENSION WINAPI CertFindExtension(
    LPCSTR pszObjId,
    DWORD cExtensions,
    CERT_EXTENSION rgExtensions[]
);

WINCRYPT32API PCRYPT_ATTRIBUTE WINAPI CertFindAttribute(
    LPCSTR pszObjId,
    DWORD cAttr,
    CRYPT_ATTRIBUTE rgAttr[]
);

WINCRYPT32API PCERT_RDN_ATTR WINAPI CertFindRDNAttr(
    LPCSTR pszObjId,
    PCERT_NAME_INFO pName
);

WINCRYPT32API BOOL WINAPI CertGetIntendedKeyUsage(
    DWORD dwCertEncodingType,
    PCERT_INFO pCertInfo,
    BYTE *pbKeyUsage,
    DWORD cbKeyUsage
...
WINCRYPT32API BOOL WINAPI CryptInstallDefaultContext(
    HCRYPTPROV hCryptProv,
    DWORD dwDefaultType,
...
WINCRYPT32API BOOL WINAPI CryptUninstallDefaultContext(
    HCRYPTDEFAULTCONTEXT hDefaultContext,
    DWORD dwFlags,
    void *pvReserved
);

WINCRYPT32API BOOL WINAPI CryptExportPublicKeyInfo(
    HCRYPTPROV_OR_NCRYPT_KEY_HANDLE hCryptProvOrNCryptKey,
    DWORD dwKeySpec,
    DWORD dwCertEncodingType,
...
WINCRYPT32API BOOL WINAPI CryptExportPublicKeyInfoEx(
    HCRYPTPROV_OR_NCRYPT_KEY_HANDLE hCryptProvOrNCryptKey,
    DWORD dwKeySpec,
    DWORD dwCertEncodingType,
...
WINCRYPT32API BOOL WINAPI CryptExportPublicKeyInfoFromBCryptKeyHandle(
    BCRYPT_KEY_HANDLE hBCryptKey,
    DWORD dwCertEncodingType,
    LPSTR pszPublicKeyObjId,
    DWORD dwFlags,
...
WINCRYPT32API BOOL WINAPI CryptImportPublicKeyInfo(
    HCRYPTPROV hCryptProv,
    DWORD dwCertEncodingType,
    PCERT_PUBLIC_KEY_INFO pInfo,
    HCRYPTKEY *phKey
...
WINCRYPT32API BOOL WINAPI CryptImportPublicKeyInfoEx(
    HCRYPTPROV hCryptProv,
    DWORD dwCertEncodingType,
    PCERT_PUBLIC_KEY_INFO pInfo,
    ALG_ID aiKeyAlg,
...
WINCRYPT32API BOOL WINAPI CryptImportPublicKeyInfoEx2(
    DWORD dwCertEncodingType,
    PCERT_PUBLIC_KEY_INFO pInfo,
    DWORD dwFlags,
    void *pvAuxInfo,
...
WINCRYPT32API BOOL WINAPI CryptFindCertificateKeyProvInfo(
    PCCERT_CONTEXT pCert,
    DWORD dwFlags,
    void *pvReserved
);
...
WINCRYPT32API BOOL WINAPI CryptExportPKCS8(
    HCRYPTPROV hCryptProv,
    DWORD dwKeySpec,
    LPSTR pszPrivateKeyObjId,
    DWORD dwFlags,
...
WINCRYPT32API BOOL WINAPI CryptExportPKCS8Ex(
...
WINCRYPT32API BOOL WINAPI CryptHashPublicKeyInfo(
    HCRYPTPROV_LEGACY hCryptProv,
    ALG_ID Algid,
    DWORD dwFlags,
    DWORD dwCertEncodingType,
...
WINCRYPT32API DWORD WINAPI CertRDNValueToStrA(
    DWORD dwValueType,
    PCERT_RDN_VALUE_BLOB pValue,
    LPSTR psz,
    DWORD csz
);
WINCRYPT32API DWORD WINAPI CertRDNValueToStrW(
    DWORD dwValueType,
    PCERT_RDN_VALUE_BLOB pValue,
    LPWSTR psz,
    DWORD csz
...
WINCRYPT32API DWORD WINAPI CertNameToStrA(
    DWORD dwCertEncodingType,
...
WINCRYPT32API DWORD WINAPI CertNameToStrW(
    DWORD dwCertEncodingType,
    PCERT_NAME_BLOB pName,
    DWORD dwStrType,
    LPWSTR psz,
...
WINCRYPT32API BOOL WINAPI CertStrToNameA(
    DWORD dwCertEncodingType,
    LPCSTR pszX500,
    DWORD dwStrType,
    void *pvReserved,
...
WINCRYPT32API BOOL WINAPI CertStrToNameW(
    DWORD dwCertEncodingType,
    LPCWSTR pszX500,
    DWORD dwStrType,
    void *pvReserved,
...
WINCRYPT32API DWORD WINAPI CertGetNameStringA(
    PCCERT_CONTEXT pCertContext,
    DWORD dwType,
    DWORD dwFlags,
    void *pvTypePara,
...
WINCRYPT32API DWORD WINAPI CertGetNameStringW(
    PCCERT_CONTEXT pCertContext,
    DWORD dwType,
    DWORD dwFlags,
    void *pvTypePara,
...
typedef struct _CRYPT_VERIFY_MESSAGE_PARA {
    ...
    PCCERT_STRONG_SIGN_PARA pStrongSignPara;
#endif /* CRYPT_VERIFY_MESSAGE_PARA_HAS_EXTRA_FIELDS */
...
typedef struct _CRYPT_DECRYPT_MESSAGE_PARA {
    ...
    DWORD dwFlags;
#endif /* CRYPT_DECRYPT_MESSAGE_PARA_HAS_EXTRA_FIELDS */
...
WINCRYPT32API BOOL WINAPI CryptVerifyMessageSignature(
...
WINCRYPT32API LONG WINAPI CryptGetMessageSignerCount(
    DWORD dwMsgEncodingType,
    const BYTE *pbSignedBlob,
    DWORD cbSignedBlob
);

WINCRYPT32API HCERTSTORE WINAPI CryptGetMessageCertificates(
    DWORD dwMsgAndCertEncodingType,
    HCRYPTPROV_LEGACY hCryptProv,
    DWORD dwFlags,
    const BYTE *pbSignedBlob,
...
WINCRYPT32API BOOL WINAPI CryptEncryptMessage(
...
WINCRYPT32API BOOL WINAPI CryptDecryptMessage(
...
WINCRYPT32API BOOL WINAPI CryptSignAndEncryptMessage(
    PCRYPT_SIGN_MESSAGE_PARA pSignPara,
    PCRYPT_ENCRYPT_MESSAGE_PARA pEncryptPara,
    DWORD cRecipientCert,
    PCCERT_CONTEXT rgpRecipientCert[],
...
WINCRYPT32API BOOL WINAPI CryptHashMessage(
...
WINCRYPT32API BOOL WINAPI CryptVerifyMessageHash(
    PCRYPT_HASH_MESSAGE_PARA pHashPara,
    BYTE *pbHashedBlob,
    DWORD cbHashedBlob,
    BYTE *pbToBeHashed,
...
WINCRYPT32API BOOL WINAPI CryptVerifyDetachedMessageHash(
    PCRYPT_HASH_MESSAGE_PARA pHashPara,
...
WINCRYPT32API BOOL WINAPI CryptSignMessageWithKey(
...
HRESULT WINAPI FindCertsByIssuer(
...
WINCRYPT32API BOOL WINAPI CryptQueryObject(
    DWORD dwObjectType,
    const void *pvObject,
...
WINCRYPT32API LPVOID WINAPI CryptMemAlloc(
    ULONG cbSize
);

WINCRYPT32API LPVOID WINAPI CryptMemRealloc(
    LPVOID pv,
    ULONG cbSize
);

WINCRYPT32API void WINAPI CryptMemFree(
    LPVOID pv
);
...
WINCRYPT32API BOOL WINAPI CryptSetAsyncParam(
    HCRYPTASYNC hAsync,
    LPSTR pszParamOid,
    LPVOID pvParam,
...
WINCRYPT32API BOOL WINAPI CryptGetAsyncParam(
    HCRYPTASYNC hAsync,
    LPSTR pszParamOid,
    LPVOID *ppvParam,
...
WINCRYPT32API BOOL WINAPI CryptCloseAsyncHandle(
    HCRYPTASYNC hAsync
);
...
WINCRYPT32API BOOL WINAPI CryptRetrieveObjectByUrlA(
    LPCSTR pszUrl,
    LPCSTR pszObjectOid,
...
WINCRYPT32API BOOL WINAPI CryptInstallCancelRetrieval(
...
WINCRYPT32API BOOL WINAPI CryptUninstallCancelRetrieval(
    DWORD dwFlags,
    void *pvReserved
);
...
WINCRYPT32API BOOL WINAPI CryptCancelAsyncRetrieval(
...
WINCRYPT32API BOOL WINAPI CryptGetObjectUrl(
    LPCSTR pszUrlOid,
    LPVOID pvPara,
    DWORD dwFlags,
...
WINCRYPT32API BOOL WINAPI CryptGetTimeValidObject(
...
WINCRYPT32API BOOL WINAPI CryptFlushTimeValidObject(
...
WINCRYPT32API BOOL WINAPI CryptGetKeyIdentifierProperty(
...
WINCRYPT32API BOOL WINAPI CryptSetKeyIdentifierProperty(
    const CRYPT_HASH_BLOB *pKeyIdentifier,
    DWORD dwPropId,
    DWORD dwFlags,
    LPCWSTR pwszComputerName,
...
WINCRYPT32API BOOL WINAPI CryptEnumKeyIdentifierProperties(
    const CRYPT_HASH_BLOB *pKeyIdentifier,
    DWORD dwPropId,
    DWORD dwFlags,
    LPCWSTR pwszComputerName,
...
WINCRYPT32API BOOL WINAPI CryptCreateKeyIdentifierFromCSP(
    DWORD dwCertEncodingType,
    LPCSTR pszPubKeyOID,
...
#define CERT_CHAIN_WEAK_RSA_PUB_KEY_TIME_DEFAULT  0x01CA8A755C6E0000ui64
...
WINCRYPT32API BOOL WINAPI CertCreateCertificateChainEngine(
    PCERT_CHAIN_ENGINE_CONFIG pConfig,
    HCERTCHAINENGINE *phChainEngine
);

WINCRYPT32API void WINAPI CertFreeCertificateChainEngine(
    HCERTCHAINENGINE hChainEngine
);

WINCRYPT32API BOOL WINAPI CertResyncCertificateChainEngine(
    HCERTCHAINENGINE hChainEngine
);
...
#endif /* CERT_CHAIN_PARA_HAS_EXTRA_FIELDS */
...
WINCRYPT32API BOOL WINAPI CertGetCertificateChain(
    HCERTCHAINENGINE hChainEngine,
    PCCERT_CONTEXT pCertContext,
    LPFILETIME pTime,
...
WINCRYPT32API void WINAPI CertFreeCertificateChain(
...
WINCRYPT32API PCCERT_CHAIN_CONTEXT WINAPI CertFindChainInStore(
    HCERTSTORE hCertStore,
    DWORD dwCertEncodingType,
    DWORD dwFindFlags,
    DWORD dwFindType,
...
#endif /* CERT_CHAIN_FIND_BY_ISSUER_PARA_HAS_EXTRA_FIELDS */
...
WINCRYPT32STRINGAPI BOOL WINAPI CryptStringToBinaryA(
    LPCSTR pszString,
    DWORD cchString,
    DWORD dwFlags,
    BYTE *pbBinary,
...
WINCRYPT32STRINGAPI BOOL WINAPI CryptStringToBinaryW(
    LPCWSTR pszString,
    DWORD cchString,
    DWORD dwFlags,
    BYTE *pbBinary,
...
WINCRYPT32STRINGAPI BOOL WINAPI CryptBinaryToStringA(
    CONST BYTE *pbBinary,
    DWORD cbBinary,
    DWORD dwFlags,
    LPSTR pszString,
...
WINCRYPT32STRINGAPI BOOL WINAPI CryptBinaryToStringW(
    CONST BYTE *pbBinary,
    DWORD cbBinary,
    DWORD dwFlags,
    LPWSTR pszString,
...
WINCRYPT32API HCERTSTORE WINAPI PFXImportCertStore(
...
WINCRYPT32API BOOL WINAPI PFXIsPFXBlob(
    CRYPT_DATA_BLOB *pPFX
);

WINCRYPT32API BOOL WINAPI PFXVerifyPassword(
    CRYPT_DATA_BLOB *pPFX,
    LPCWSTR szPassword,
    DWORD dwFlags
);

WINCRYPT32API BOOL WINAPI PFXExportCertStoreEx(
    HCERTSTORE hStore,
    CRYPT_DATA_BLOB *pPFX,
    LPCWSTR szPassword,
    void *pvPara,
...
WINCRYPT32API BOOL WINAPI PFXExportCertStore(
    HCERTSTORE hStore,
    CRYPT_DATA_BLOB *pPFX,
    LPCWSTR szPassword,
    DWORD dwFlags
...
WINCRYPT32API HCERT_SERVER_OCSP_RESPONSE WINAPI CertOpenServerOcspResponse(
    PCCERT_CHAIN_CONTEXT pChainContext,
    DWORD dwFlags,
...
WINCRYPT32API void WINAPI CertCloseServerOcspResponse(
    HCERT_SERVER_OCSP_RESPONSE hServerOcspResponse,
    DWORD dwFlags
);

WINCRYPT32API PCCERT_SERVER_OCSP_RESPONSE_CONTEXT WINAPI CertGetServerOcspResponseContext(
    HCERT_SERVER_OCSP_RESPONSE hServerOcspResponse,
    DWORD dwFlags,
    LPVOID pvReserved
);

WINCRYPT32API void WINAPI CertAddRefServerOcspResponseContext(
    PCCERT_SERVER_OCSP_RESPONSE_CONTEXT pServerOcspResponseContext
);

WINCRYPT32API void WINAPI CertFreeServerOcspResponseContext(
    PCCERT_SERVER_OCSP_RESPONSE_CONTEXT pServerOcspResponseContext
);

#endif /* (NTDDI_VERSION >= NTDDI_VISTA) */

WINCRYPT32API BOOL WINAPI CertRetrieveLogoOrBiometricInfo(
    PCCERT_CONTEXT pCertContext,
...
WINCRYPT32API BOOL WINAPI CertSelectCertificateChains(
...
BOOL WINAPI CryptVerifyTimeStampSignature(
...
WINCRYPT32API BOOL WINAPI CertIsWeakHash(
    DWORD dwHashUseType,
    LPCWSTR pwszCNGHashAlgid,
    DWORD dwChainFlags,
...
typedef BOOL (WINAPI *PFN_CERT_IS_WEAK_HASH)(
    DWORD dwHashUseType,
    LPCWSTR pwszCNGHashAlgid,
    DWORD dwChainFlags,
    PCCERT_CHAIN_CONTEXT pSignerChainContext,
