...
#define CM_DISABLE_BITS             (0x0000000F)
...
CMAPI CONFIGRET WINAPI CM_Add_Empty_Log_Conf(
...
CMAPI CONFIGRET WINAPI CM_Add_Empty_Log_Conf_Ex(
    PLOG_CONF plcLogConf,
    DEVINST dnDevInst,
    PRIORITY Priority,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Add_IDA(
    DEVINST dnDevInst,
    PSTR pszID,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Add_IDW(
    DEVINST dnDevInst,
    PWSTR pszID,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Add_ID_ExA(
    DEVINST dnDevInst,
    PSTR pszID,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Add_ID_ExW(
    DEVINST dnDevInst,
    PWSTR pszID,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Add_Res_Des(
    PRES_DES prdResDes,
    LOG_CONF lcLogConf,
...
CMAPI CONFIGRET WINAPI CM_Connect_MachineA(
    PCSTR UNCServerName,
    PHMACHINE phMachine
);

CMAPI CONFIGRET WINAPI CM_Connect_MachineW(
...
CMAPI CONFIGRET WINAPI CM_Create_DevNodeW(
    PDEVINST pdnDevInst,
...
CMAPI CONFIGRET WINAPI CM_Create_DevNode_ExA(
    PDEVINST pdnDevInst,
    DEVINSTID_A pDeviceID,
    DEVINST dnParent,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Create_DevNode_ExW(
    PDEVINST pdnDevInst,
    DEVINSTID_W pDeviceID,
    DEVINST dnParent,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Create_Range_List(
    PRANGE_LIST prlh,
    ULONG ulFlags
);
...
CMAPI CONFIGRET WINAPI CM_Delete_Class_Key(
    LPGUID ClassGuid,
    ULONG ulFlags
);
...
CMAPI CONFIGRET WINAPI CM_Delete_Class_Key_Ex(
    LPGUID ClassGuid,
    ULONG ulFlags,
    HMACHINE hMachine
);
...
CMAPI CONFIGRET WINAPI CM_Delete_DevNode_Key_Ex(
    DEVNODE dnDevNode,
    ULONG ulHardwareProfile,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Delete_Range(
    DWORDLONG ullStartValue,
    DWORDLONG ullEndValue,
    RANGE_LIST rlh,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Detect_Resource_Conflict(
    DEVINST dnDevInst,
    RESOURCEID ResourceID,
    PCVOID ResourceData,
    ULONG ResourceLen,
...
CMAPI CONFIGRET WINAPI CM_Detect_Resource_Conflict_Ex(
    DEVINST dnDevInst,
    RESOURCEID ResourceID,
    PCVOID ResourceData,
    ULONG ResourceLen,
...
CMAPI CONFIGRET WINAPI CM_Disable_DevNode(
    DEVINST dnDevInst,
    ULONG ulFlags
);
...
CMAPI CONFIGRET WINAPI CM_Dup_Range_List(
    RANGE_LIST rlhOld,
    RANGE_LIST rlhNew,
    ULONG ulFlags
);
...
CMAPI CONFIGRET WINAPI CM_Enable_DevNode(
    DEVINST dnDevInst,
    ULONG ulFlags
);
...
CMAPI CONFIGRET WINAPI CM_Enable_DevNode_Ex(
    DEVINST dnDevInst,
    ULONG ulFlags,
    HMACHINE hMachine
);
...
CMAPI CONFIGRET WINAPI CM_Enumerate_Classes_Ex(
    ULONG ulClassIndex,
    LPGUID ClassGuid,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Enumerate_Enumerators_ExW(
    ULONG ulEnumIndex,
    PWSTR Buffer,
    PULONG pulLength,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Find_Range(
...
CMAPI CONFIGRET WINAPI CM_First_Range(
    RANGE_LIST rlh,
    PDWORDLONG pullStart,
    PDWORDLONG pullEnd,
...
CMAPI CONFIGRET WINAPI CM_Free_Log_Conf(
...
CMAPI CONFIGRET WINAPI CM_Free_Log_Conf_Handle(
    LOG_CONF lcLogConf
);

CMAPI CONFIGRET WINAPI CM_Free_Range_List(
    RANGE_LIST rlh,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Free_Res_Des(
    PRES_DES prdResDes,
    RES_DES rdResDes,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Free_Res_Des_Ex(
    PRES_DES prdResDes,
    RES_DES rdResDes,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Free_Res_Des_Handle(
    RES_DES rdResDes
);
...
CMAPI CONFIGRET WINAPI CM_Get_Class_NameA(
    LPGUID ClassGuid,
    PSTR Buffer,
    PULONG pulLength,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Get_Class_Name_ExA(
    LPGUID ClassGuid,
    PSTR Buffer,
    PULONG pulLength,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Get_Class_Key_NameA(
    LPGUID ClassGuid,
    LPSTR pszKeyName,
    PULONG pulLength,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Get_Class_Key_NameW(
    LPGUID ClassGuid,
    LPWSTR pszKeyName,
    PULONG pulLength,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Get_Class_Key_Name_ExW(
    LPGUID ClassGuid,
    LPWSTR pszKeyName,
    PULONG pulLength,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Get_Depth(
    PULONG pulDepth,
    DEVINST dnDevInst,
    ULONG ulFlags
);
...
CMAPI CONFIGRET WINAPI CM_Get_Depth_Ex(
    PULONG pulDepth,
    DEVINST dnDevInst,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_ExA(
    DEVINST dnDevInst,
    PSTR Buffer,
    ULONG BufferLen,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_ExW(
    DEVINST dnDevInst,
    PWSTR Buffer,
    ULONG BufferLen,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_ListA(
    PCSTR pszFilter,
    PZZSTR Buffer,
    ULONG BufferLen,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_ListW(
    PCWSTR pszFilter,
    PZZWSTR Buffer,
    ULONG BufferLen,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_ExA(
    PCSTR pszFilter,
    PZZSTR Buffer,
    ULONG BufferLen,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_ExW(
    PCWSTR pszFilter,
    PZZWSTR Buffer,
    ULONG BufferLen,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_SizeA(
    PULONG pulLen,
    PCSTR pszFilter,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_SizeW(
    PULONG pulLen,
    PCWSTR pszFilter,
    ULONG ulFlags
);
...
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_Size_ExA(
    PULONG pulLen,
    PCSTR pszFilter,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_Size_ExW(
    PULONG pulLen,
    PCWSTR pszFilter,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Property_ExW(
    DEVINST dnDevInst,
    CONST DEVPROPKEY *PropertyKey,
    DEVPROPTYPE *PropertyType,
    PBYTE PropertyBuffer,
...
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Property_Keys(
    DEVINST dnDevInst,
...
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Property_Keys_Ex(
    DEVINST dnDevInst,
    DEVPROPKEY *PropertyKeyArray,
    PULONG PropertyKeyCount,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Registry_PropertyA(
    DEVINST dnDevInst,
    ULONG ulProperty,
...
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Registry_PropertyW(
    DEVINST dnDevInst,
    ULONG ulProperty,
    PULONG pulRegDataType,
    PVOID Buffer,
...
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Registry_Property_ExA(
    DEVINST dnDevInst,
    ULONG ulProperty,
    PULONG pulRegDataType,
    PVOID Buffer,
...
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Registry_Property_ExW(
    DEVINST dnDevInst,
    ULONG ulProperty,
    PULONG pulRegDataType,
    PVOID Buffer,
...
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Custom_PropertyW(
    DEVINST dnDevInst,
...
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Custom_Property_ExA(
    DEVINST dnDevInst,
    PCSTR pszCustomPropertyName,
    PULONG pulRegDataType,
    PVOID Buffer,
...
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Custom_Property_ExW(
    DEVINST dnDevInst,
    PCWSTR pszCustomPropertyName,
    PULONG pulRegDataType,
    PVOID Buffer,
...
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Status_Ex(
    PULONG pulStatus,
    PULONG pulProblemNumber,
    DEVINST dnDevInst,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Get_First_Log_Conf_Ex(
    PLOG_CONF plcLogConf,
    DEVINST dnDevInst,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Get_Global_State(
    PULONG pulState,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Get_Global_State_Ex(
    PULONG pulState,
    ULONG ulFlags,
    HMACHINE hMachine
);
...
CMAPI CONFIGRET WINAPI CM_Get_Hardware_Profile_InfoA(
    ULONG ulIndex,
    PHWPROFILEINFO_A pHWProfileInfo,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Get_Hardware_Profile_Info_ExA(
    ULONG ulIndex,
    PHWPROFILEINFO_A pHWProfileInfo,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Get_Hardware_Profile_InfoW(
    ULONG ulIndex,
    PHWPROFILEINFO_W pHWProfileInfo,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Get_Hardware_Profile_Info_ExW(
    ULONG ulIndex,
    PHWPROFILEINFO_W pHWProfileInfo,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Get_HW_Prof_FlagsA(
    DEVINSTID_A pDeviceID,
    ULONG ulHardwareProfile,
    PULONG pulValue,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Get_HW_Prof_FlagsW(
    DEVINSTID_W pDeviceID,
    ULONG ulHardwareProfile,
    PULONG pulValue,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Get_HW_Prof_Flags_ExW(
    DEVINSTID_W pDeviceID,
    ULONG ulHardwareProfile,
    PULONG pulValue,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_AliasW(
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_Alias_ExA(
    LPCSTR pszDeviceInterface,
    LPGUID AliasInterfaceGuid,
    LPSTR pszAliasDeviceInterface,
    PULONG pulLength,
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_Alias_ExW(
    LPCWSTR pszDeviceInterface,
    LPGUID AliasInterfaceGuid,
    LPWSTR pszAliasDeviceInterface,
    PULONG pulLength,
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_List_ExA(
    LPGUID InterfaceClassGuid,
    DEVINSTID_A pDeviceID,
    PZZSTR Buffer,
    ULONG BufferLen,
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_List_ExW(
    LPGUID InterfaceClassGuid,
    DEVINSTID_W pDeviceID,
    PZZWSTR Buffer,
    ULONG BufferLen,
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_List_SizeA(
    PULONG pulLen,
    LPGUID InterfaceClassGuid,
    DEVINSTID_A pDeviceID,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_List_SizeW(
    PULONG pulLen,
    LPGUID InterfaceClassGuid,
    DEVINSTID_W pDeviceID,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_List_Size_ExW(
    PULONG pulLen,
    LPGUID InterfaceClassGuid,
    DEVINSTID_W pDeviceID,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_PropertyW(
    LPCWSTR pszDeviceInterface,
    CONST DEVPROPKEY *PropertyKey,
    DEVPROPTYPE *PropertyType,
    PBYTE PropertyBuffer,
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_Property_ExW(
    LPCWSTR pszDeviceInterface,
    CONST DEVPROPKEY *PropertyKey,
    DEVPROPTYPE *PropertyType,
    PBYTE PropertyBuffer,
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_Property_KeysW(
    LPCWSTR pszDeviceInterface,
    DEVPROPKEY *PropertyKeyArray,
    PULONG PropertyKeyCount,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_Property_Keys_ExW(
    LPCWSTR pszDeviceInterface,
    DEVPROPKEY *PropertyKeyArray,
    PULONG PropertyKeyCount,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Get_Log_Conf_Priority(
    LOG_CONF lcLogConf,
    PPRIORITY pPriority,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Get_Log_Conf_Priority_Ex(
    LOG_CONF lcLogConf,
    PPRIORITY pPriority,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Get_Next_Log_Conf(
    PLOG_CONF plcLogConf,
    LOG_CONF lcLogConf,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Get_Next_Log_Conf_Ex(
    PLOG_CONF plcLogConf,
    LOG_CONF lcLogConf,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Get_Parent_Ex(
    PDEVINST pdnDevInst,
    DEVINST dnDevInst,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Get_Res_Des_Data_Ex(
    RES_DES rdResDes,
    PVOID Buffer,
    ULONG BufferLen,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Get_Res_Des_Data_Size_Ex(
    PULONG pulSize,
    RES_DES rdResDes,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI WORD WINAPI CM_Get_Version(
    VOID
);

CMAPI WORD WINAPI CM_Get_Version_Ex(
    HMACHINE hMachine
);

#if (WINVER >= _WIN32_WINNT_WINXP)
CMAPI BOOL WINAPI CM_Is_Version_Available(
    WORD wVersion
);

CMAPI BOOL WINAPI CM_Is_Version_Available_Ex(
    WORD wVersion,
    HMACHINE hMachine
);
#endif /* (WINVER >= _WIN32_WINNT_WINXP) */

CMAPI CONFIGRET WINAPI CM_Intersect_Range_List(
    RANGE_LIST rlhOld1,
    RANGE_LIST rlhOld2,
    RANGE_LIST rlhNew,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Invert_Range_List(
    RANGE_LIST rlhOld,
    RANGE_LIST rlhNew,
...
CMAPI CONFIGRET WINAPI CM_Locate_DevNodeA(
    PDEVINST pdnDevInst,
    DEVINSTID_A pDeviceID,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Locate_DevNodeW(
    PDEVINST pdnDevInst,
    DEVINSTID_W pDeviceID,
    ULONG ulFlags
);
...
CMAPI CONFIGRET WINAPI CM_Merge_Range_List(
    RANGE_LIST rlhOld1,
    RANGE_LIST rlhOld2,
    RANGE_LIST rlhNew,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Modify_Res_Des_Ex(
    PRES_DES prdResDes,
    RES_DES rdResDes,
    RESOURCEID ResourceID,
    PCVOID ResourceData,
...
CMAPI CONFIGRET WINAPI CM_Move_DevNode(
    DEVINST dnFromDevInst,
    DEVINST dnToDevInst,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Move_DevNode_Ex(
    DEVINST dnFromDevInst,
    DEVINST dnToDevInst,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Next_Range(
    PRANGE_ELEMENT preElement,
    PDWORDLONG pullStart,
    PDWORDLONG pullEnd,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Get_Next_Res_Des_Ex(
    PRES_DES prdResDes,
    RES_DES rdResDes,
    RESOURCEID ForResource,
    PRESOURCEID pResourceID,
...
CMAPI CONFIGRET WINAPI CM_Open_Class_KeyA(
    LPGUID ClassGuid,
    LPCSTR pszClassName,
    REGSAM samDesired,
...
CMAPI CONFIGRET WINAPI CM_Open_Class_KeyW(
    LPGUID ClassGuid,
...
CMAPI CONFIGRET WINAPI CM_Open_Class_Key_ExA(
    LPGUID ClassGuid,
    LPCSTR pszClassName,
    REGSAM samDesired,
    REGDISPOSITION Disposition,
...
CMAPI CONFIGRET WINAPI CM_Open_Class_Key_ExW(
    LPGUID ClassGuid,
    LPCWSTR pszClassName,
    REGSAM samDesired,
    REGDISPOSITION Disposition,
...
CMAPI CONFIGRET WINAPI CM_Open_DevNode_Key(
    DEVINST dnDevNode,
    REGSAM samDesired,
    ULONG ulHardwareProfile,
    REGDISPOSITION Disposition,
...
CMAPI CONFIGRET WINAPI CM_Open_DevNode_Key_Ex(
    DEVINST dnDevNode,
    REGSAM samDesired,
    ULONG ulHardwareProfile,
    REGDISPOSITION Disposition,
...
CMAPI CONFIGRET WINAPI CM_Open_Device_Interface_KeyW(
    LPCWSTR pszDeviceInterface,
    REGSAM samDesired,
    REGDISPOSITION Disposition,
    PHKEY phkDeviceInterface,
...
CMAPI CONFIGRET WINAPI CM_Open_Device_Interface_Key_ExA(
    LPCSTR pszDeviceInterface,
    REGSAM samDesired,
    REGDISPOSITION Disposition,
    PHKEY phkDeviceInterface,
...
CMAPI CONFIGRET WINAPI CM_Open_Device_Interface_Key_ExW(
    LPCWSTR pszDeviceInterface,
    REGSAM samDesired,
    REGDISPOSITION Disposition,
    PHKEY phkDeviceInterface,
...
CMAPI CONFIGRET WINAPI CM_Delete_Device_Interface_KeyA(
    LPCSTR pszDeviceInterface,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Delete_Device_Interface_KeyW(
    LPCWSTR pszDeviceInterface,
    ULONG ulFlags
);
...
CMAPI CONFIGRET WINAPI CM_Delete_Device_Interface_Key_ExW(
    LPCWSTR pszDeviceInterface,
    ULONG ulFlags,
    HMACHINE hMachine
);
...
CMAPI CONFIGRET WINAPI CM_Query_Arbitrator_Free_Data(
    PVOID pData,
    ULONG DataLen,
    DEVINST dnDevInst,
    RESOURCEID ResourceID,
...
CMAPI CONFIGRET WINAPI CM_Query_Arbitrator_Free_Data_Ex(
    PVOID pData,
    ULONG DataLen,
    DEVINST dnDevInst,
    RESOURCEID ResourceID,
...
CMAPI CONFIGRET WINAPI CM_Query_Arbitrator_Free_Size(
    PULONG pulSize,
    DEVINST dnDevInst,
    RESOURCEID ResourceID,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Query_Arbitrator_Free_Size_Ex(
    PULONG pulSize,
    DEVINST dnDevInst,
    RESOURCEID ResourceID,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Query_Remove_SubTree(
    DEVINST dnAncestor,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Query_Remove_SubTree_Ex(
    DEVINST dnAncestor,
    ULONG ulFlags,
    HMACHINE hMachine
);
...
CMAPI CONFIGRET WINAPI CM_Query_And_Remove_SubTreeA(
    DEVINST dnAncestor,
...
CMAPI CONFIGRET WINAPI CM_Query_And_Remove_SubTreeW(
    DEVINST dnAncestor,
    PPNP_VETO_TYPE pVetoType,
    LPWSTR pszVetoName,
    ULONG ulNameLength,
...
CMAPI CONFIGRET WINAPI CM_Query_And_Remove_SubTree_ExA(
    DEVINST dnAncestor,
    PPNP_VETO_TYPE pVetoType,
    LPSTR pszVetoName,
    ULONG ulNameLength,
...
CMAPI CONFIGRET WINAPI CM_Query_And_Remove_SubTree_ExW(
    DEVINST dnAncestor,
    PPNP_VETO_TYPE pVetoType,
    LPWSTR pszVetoName,
    ULONG ulNameLength,
...
CMAPI CONFIGRET WINAPI CM_Request_Device_EjectA(
    DEVINST dnDevInst,
    PPNP_VETO_TYPE pVetoType,
    LPSTR pszVetoName,
    ULONG ulNameLength,
...
CMAPI CONFIGRET WINAPI CM_Request_Device_Eject_ExA(
    DEVINST dnDevInst,
    PPNP_VETO_TYPE pVetoType,
    LPSTR pszVetoName,
    ULONG ulNameLength,
...
CMAPI CONFIGRET WINAPI CM_Request_Device_EjectW(
    DEVINST dnDevInst,
    PPNP_VETO_TYPE pVetoType,
    LPWSTR pszVetoName,
    ULONG ulNameLength,
...
CMAPI CONFIGRET WINAPI CM_Request_Device_Eject_ExW(
    DEVINST dnDevInst,
    PPNP_VETO_TYPE pVetoType,
    LPWSTR pszVetoName,
    ULONG ulNameLength,
...
CMAPI CONFIGRET WINAPI CM_Reenumerate_DevNode(
    DEVINST dnDevInst,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Reenumerate_DevNode_Ex(
    DEVINST dnDevInst,
    ULONG ulFlags,
    HMACHINE hMachine
);
...
CMAPI CONFIGRET WINAPI CM_Register_Device_InterfaceA(
    DEVINST dnDevInst,
    LPGUID InterfaceClassGuid,
    LPCSTR pszReference,
...
CMAPI CONFIGRET WINAPI CM_Register_Device_InterfaceW(
    DEVINST dnDevInst,
    LPGUID InterfaceClassGuid,
...
CMAPI CONFIGRET WINAPI CM_Register_Device_Interface_ExW(
    DEVINST dnDevInst,
    LPGUID InterfaceClassGuid,
    LPCWSTR pszReference,
    LPWSTR pszDeviceInterface,
...
CMAPI CONFIGRET WINAPI CM_Set_DevNode_Problem_Ex(
    DEVINST dnDevInst,
    ULONG ulProblem,
    ULONG ulFlags,
    HMACHINE hMachine
...
CMAPI CONFIGRET WINAPI CM_Set_DevNode_Problem(
    DEVINST dnDevInst,
    ULONG ulProblem,
    ULONG ulFlags
);
...
CMAPI CONFIGRET WINAPI CM_Unregister_Device_InterfaceA(
    LPCSTR pszDeviceInterface,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Unregister_Device_InterfaceW(
    LPCWSTR pszDeviceInterface,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Unregister_Device_Interface_ExA(
    LPCSTR pszDeviceInterface,
    ULONG ulFlags,
    HMACHINE hMachine
);

CMAPI CONFIGRET WINAPI CM_Unregister_Device_Interface_ExW(
    LPCWSTR pszDeviceInterface,
    ULONG ulFlags,
    HMACHINE hMachine
);
...
CMAPI CONFIGRET WINAPI CM_Register_Device_Driver(
    DEVINST dnDevInst,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Register_Device_Driver_Ex(
    DEVINST dnDevInst,
    ULONG ulFlags,
    HMACHINE hMachine
);

CMAPI CONFIGRET WINAPI CM_Remove_SubTree(
    DEVINST dnAncestor,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Remove_SubTree_Ex(
    DEVINST dnAncestor,
    ULONG ulFlags,
    HMACHINE hMachine
);
...
CMAPI CONFIGRET WINAPI CM_Set_DevNode_Property_ExW(
    DEVINST dnDevInst,
    CONST DEVPROPKEY *PropertyKey,
    DEVPROPTYPE PropertyType,
    CONST PBYTE PropertyBuffer,
...
CMAPI CONFIGRET WINAPI CM_Set_DevNode_Registry_PropertyW(
    DEVINST dnDevInst,
    ULONG ulProperty,
    PCVOID Buffer,
    ULONG ulLength,
...
CMAPI CONFIGRET WINAPI CM_Set_DevNode_Registry_Property_ExA(
    DEVINST dnDevInst,
    ULONG ulProperty,
    PCVOID Buffer,
    ULONG ulLength,
...
CMAPI CONFIGRET WINAPI CM_Set_DevNode_Registry_Property_ExW(
    DEVINST dnDevInst,
    ULONG ulProperty,
    PCVOID Buffer,
    ULONG ulLength,
...
CMAPI CONFIGRET WINAPI CM_Set_Device_Interface_PropertyW(
    LPCWSTR pszDeviceInterface,
    CONST DEVPROPKEY *PropertyKey,
    DEVPROPTYPE PropertyType,
    CONST PBYTE PropertyBuffer,
...
CMAPI CONFIGRET WINAPI CM_Set_Device_Interface_Property_ExW(
    LPCWSTR pszDeviceInterface,
    CONST DEVPROPKEY *PropertyKey,
    DEVPROPTYPE PropertyType,
    CONST PBYTE PropertyBuffer,
...
CMAPI CONFIGRET WINAPI CM_Is_Dock_Station_Present_Ex(
    PBOOL pbPresent,
    HMACHINE hMachine
);

CMAPI CONFIGRET WINAPI CM_Request_Eject_PC(
    VOID
);

CMAPI CONFIGRET WINAPI CM_Request_Eject_PC_Ex(
    HMACHINE hMachine
);

CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_FlagsA(
    DEVINSTID_A pDeviceID,
    ULONG ulConfig,
    ULONG ulValue,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_FlagsW(
    DEVINSTID_W pDeviceID,
    ULONG ulConfig,
    ULONG ulValue,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_Flags_ExA(
    DEVINSTID_A pDeviceID,
    ULONG ulConfig,
    ULONG ulValue,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_Flags_ExW(
    DEVINSTID_W pDeviceID,
    ULONG ulConfig,
    ULONG ulValue,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Setup_DevNode(
    DEVINST dnDevInst,
    ULONG ulFlags
);
...
CMAPI CONFIGRET WINAPI CM_Setup_DevNode_Ex(
    DEVINST dnDevInst,
    ULONG ulFlags,
    HMACHINE hMachine
);
...
CMAPI CONFIGRET WINAPI CM_Test_Range_Available(
    DWORDLONG ullStartValue,
    DWORDLONG ullEndValue,
    RANGE_LIST rlh,
    ULONG ulFlags
...
CMAPI CONFIGRET WINAPI CM_Uninstall_DevNode(
    DEVNODE dnDevInst,
    ULONG ulFlags
);
...
CMAPI CONFIGRET WINAPI CM_Uninstall_DevNode_Ex(
    DEVNODE dnDevInst,
    ULONG ulFlags,
    HMACHINE hMachine
);
...
CMAPI CONFIGRET WINAPI CM_Run_Detection_Ex(
    ULONG ulFlags,
    HMACHINE hMachine
);
...
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof(
    ULONG ulHardwareProfile,
    ULONG ulFlags
);

CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_Ex(
    ULONG ulHardwareProfile,
    ULONG ulFlags,
    HMACHINE hMachine
);

CMAPI CONFIGRET WINAPI CM_Query_Resource_Conflict_List(
...
CMAPI CONFIGRET WINAPI CM_Get_Resource_Conflict_Count(
    CONFLICT_LIST clConflictList,
    PULONG pulCount
);

CMAPI CONFIGRET WINAPI CM_Get_Resource_Conflict_DetailsA(
    CONFLICT_LIST clConflictList,
    ULONG ulIndex,
    PCONFLICT_DETAILS_A pConflictDetails
);

CMAPI CONFIGRET WINAPI CM_Get_Resource_Conflict_DetailsW(
    CONFLICT_LIST clConflictList,
    ULONG ulIndex,
...
CMAPI CONFIGRET WINAPI CM_Get_Class_Property_ExW(
    LPCGUID ClassGUID,
    CONST DEVPROPKEY *PropertyKey,
    DEVPROPTYPE *PropertyType,
    PBYTE PropertyBuffer,
...
CMAPI CONFIGRET WINAPI CM_Get_Class_Property_Keys_Ex(
    LPCGUID ClassGUID,
    DEVPROPKEY *PropertyKeyArray,
    PULONG PropertyKeyCount,
    ULONG ulFlags,
...
CMAPI CONFIGRET WINAPI CM_Set_Class_PropertyW(
    LPCGUID ClassGUID,
    CONST DEVPROPKEY *PropertyKey,
    DEVPROPTYPE PropertyType,
    CONST PBYTE PropertyBuffer,
...
CMAPI CONFIGRET WINAPI CM_Set_Class_Property_ExW(
    LPCGUID ClassGUID,
    CONST DEVPROPKEY *PropertyKey,
    DEVPROPTYPE PropertyType,
    CONST PBYTE PropertyBuffer,
...
CMAPI CONFIGRET WINAPI CM_Get_Class_Registry_PropertyA(
    LPGUID ClassGuid,
    ULONG ulProperty,
    PULONG pulRegDataType,
    PVOID Buffer,
...
CMAPI CONFIGRET WINAPI CM_Set_Class_Registry_PropertyA(
    LPGUID ClassGuid,
    ULONG ulProperty,
    PCVOID Buffer,
    ULONG ulLength,
...
CMAPI CONFIGRET WINAPI CM_Set_Class_Registry_PropertyW(
    LPGUID ClassGuid,
    ULONG ulProperty,
    PCVOID Buffer,
    ULONG ulLength,
...
DWORD WINAPI CM_WaitNoPendingInstallEvents(
    DWORD dwTimeout
);
...
CMAPI DWORD WINAPI CM_MapCrToWin32Err(
