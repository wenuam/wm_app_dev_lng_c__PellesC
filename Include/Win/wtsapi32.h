...
BOOL WINAPI WTSStopRemoteControlSession(
    ULONG LogonId
);

BOOL WINAPI WTSStartRemoteControlSessionW(
...
BOOL WINAPI WTSStartRemoteControlSessionA(
...
BOOL WINAPI WTSConnectSessionA(
    ULONG LogonId,
    ULONG TargetLogonId,
    PSTR pPassword,
    BOOL bWait
...
BOOL WINAPI WTSConnectSessionW(
    ULONG LogonId,
    ULONG TargetLogonId,
    PWSTR pPassword,
    BOOL bWait
...
BOOL WINAPI WTSEnumerateServersW(
    LPWSTR pDomainName,
    DWORD Reserved,
    DWORD Version,
...
BOOL WINAPI WTSEnumerateServersA(
    LPSTR pDomainName,
    DWORD Reserved,
    DWORD Version,
...
HANDLE WINAPI WTSOpenServerW(
    LPWSTR pServerName
);

HANDLE WINAPI WTSOpenServerA(
    LPSTR pServerName
);

HANDLE WINAPI WTSOpenServerExW(
    LPWSTR pServerName
);

HANDLE WINAPI WTSOpenServerExA(
    LPSTR pServerName
);
...
BOOL WINAPI WTSEnumerateSessionsExW(
    HANDLE hServer,
    DWORD *pLevel,
    DWORD Filter,
...
BOOL WINAPI WTSEnumerateSessionsExA(
    HANDLE hServer,
    DWORD *pLevel,
    DWORD Filter,
...
BOOL WINAPI WTSEnumerateProcessesW(
    HANDLE hServer,
    DWORD Reserved,
    DWORD Version,
...
BOOL WINAPI WTSEnumerateProcessesA(
    HANDLE hServer,
    DWORD Reserved,
    DWORD Version,
...
BOOL WINAPI WTSTerminateProcess(
    HANDLE hServer,
    DWORD ProcessId,
    DWORD ExitCode
);
...
BOOL WINAPI WTSDisconnectSession(
    HANDLE hServer,
    DWORD SessionId,
    BOOL bWait
);

BOOL WINAPI WTSLogoffSession(
    HANDLE hServer,
    DWORD SessionId,
    BOOL bWait
);

BOOL WINAPI WTSShutdownSystem(
    HANDLE hServer,
    DWORD ShutdownFlag
);

BOOL WINAPI WTSWaitSystemEvent(
    HANDLE hServer,
    DWORD EventMask,
    DWORD * pEventFlags
);

HANDLE WINAPI WTSVirtualChannelOpen(
    HANDLE hServer,
    DWORD SessionId,
    LPSTR pVirtualName
);
...
BOOL WINAPI WTSVirtualChannelClose(
    HANDLE hChannelHandle
);

BOOL WINAPI WTSVirtualChannelRead(
    HANDLE hChannelHandle,
    ULONG TimeOut,
    PCHAR Buffer,
    ULONG BufferSize,
...
BOOL WINAPI WTSVirtualChannelWrite(
    HANDLE hChannelHandle,
    PCHAR Buffer,
    ULONG Length,
...
BOOL WINAPI WTSVirtualChannelPurgeInput(
    HANDLE hChannelHandle
);

BOOL WINAPI WTSVirtualChannelPurgeOutput(
    HANDLE hChannelHandle
);

BOOL WINAPI WTSVirtualChannelQuery(
    HANDLE hChannelHandle,
    WTS_VIRTUAL_CLASS,
    PVOID *ppBuffer,
    DWORD *pBytesReturned
...
BOOL WINAPI WTSUnRegisterSessionNotification(
    HWND hWnd
);

BOOL WINAPI WTSRegisterSessionNotificationEx(
    HANDLE hServer,
    HWND hWnd,
    DWORD dwFlags
);

BOOL WINAPI WTSUnRegisterSessionNotificationEx(
    HANDLE hServer,
    HWND hWnd
);
...
BOOL WINAPI WTSEnumerateProcessesExA(
    HANDLE hServer,
    DWORD *pLevel,
    DWORD SessionId,
    LPSTR *ppProcessInfo,
...
BOOL WINAPI WTSEnumerateListenersW(
    HANDLE hServer,
    PVOID pReserved,
    DWORD Reserved,
...
BOOL WINAPI WTSEnumerateListenersA(
    HANDLE hServer,
    PVOID pReserved,
    DWORD Reserved,
