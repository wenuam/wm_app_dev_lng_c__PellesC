...
ULONG APIENTRY LPM_Initialize(
    LPM_HANDLE LpmHandle,
    LPM_INIT_INFO *pLpmInitInfo,
    DWORD *pLpmVersionNumber,
    PETYPE *pSupportedPeType,
    VOID *Reserved);

ULONG APIENTRY LPM_Deinitialize(
    LPM_HANDLE LpmHandle);
...
ULONG APIENTRY LPM_AdmitRsvpMsg(
...
ULONG APIENTRY LPM_GetRsvpObjects(
    RHANDLE PcmReqHandle,
    ULONG MaxPdSize,
...
VOID APIENTRY LPM_DeleteState(
    RSVP_HOP *pRcvdIfAddr,
    MSG_TYPE RsvpMsgType,
    RSVP_SESSION *pRsvpSession,
    RSVP_HOP *pRsvpFromHop,
    RESV_STYLE *pResvStyle,
...
BOOL APIENTRY LPM_IpAddressTable(
    ULONG cIpAddrTable,
