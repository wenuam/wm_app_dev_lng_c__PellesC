...
#if defined(_MMSYSTEM_H) || defined(_MMREG_H)
...
#endif /* defined(_MMSYSTEM_H) || defined(_MMREG_H) */
...
DEFINE_DEVPROPKEY(DEVPKEY_KsAudio_PacketSize_Constraints, 0x13e004d6, 0xb066, 0x43bd, 0x91, 0x3b, 0xa4, 0x15, 0xcd, 0x13, 0xda, 0x87, 2);
#endif

#if (NTDDI_VERSION >= NTDDI_WIN10_RS5)
#ifdef DEFINE_DEVPROPKEY
DEFINE_DEVPROPKEY(DEVPKEY_KsAudio_Controller_DeviceInterface_Path, 0x13e004d6, 0xb066, 0x43bd, 0x91, 0x3b, 0xa4, 0x15, 0xcd, 0x13, 0xda, 0x87, 3);
#endif
#endif
...
#ifdef DEFINE_DEVPROPKEY
DEFINE_DEVPROPKEY(DEVPKEY_KsAudio_PacketSize_Constraints2, 0x9404f781, 0x7191, 0x409b, 0x8b, 0xb, 0x80, 0xbf, 0x6e, 0xc2, 0x29, 0xae, 2);
#endif
...
#ifdef _NTDDK_
typedef NTSTATUS (CALLBACK *PRTAUDIOGETPOSITION)(PFILE_OBJECT PinFileObject,
    PUCHAR *ppPlayPosition,
    PLONG plOffset);
#endif /* _NTDDK_ */
...
#define KS_COPYPROTECT_RestrictDuplication   0x00000001
...
#define KS_MPEG2_WidescreenAnalogOut 0x00000200

#define KS_AMCONTROL_USED              0x00000001

#define KS_AMCONTROL_PAD_TO_4x3        0x00000002
#define KS_AMCONTROL_PAD_TO_16x9       0x00000004
#define KS_AMCONTROL_COLORINFO_PRESENT 0x00000080
...
#define KS_VIDEO_FLAG_FIELD_MASK   0x0003L
...
#define KS_VIDEO_FLAG_IPB_MASK     0x0030L
...
#if (NTDDI_VERSION < NTDDI_WINXP)
#define KS_VBI_FLAG_FRAME                0x0000L
#endif
...
#endif /* ((NTDDI_VERSION >= NTDDI_WINXPSP2) && (NTDDI_VERSION < NTDDI_WS03) ) || (NTDDI_VERSION >= NTDDI_WS03SP1) */
...
#if (NTDDI_VERSION >= NTDDI_VISTA)
#define KS_TVAUDIO_PRESET_STEREO       0x0200
#define KS_TVAUDIO_PRESET_LANG_A       0x1000
#define KS_TVAUDIO_PRESET_LANG_B       0x2000
#define KS_TVAUDIO_PRESET_LANG_C       0x4000
#endif
