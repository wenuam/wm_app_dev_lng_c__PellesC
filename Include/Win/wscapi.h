...
HRESULT wscShowAMSCN(
    DWORD InputFlags, PDWORD pdwResultFlags);

HRESULT wscLaunchAdminMakeDefaultUI(
    PCWSTR pwszProductName);

STDAPI WscQueryAntiMalwareUri(void);

STDAPI WscGetAntiMalwareUri(
    LPWSTR *ppszUri);
