...
#endif /* ((NTDDI_VERSION >= NTDDI_WS03) || ((OSVER(NTDDI_VERSION) == NTDDI_WIN2K) && (SPVER(NTDDI_VERSION) >= 4))) */
...
HANDLE WINAPI GetSpoolFileHandle(
    HANDLE hPrinter
);
...
BOOL WINAPI CloseSpoolFileHandle(
    HANDLE hPrinter,
    HANDLE hSpoolFile
);
...
#endif /* ((OSVER(NTDDI_VERSION) == NTDDI_WINXP) && (SPVER(NTDDI_VERSION) >= 2) || (NTDDI_VERSION >= NTDDI_WS03SP1)) */
...
#endif /* ((NTDDI_VERSION >= NTDDI_WINXPSP1) || ((OSVER(NTDDI_VERSION) == NTDDI_WIN2K) && (SPVER(NTDDI_VERSION) >= 3))) */
...
BOOL WINAPI AddPrinterConnection2A(
    HWND hWnd,
    LPCSTR pszName,
    DWORD dwLevel,
    PVOID pConnectionInfo
);
BOOL WINAPI AddPrinterConnection2W(
    HWND hWnd,
    LPCWSTR pszName,
    DWORD dwLevel,
    PVOID pConnectionInfo
...
HRESULT WINAPI InstallPrinterDriverFromPackageA(
    LPCSTR pszServer,
    LPCSTR pszInfPath,
...
HRESULT WINAPI InstallPrinterDriverFromPackageW(
    LPCWSTR pszServer,
    LPCWSTR pszInfPath,
...
HRESULT WINAPI CorePrinterDriverInstalledA(
    LPCSTR pszServer,
    LPCSTR pszEnvironment,
    GUID CoreDriverGUID,
    FILETIME ftDriverDate,
...
HRESULT WINAPI CorePrinterDriverInstalledW(
    LPCWSTR pszServer,
    LPCWSTR pszEnvironment,
    GUID CoreDriverGUID,
    FILETIME ftDriverDate,
...
HRESULT WINAPI ReportJobProcessingProgress(
...
BOOL WINAPI GetPrinterDriver2A(
    HWND hWnd,
    HANDLE hPrinter,
    LPSTR pEnvironment,
    DWORD Level,
...
BOOL WINAPI GetPrinterDriver2W(
    HWND hWnd,
    HANDLE hPrinter,
    LPWSTR pEnvironment,
    DWORD Level,
...
void WINAPI FreePrintPropertyValue(
    PrintPropertyValue *pValue
);
...
DWORD WINAPI DeleteJobNamedProperty(
    HANDLE hPrinter,
    DWORD JobId,
    PCWSTR pszName
);
