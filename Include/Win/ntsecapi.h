...
#if (_WIN32_WINNT >= 0x0501)
BOOLEAN __stdcall RtlGenRandom(
    PVOID RandomBuffer,
...
NTSTATUS __stdcall RtlEncryptMemory(
    PVOID Memory,
    ULONG MemorySize,
    ULONG OptionFlags
);

NTSTATUS __stdcall RtlDecryptMemory(
    PVOID Memory,
    ULONG MemorySize,
    ULONG OptionFlags
);
...
BOOLEAN NTAPI AuditSetSystemPolicy(
    PCAUDIT_POLICY_INFORMATION pAuditPolicy,
    ULONG dwPolicyCount
);

BOOLEAN NTAPI AuditSetPerUserPolicy(
    const PSID pSid,
    PCAUDIT_POLICY_INFORMATION pAuditPolicy,
    ULONG dwPolicyCount
);

BOOLEAN NTAPI AuditQuerySystemPolicy(
    const GUID * pSubCategoryGuids,
    ULONG dwPolicyCount,
    PAUDIT_POLICY_INFORMATION * ppAuditPolicy
);

BOOLEAN NTAPI AuditQueryPerUserPolicy(
    const PSID pSid,
    const GUID * pSubCategoryGuids,
    ULONG dwPolicyCount,
    PAUDIT_POLICY_INFORMATION * ppAuditPolicy
...
BOOLEAN NTAPI AuditEnumeratePerUserPolicy(
    PPOLICY_AUDIT_SID_ARRAY * ppAuditSidArray
);

BOOLEAN NTAPI AuditComputeEffectivePolicyBySid(
    const PSID pSid,
    const GUID * pSubCategoryGuids,
    ULONG dwPolicyCount,
    PAUDIT_POLICY_INFORMATION * ppAuditPolicy
...
BOOLEAN NTAPI AuditComputeEffectivePolicyByToken(
    HANDLE hTokenHandle,
    const GUID * pSubCategoryGuids,
    ULONG dwPolicyCount,
    PAUDIT_POLICY_INFORMATION * ppAuditPolicy
...
BOOLEAN NTAPI AuditEnumerateCategories(
    GUID * * ppAuditCategoriesArray,
    PULONG pdwCountReturned
);

BOOLEAN NTAPI AuditEnumerateSubCategories(
...
BOOLEAN NTAPI AuditLookupCategoryNameW(
    const GUID * pAuditCategoryGuid,
    PWSTR * ppszCategoryName
);

BOOLEAN NTAPI AuditLookupCategoryNameA(
    const GUID * pAuditCategoryGuid,
    PSTR * ppszCategoryName
);
...
BOOLEAN NTAPI AuditLookupSubCategoryNameW(
    const GUID * pAuditSubCategoryGuid,
    PWSTR * ppszSubCategoryName
);

BOOLEAN NTAPI AuditLookupSubCategoryNameA(
    const GUID * pAuditSubCategoryGuid,
    PSTR * ppszSubCategoryName
);
...
BOOLEAN NTAPI AuditLookupCategoryIdFromCategoryGuid(
    const GUID * pAuditCategoryGuid,
    PPOLICY_AUDIT_EVENT_TYPE pAuditCategoryId
);

BOOLEAN NTAPI AuditLookupCategoryGuidFromCategoryId(
    POLICY_AUDIT_EVENT_TYPE AuditCategoryId,
    GUID * pAuditCategoryGuid
);

BOOLEAN NTAPI AuditSetSecurity(
    SECURITY_INFORMATION SecurityInformation,
    PSECURITY_DESCRIPTOR pSecurityDescriptor
);

BOOLEAN NTAPI AuditQuerySecurity(
    SECURITY_INFORMATION SecurityInformation,
