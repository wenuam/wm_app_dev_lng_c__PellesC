...
BOOL WINAPI DdeDisconnect(
    HCONV hConv
);

HCONV WINAPI DdeReconnect(
    HCONV hConv
);
...
BOOL WINAPI DdeImpersonateClient(
    HCONV hConv
);
...
HSZ WINAPI DdeCreateStringHandleA(
    DWORD idInst,
    LPCSTR psz,
    int iCodePage
);
