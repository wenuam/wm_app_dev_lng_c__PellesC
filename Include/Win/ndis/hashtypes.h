...
static inline ULONG NDIS_RSS_HASH_FUNC_FROM_HASH_INFO(ULONG HashInfo) {
    return HashInfo & NDIS_HASH_FUNCTION_MASK;
}

static inline ULONG NDIS_RSS_HASH_TYPE_FROM_HASH_INFO(ULONG HashInfo) {
    return HashInfo & NDIS_HASH_TYPE_MASK;
}

static inline ULONG NDIS_RSS_HASH_INFO_FROM_TYPE_AND_FUNC(ULONG HashType, ULONG HashFunction) {
