...
#if __POCC__ < 1300
#error <wchar.h> need POCC version 13.0 or higher
#endif /* __POCC__ < 1300 */
...
extern _CRTIMP _CRTCHK(printf,2,3) int __cdecl vfwprintf(struct FILE * restrict, const wchar_t * restrict, va_list);
extern _CRTIMP _CRTCHK(scanf,2,3) int __cdecl vfwscanf(struct FILE * restrict, const wchar_t * restrict, va_list);
extern _CRTIMP _CRTCHK(printf,3,4) int __cdecl vswprintf(wchar_t * restrict, size_t, const wchar_t * restrict, va_list);
extern _CRTIMP _CRTCHK(scanf,2,3) int __cdecl vswscanf(const wchar_t * restrict, const wchar_t * restrict, va_list);
extern _CRTIMP _CRTCHK(printf,1,2) int __cdecl vwprintf(const wchar_t * restrict, va_list);
extern _CRTIMP _CRTCHK(scanf,1,2) int __cdecl vwscanf(const wchar_t * restrict, va_list);
...
extern _CRTIMP long __cdecl wcstol_c23(const wchar_t * restrict, wchar_t ** restrict, int);
#define wcstol  wcstol_c23
extern _CRTIMP long long __cdecl wcstoll_c23(const wchar_t * restrict, wchar_t ** restrict, int);
#define wcstoll  wcstoll_c23
extern _CRTIMP unsigned long __cdecl wcstoul_c23(const wchar_t * restrict, wchar_t ** restrict, int);
#define wcstoul  wcstoul_c23
extern _CRTIMP unsigned long long __cdecl wcstoull_c23(const wchar_t * restrict, wchar_t ** restrict, int);
#define wcstoull  wcstoull_c23
#endif /* __POCC_STDC_VERSION__ >= 202311L */
/* (copying functions) */
...
/* (search functions) */
extern _CRTIMP _CRTRET(1) wchar_t * __cdecl wcschr(const wchar_t *, wchar_t);
extern _CRTIMP size_t __cdecl wcscspn(const wchar_t *, const wchar_t *);
extern _CRTIMP _CRTRET(1) wchar_t * __cdecl wcspbrk(const wchar_t *, const wchar_t *);
extern _CRTIMP _CRTRET(1) wchar_t * __cdecl wcsrchr(const wchar_t *, wchar_t);
extern _CRTIMP size_t __cdecl wcsspn(const wchar_t *, const wchar_t *);
extern _CRTIMP _CRTRET(1) wchar_t * __cdecl wcsstr(const wchar_t *, const wchar_t *);
extern _CRTIMP wchar_t * __cdecl wcstok(wchar_t * restrict, const wchar_t * restrict, wchar_t ** restrict);
extern _CRTIMP _CRTRET(1) wchar_t * __cdecl wmemchr(const wchar_t *, wchar_t, size_t);
...
extern _CRTIMP _CRTCHK(strftime,3,4) size_t __cdecl wcsftime(wchar_t * restrict, size_t, const wchar_t * restrict, const struct tm * restrict);
...
extern _CRTIMP _CRTCHK(printf,3,4) int __cdecl _vsnwprintf(wchar_t * restrict, size_t, const wchar_t * restrict, va_list);
...
extern _CRTIMP wchar_t * __cdecl _wcsset(wchar_t *, wchar_t);
...
extern wchar_t * __cdecl wcsset(wchar_t *, wchar_t);
...
/* formatted wide-character input/output functions */
extern _CRTIMP _CRTCHK(printf_s,2,3) int __cdecl fwprintf_s(struct FILE * restrict, const wchar_t * restrict, ...);
extern _CRTIMP _CRTCHK(scanf_s,2,3) int __cdecl fwscanf_s(struct FILE * restrict, const wchar_t * restrict, ...);
extern _CRTIMP _CRTCHK(printf_s,3,4) int __cdecl snwprintf_s(wchar_t * restrict, rsize_t, const wchar_t * restrict, ...);
extern _CRTIMP _CRTCHK(printf_s,3,4) int __cdecl swprintf_s(wchar_t * restrict, rsize_t, const wchar_t * restrict, ...);
extern _CRTIMP _CRTCHK(scanf_s,2,3) int __cdecl swscanf_s(const wchar_t * restrict, const wchar_t * restrict, ...);
extern _CRTIMP _CRTCHK(printf_s,2,3) int __cdecl vfwprintf_s(struct FILE * restrict, const wchar_t * restrict, va_list);
extern _CRTIMP _CRTCHK(scanf_s,2,3) int __cdecl vfwscanf_s(struct FILE * restrict, const wchar_t * restrict, va_list);
extern _CRTIMP _CRTCHK(printf_s,3,4) int __cdecl vsnwprintf_s(wchar_t * restrict, rsize_t, const wchar_t * restrict, va_list);
extern _CRTIMP _CRTCHK(printf_s,3,4) int __cdecl vswprintf_s(wchar_t * restrict, rsize_t, const wchar_t * restrict, va_list);
extern _CRTIMP _CRTCHK(scanf_s,2,3) int __cdecl vswscanf_s(const wchar_t * restrict, const wchar_t * restrict, va_list);
extern _CRTIMP _CRTCHK(printf_s,1,2) int __cdecl vwprintf_s(const wchar_t * restrict, va_list);
extern _CRTIMP _CRTCHK(scanf_s,1,2) int __cdecl vwscanf_s(const wchar_t * restrict, va_list);
extern _CRTIMP _CRTCHK(printf_s,1,2) int __cdecl wprintf_s(const wchar_t * restrict, ...);
...
extern _CRTIMP _CRTCHK(printf,2,3) int __cdecl vaswprintf(wchar_t ** restrict, const wchar_t * restrict, va_list);

extern _CRTIMP _ssize_t __cdecl getwdelim(wchar_t ** restrict, size_t * restrict, wint_t, struct FILE *);
extern _CRTIMP _ssize_t __cdecl getwline(wchar_t **, size_t *, struct FILE *);
