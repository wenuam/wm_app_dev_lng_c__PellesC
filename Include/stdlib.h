...
#if __POCC__ < 1200
#error <stdlib.h> need POCC version 12.0 or higher
#endif /* __POCC__ < 1200 */
...
typedef __ONCE_FLAG_TYPE__ once_flag;
...
extern size_t __cdecl __mb_cur_max(void);
...
#if __POCC_STDC_VERSION__ >= 202311L
extern _CRTIMP _CRTCHK(strfrom,3,4) int __cdecl strfromf(char * restrict, size_t, const char * restrict, float);
extern _CRTIMP _CRTCHK(strfrom,3,4) int __cdecl strfromd(char * restrict, size_t, const char * restrict, double);
extern _CRTIMP _CRTCHK(strfrom,3,4) int __cdecl strfroml(char * restrict, size_t, const char * restrict, long double);
#endif /* __POCC_STDC_VERSION__ >= 202311L */
...
extern _CRTIMP long __cdecl strtol_c23(const char * restrict, char ** restrict, int);
#define strtol  strtol_c23
extern _CRTIMP long long __cdecl strtoll_c23(const char * restrict, char ** restrict, int);
#define strtoll  strtoll_c23
extern _CRTIMP unsigned long __cdecl strtoul_c23(const char * restrict, char ** restrict, int);
#define strtoul  strtoul_c23
extern _CRTIMP unsigned long long __cdecl strtoull_c23(const char * restrict, char ** restrict, int);
...
#if __POCC_STDC_VERSION__ >= 202311L
extern _CRTIMP _CRTFRE(1) void __cdecl free_sized(void *, size_t);
extern _CRTIMP _CRTFRE(1) void __cdecl free_aligned_sized(void *, size_t, size_t);
#endif /* __POCC_STDC_VERSION__ >= 202311L */
...
extern _CRTIMP _CRTRET(2) void * __cdecl bsearch(const void *, const void *, size_t, size_t, __cmpfunc *);
...
/* alignment of memory */
#if __POCC_STDC_VERSION__ >= 202311L
extern _CRTIMP size_t __cdecl memalignment(const void *);
#endif /* __POCC_STDC_VERSION__ >= 202311L */
...
extern _CRTIMP _CRTRET(2) void * __cdecl bsearch_s(const void *, const void *, rsize_t, rsize_t, __cmpfunc_s *, void *);
