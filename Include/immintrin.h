...
/* user wait */
extern void __cdecl _umonitor(void *);
extern unsigned char __cdecl _umwait(unsigned int, unsigned __int64);
extern unsigned char __cdecl _tpause(unsigned int, unsigned __int64);

#if __POCC_TARGET__ == 3
/* user interrupts */
extern void __cdecl _clui(void);
extern void __cdecl _stui(void);
extern unsigned char __cdecl _testui(void);
extern void __cdecl _senduipi(unsigned __int64);
#endif /* __POCC_TARGET__ == 3 */
