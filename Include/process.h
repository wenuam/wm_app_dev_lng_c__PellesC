...
extern _CRTIMP intptr_t __cdecl _execv(const char *, const char * const []);
extern _CRTIMP intptr_t __cdecl _execve(const char *, const char * const [], const char * const []);
extern _CRTIMP intptr_t __cdecl _execvp(const char *, const char * const []);
extern _CRTIMP intptr_t __cdecl _execvpe(const char *, const char * const [], const char * const []);
...
extern _CRTIMP intptr_t __cdecl _spawnv(int, const char *, const char * const []);
extern _CRTIMP intptr_t __cdecl _spawnve(int, const char *, const char * const [], const char * const []);
extern _CRTIMP intptr_t __cdecl _spawnvp(int, const char *, const char * const []);
extern _CRTIMP intptr_t __cdecl _spawnvpe(int, const char *, const char * const [], const char * const []);
...
extern _CRTIMP intptr_t __cdecl _wexecv(const wchar_t *, const wchar_t * const []);
extern _CRTIMP intptr_t __cdecl _wexecve(const wchar_t *, const wchar_t * const [], const wchar_t * const []);
extern _CRTIMP intptr_t __cdecl _wexecvp(const wchar_t *, const wchar_t * const []);
extern _CRTIMP intptr_t __cdecl _wexecvpe(const wchar_t *, const wchar_t * const [], const wchar_t * const []);
...
extern _CRTIMP intptr_t __cdecl _wspawnv(int, const wchar_t *, const wchar_t * const []);
extern _CRTIMP intptr_t __cdecl _wspawnve(int, const wchar_t *, const wchar_t * const [], const wchar_t * const []);
extern _CRTIMP intptr_t __cdecl _wspawnvp(int, const wchar_t *, const wchar_t * const []);
extern _CRTIMP intptr_t __cdecl _wspawnvpe(int, const wchar_t *, const wchar_t * const [], const wchar_t * const []);
