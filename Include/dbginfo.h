 ...
 *           22-09-09  Added PODBG_LEAF_BITINT_T.                           *
 *           22-11-08  Deprecated PODBG_LEAF_STRUCT_T.                      *
 *           22-11-08  Deprecated PODBG_LEAF_ENUM_T.                        *
 *           22-11-08  Deprecated PODBG_LEAF_FIELDLIST_T.                   *
 *           22-11-08  Deprecated PODBG_LEAF_BITFIELD_T.                    *
 *           22-11-08  Deprecated all PODBG_SUBLEAF_xxx_T.                  *
 *           22-11-08  Added PODBG_LEAF_STRUCT_V2_T.                        *
 *           22-11-08  Added PODBG_LEAF_ENUM_V2_T.                          *
 *           22-11-08  Added PODBG_LEAF_MEMBERLIST_V2_T.                    *
 *           22-11-08  Added PODBG_LEAF_FIELD_V2_T.                         *
 *           22-11-08  Added PODBG_LEAF_BITFIELD_V2_T.                      *
 *           22-11-08  Added PODBG_LEAF_ENUM32_V2_T.                        *
 *           22-11-08  Added PODBG_LEAF_ENUM64_V2_T.                        *
 *                                                                          *
 ****************************************************************************/
...
typedef struct PODBG_LEAF_STRUCT_V2_T {
    uint16_t length;                        /* length of type info (part of alignment) */
    uint16_t kind;                          /* leaf kind: PODBG_LEAF_STRUCT_V2 or PODBG_LEAF_UNION_V2 */
    uint32_t type_fields;                   /* type index of PODBG_LEAF_MEMBERLIST_V2 */
    uint32_t size;                          /* size of this struct or union (in bytes) */
    uint16_t flags;                         /* struct or union flags (PODBG_LEAF_STRUCT_FLAG_xxx) */
    char name[1];                           /* nul-terminated UTF-8 tag name */
} PODBG_LEAF_STRUCT_V2_T;
...
typedef struct PODBG_LEAF_ENUM_V2_T {
    uint16_t length;                        /* length of type info (part of alignment) */
    uint16_t kind;                          /* leaf kind: PODBG_LEAF_ENUM_V2 */
    uint32_t type_elem;                     /* type (primitive, or complex type index) of elements */
    uint32_t type_members;                  /* type index of PODBG_LEAF_MEMBERLIST_V2 */
    char name[1];                           /* nul-terminated UTF-8 name of enum tag */
} PODBG_LEAF_ENUM_V2_T;
...
typedef struct PODBG_LEAF_BITINT_T {
    uint16_t length;                        /* length of type info (part of alignment) */
    uint16_t kind;                          /* leaf kind: PODBG_LEAF_BITINT */
    uint16_t nbits;                         /* number of bits (i.e. N in _BitInt(N)) */
    uint16_t flags;                         /* _BitInt(N) flags (PODBG_LEAF_BITINT_FLAG_xxx) */
} PODBG_LEAF_BITINT_T;
...
typedef struct PODBG_LEAF_MEMBERLIST_V2_T {
    uint16_t length;                        /* length of type info (part of alignment) */
    uint16_t kind;                          /* leaf kind: PODBG_LEAF_MEMBERLIST_V2 */
    uint32_t nmembers;                      /* number of members */
    uint32_t type_members[/*nmembers*/];    /* array of member types */
} PODBG_LEAF_MEMBERLIST_V2_T;

typedef struct PODBG_LEAF_FIELD_V2_T {
    uint16_t length;                        /* length of type info (part of alignment) */
    uint16_t kind;                          /* leaf kind: PODBG_LEAF_FIELD_V2 */
    uint32_t type;                          /* type index of field */
    uint32_t offset;                        /* struct offset (zero for union) */
    char name[1];                           /* nul-terminated UTF-8 name of field */
} PODBG_LEAF_FIELD_V2_T;

typedef struct PODBG_LEAF_BITFIELD_V2_T {
    uint16_t length;                        /* length of type info (part of alignment) */
    uint16_t kind;                          /* leaf kind: PODBG_LEAF_BITFIELD_V2 */
    uint32_t type;                          /* type index of bit-field */
    uint32_t offset;                        /* struct offset */
    uint8_t nbits;                          /* number of bits (width) */
    uint8_t position;                       /* starting position (from bit 0) */
    char name[1];                           /* nul-terminated UTF-8 name of bit-field */
} PODBG_LEAF_BITFIELD_V2_T;

typedef struct PODBG_LEAF_ENUM32_V2_T {
    uint16_t length;                        /* length of type info (part of alignment) */
    uint16_t kind;                          /* leaf kind: PODBG_LEAF_ENUM32_V2 */
    uint32_t value;                         /* enumerator value */
    char name[1];                           /* nul-terminated UTF-8 name of enumerator */
} PODBG_LEAF_ENUM32_V2_T;

typedef struct PODBG_LEAF_ENUM64_V2_T {
    uint16_t length;                        /* length of type info (part of alignment) */
    uint16_t kind;                          /* leaf kind: PODBG_LEAF_ENUM64_V2 */
    uint32_t value_lo;                      /* enumerator value (lower 32 bits) */
    uint32_t value_hi;                      /* enumerator value (upper 32 bits) */
    char name[1];                           /* nul-terminated UTF-8 name of enumerator */
} PODBG_LEAF_ENUM64_V2_T;
...
typedef union PODBG_LEAF_GROUP_T {
    ...
    PODBG_LEAF_BITINT_T bix;
    PODBG_LEAF_STRUCT_V2_T str2;
    PODBG_LEAF_ENUM_V2_T enm2;
    PODBG_LEAF_MEMBERLIST_V2_T mbrs;
    PODBG_LEAF_FIELD_V2_T fld2;
    PODBG_LEAF_BITFIELD_V2_T bit2;
    PODBG_LEAF_ENUM32_V2_T e32;
    PODBG_LEAF_ENUM64_V2_T e64;
} PODBG_LEAF_GROUP_T;
...
typedef struct PODBG_SUBLEAF_ENUM32_T {
    ...
    uint16_t reserved;                      /* --reserved-- */
    int32_t value;                          /* enumerator value */
