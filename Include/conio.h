...
extern _CRTIMP wchar_t * __cdecl _cgetws(wchar_t *);
...
extern _CRTIMP int __cdecl _cputws(const wchar_t *);
extern _CRTIMP _CRTCHK(scanf,1,2) int __cdecl _cscanf(const char * restrict, ...);
extern _CRTIMP _CRTCHK(scanf,1,2) int __cdecl _cwscanf(const wchar_t * restrict, ...);
extern _CRTIMP int __cdecl _getch(void);
extern _CRTIMP int __cdecl _getche(void);
extern _CRTIMP wint_t __cdecl _getwch(void);
extern _CRTIMP wint_t __cdecl _getwche(void);
...
extern _CRTIMP wint_t __cdecl _ungetwch(wint_t);
