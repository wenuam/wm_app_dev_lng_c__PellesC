...
/* declarations */
extern _CRTIMP _CRTRET(1) void * __cdecl memchr(const void *, int, size_t);
...
extern _CRTIMP _CRTRET(1) char * __cdecl strchr(const char *, int);
...
extern _CRTIMP _CRTRET(1) char * __cdecl strpbrk(const char *, const char *);
extern _CRTIMP _CRTRET(1) char * __cdecl strrchr(const char *, int);
extern _CRTIMP size_t __cdecl strspn(const char *, const char *);
extern _CRTIMP _CRTRET(1) char * __cdecl strstr(const char *, const char *);
...
extern _CRTIMP void * __cdecl memset_explicit(void *, int, size_t);
