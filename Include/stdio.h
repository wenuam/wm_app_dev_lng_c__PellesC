...
#if __POCC__ < 1300
#error <stdio.h> need POCC version 13.0 or higher
#endif /* __POCC__ < 1300 */
...
extern _CRTIMP _CRTCHK(printf,2,3) int __cdecl vfprintf(FILE * restrict, const char * restrict, va_list);
extern _CRTIMP _CRTCHK(scanf,2,3) int __cdecl vfscanf(FILE * restrict, const char * restrict, va_list);
extern _CRTIMP _CRTCHK(printf,1,2) int __cdecl vprintf(const char * restrict, va_list);
extern _CRTIMP _CRTCHK(scanf,1,2) int __cdecl vscanf(const char * restrict, va_list);
extern _CRTIMP _CRTCHK(printf,3,4) int __cdecl vsnprintf(char * restrict, size_t, const char * restrict, va_list);
extern _CRTIMP _CRTCHK(printf,2,3) int __cdecl vsprintf(char * restrict, const char * restrict, va_list);
extern _CRTIMP _CRTCHK(scanf,2,3) int __cdecl vsscanf(const char * restrict, const char * restrict, va_list);
...
extern _CRTIMP _CRTCHK(printf,3,4) int __cdecl _snprintf(char * restrict, size_t, const char * restrict, ...);
extern _CRTIMP _CRTCHK(printf,3,4) int __cdecl _vsnprintf(char * restrict, size_t, const char * restrict, va_list);
...
extern _CRTIMP int __cdecl _fseek64(FILE *, long long, int);
extern _CRTIMP long long __cdecl _ftell64(FILE *);
...
/* formatted input/output functions */
extern _CRTIMP _CRTCHK(printf_s,2,3) int __cdecl fprintf_s(FILE * restrict, const char * restrict, ...);
extern _CRTIMP _CRTCHK(scanf_s,2,3) int __cdecl fscanf_s(FILE * restrict, const char * restrict, ...);
extern _CRTIMP _CRTCHK(printf_s,1,2) int __cdecl printf_s(const char * restrict, ...);
extern _CRTIMP _CRTCHK(scanf_s,1,2) int __cdecl scanf_s(const char * restrict, ...);
extern _CRTIMP _CRTCHK(printf_s,3,4) int __cdecl snprintf_s(char * restrict, rsize_t, const char * restrict, ...);
extern _CRTIMP _CRTCHK(printf_s,3,4) int __cdecl sprintf_s(char * restrict, rsize_t, const char * restrict, ...);
extern _CRTIMP _CRTCHK(scanf_s,2,3) int __cdecl sscanf_s(const char * restrict, const char * restrict, ...);
extern _CRTIMP _CRTCHK(printf_s,2,3) int __cdecl vfprintf_s(FILE * restrict, const char * restrict, va_list);
extern _CRTIMP _CRTCHK(scanf_s,2,3) int __cdecl vfscanf_s(FILE * restrict, const char * restrict, va_list);
extern _CRTIMP _CRTCHK(printf_s,1,2) int __cdecl vprintf_s(const char * restrict, va_list);
extern _CRTIMP _CRTCHK(scanf_s,1,2) int __cdecl vscanf_s(const char * restrict, va_list);
extern _CRTIMP _CRTCHK(printf_s,3,4) int __cdecl vsnprintf_s(char * restrict, rsize_t, const char * restrict, va_list);
extern _CRTIMP _CRTCHK(printf_s,3,4) int __cdecl vsprintf_s(char * restrict, rsize_t, const char * restrict, va_list);
extern _CRTIMP _CRTCHK(scanf_s,2,3) int __cdecl vsscanf_s(const char * restrict, const char * restrict, va_list);
...
extern _CRTIMP _CRTCHK(printf,2,3) int __cdecl vasprintf(char ** restrict, const char * restrict, va_list);

extern _CRTIMP _ssize_t __cdecl getdelim(char ** restrict, size_t * restrict, int, FILE *);
extern _CRTIMP _ssize_t __cdecl getline(char **, size_t *, FILE *);
