 ...
 *           21-09-14  Added support for __unaligned qualifier.             *
 *           22-03-13  Added support for char8_t (C2X).                     *
 *           22-09-09  Added support for _BitInt(N) (C2X).                  *
 *           22-11-08  Deprecated PODBG_LEAF_STRUCT, PODBG_LEAF_UNION.      *
 *           22-11-08  Deprecated PODBG_LEAF_ENUM.                          *
 *           22-11-08  Deprecated PODBG_LEAF_FIELDLIST.                     *
 *           22-11-08  Deprecated PODBG_LEAF_BITFIELD.                      *
 *           22-11-08  Deprecated whole subleaf business (complex lists).   *
 *           22-11-08  Added PODBG_LEAF_STRUCT_V2, PODBG_LEAF_UNION_V2.     *
 *           22-11-08  Added PODBG_LEAF_ENUM_V2.                            *
 *           22-11-08  Added PODBG_LEAF_MEMBERLIST_V2.                      *
 *           22-11-08  Added PODBG_LEAF_FIELD_V2.                           *
 *           22-11-08  Added PODBG_LEAF_BITFIELD_V2.                        *
 *           22-11-08  Added PODBG_LEAF_ENUM32_V2.                          *
 *           22-11-08  Added PODBG_LEAF_ENUM64_V2.                          *
 *           22-11-08  Changed types version to PODBG_TYPES_VERSION_2.      *
 *                                                                          *
 ****************************************************************************/
...
/* Known versions */
#define PODBG_SYMBOLS_VERSION_1  1  /* POCC v9, POASM v9/v10/v11 */
#define PODBG_SYMBOLS_VERSION_2  2  /* POCC v10/v11 */
#define PODBG_TYPES_VERSION_1  1    /* POCC v9/v10/v11, POASM v9/v10/v11 */
#define PODBG_TYPES_VERSION_2  2    /* POCC v12, POASM v12 */

/* Current versions */
#define PODBG_SYMBOLS_VERSION  PODBG_SYMBOLS_VERSION_2
#define PODBG_TYPES_VERSION  PODBG_TYPES_VERSION_2
...
#define PODBG_LEAF_MODIFIER_FLAG_UNALIGNED  0x0010  /* __unaligned qualifier */
...
#define PODBG_LEAF_POINTER_FLAG_UNALIGNED   0x0010  /* __unaligned qualifier */

/* PODBG_LEAF_STRUCT_T flags */
#define PODBG_LEAF_STRUCT_FLAG_FWDREF       0x0001  /* forward reference (incomplete defn) */

/* PODBG_LEAF_BITINT_T flags */
#define PODBG_LEAF_BITINT_FLAG_UNSIGNED     0x0001  /* unsigned _BitInt(N) */
...
/* Really an 8-bit Unicode character types */
#define PODBG_TYPE_CHAR8        PODBG_PRIMITIVE_TYPE(PODBG_KM_INTEGER,PODBG_KI_CHAR8,PODBG_PM_DIR)
#define PODBG_TYPE_PCHAR8       PODBG_PRIMITIVE_TYPE(PODBG_KM_INTEGER,PODBG_KI_CHAR8,PODBG_PM_PTR)
...
#ifdef PODBG_HAVE_DEPRECATED_TYPES_V1
/*
 ...
 */
#else /* !PODBG_HAVE_DEPRECATED_TYPES_V1 */
/*
 * No PODBG_LEAF_xxx index can have a value of 0x0000. The leaf indices are separated into
 * two groups according to the use of the type record. The first group is for the type records
 * that are directly referenced from symbols. The second group is for type records that are
 * not referenced from symbols, but instead are referenced from other type records. All type
 * records must have a starting leaf index in one of these two groups.
 */
#endif /* !PODBG_HAVE_DEPRECATED_TYPES_V1 */
...
#ifdef PODBG_HAVE_DEPRECATED_TYPES_V1
    PODBG_LEAF_STRUCT = 0x1005,         /* structure [DEPRECATED] */
    PODBG_LEAF_UNION = 0x1006,          /* union [DEPRECATED] */
    PODBG_LEAF_ENUM = 0x1007,           /* enumeration [DEPRECATED] */
#endif /* PODBG_HAVE_DEPRECATED_TYPES_V1 */
    PODBG_LEAF_FUNCTION = 0x1008,       /* function */
    PODBG_LEAF_BITINT = 0x1009,         /* _BitInt(N) */
    PODBG_LEAF_STRUCT_V2 = 0x100A,      /* structure v2 */
    PODBG_LEAF_UNION_V2 = 0x100B,       /* union v2 */
    PODBG_LEAF_ENUM_V2 = 0x100C,        /* enumeration v2 */
    /*
     * Group 2: Leaf indices starting records only referenced from other type records.
     */
    PODBG_LEAF_PARMLIST = 0x1201,       /* parameter list */
#ifdef PODBG_HAVE_DEPRECATED_TYPES_V1
    PODBG_LEAF_FIELDLIST = 0x1202,      /* field list [DEPRECATED] */
    PODBG_LEAF_BITFIELD = 0x1203,       /* bit-field [DEPRECATED] */
#endif /* PODBG_HAVE_DEPRECATED_TYPES_V1 */
    PODBG_LEAF_REFSYM = 0x1204,         /* reference symbol */
    PODBG_LEAF_DIMCNST = 0x1205,        /* constant dimension (vararray) */
    PODBG_LEAF_MEMBERLIST_V2 = 0x1206,  /* structure, union, or enumeration member list */
    PODBG_LEAF_FIELD_V2 = 0x1207,       /* structure or union field v2 */
    PODBG_LEAF_BITFIELD_V2 = 0x1208,    /* structure bit-field v2 */
    PODBG_LEAF_ENUM32_V2 = 0x1209,      /* enumerator v2 (32-bit value) */
    PODBG_LEAF_ENUM64_V2 = 0x120A,      /* enumerator v2 (64-bit value) */
    /*
     * Group 3: Leaf indices for fields of complex lists.
     */
#ifdef PODBG_HAVE_DEPRECATED_TYPES_V1
    PODBG_SUBLEAF_FIELD16 = 0x1401,     /* field list member (16-bit offset) [DEPRECATED] */
    PODBG_SUBLEAF_FIELD32 = 0x1402,     /* field list member (32-bit offset) [DEPRECATED] */
    PODBG_SUBLEAF_ENUM32 = 0x1403,      /* enumeration member (32-bit value) [DEPRECATED] */
    /*
     * Paddington.
     */
    PODBG_LEAF_PAD0 = 0xF0,             /* [DEPRECATED] */
    PODBG_LEAF_PAD1 = 0xF1,             /* [DEPRECATED] */
    PODBG_LEAF_PAD2 = 0xF2,             /* [DEPRECATED] */
    PODBG_LEAF_PAD3 = 0xF3,             /* [DEPRECATED] */
    PODBG_LEAF_PAD4 = 0xF4,             /* [DEPRECATED] */
    PODBG_LEAF_PAD5 = 0xF5,             /* [DEPRECATED] */
    PODBG_LEAF_PAD6 = 0xF6,             /* [DEPRECATED] */
    PODBG_LEAF_PAD7 = 0xF7,             /* [DEPRECATED] */
    PODBG_LEAF_PAD8 = 0xF8,             /* [DEPRECATED] */
    PODBG_LEAF_PAD9 = 0xF9,             /* [DEPRECATED] */
    PODBG_LEAF_PAD10 = 0xFA,            /* [DEPRECATED] */
    PODBG_LEAF_PAD11 = 0xFB,            /* [DEPRECATED] */
    PODBG_LEAF_PAD12 = 0xFC,            /* [DEPRECATED] */
    PODBG_LEAF_PAD13 = 0xFD,            /* [DEPRECATED] */
    PODBG_LEAF_PAD14 = 0xFE,            /* [DEPRECATED] */
    PODBG_LEAF_PAD15 = 0xFF,            /* [DEPRECATED] */
#endif /* PODBG_HAVE_DEPRECATED_TYPES_V1 */
} PODBG_LEAF_T;
