 ...
 * File    : dllmain.c                                                      *
 *                                                                          *
 * Purpose : Demonstrates shared data in a DLL.                             *
 *                                                                          *
 * History : Date      Reason                                               *
 *           00/00/00  Created                                              *
 *                                                                          *
...
/* one shared integer - for test */
#pragma data_seg(".SHARE")
_declspec(dllexport) int my_shared_int = 0;  /* initialize data! */
#pragma data_seg()  /* back to default data section */

/* tell the linker that the section ".SHARE" is shared... */
#pragma comment(linker, "/section:.SHARE,RWS")

/* one private integer - for comparison */
_declspec(dllexport) int my_private_int = 0;
...
/****************************************************************************
 *                                                                          *
 * Function: set_shared_int_value                                           *
 *                                                                          *
 * Purpose : Set new value of shared integer.                               *
 *                                                                          *
 * History : Date      Reason                                               *
 *           00/00/00  Created                                              *
 *                                                                          *
...
{
    my_shared_int = new_shared_int;
}

/****************************************************************************
 *                                                                          *
 * Function: get_shared_int_value                                           *
 *                                                                          *
 * Purpose : Get current value of shared integer.                           *
 *                                                                          *
 * History : Date      Reason                                               *
 *           00/00/00  Created                                              *
 *                                                                          *
...
{
    return my_shared_int;
}

/****************************************************************************
 *                                                                          *
 * Function: set_private_int_value                                          *
 *                                                                          *
 * Purpose : Set new value of private integer.                              *
 *                                                                          *
 * History : Date      Reason                                               *
 *           00/00/00  Created                                              *
 *                                                                          *
...
{
    my_private_int = new_private_int;
}

/****************************************************************************
 *                                                                          *
 * Function: get_private_int_value                                          *
 *                                                                          *
 * Purpose : Get current value of private integer.                          *
 *                                                                          *
 * History : Date      Reason                                               *
 *           00/00/00  Created                                              *
 *                                                                          *
