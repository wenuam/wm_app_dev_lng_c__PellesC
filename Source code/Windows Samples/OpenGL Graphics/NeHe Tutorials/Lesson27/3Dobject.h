...
// load object
inline int ReadObject(char *st, struct glObject *o){
  FILE *file;
  unsigned int i;
...
inline void SetConnectivity(struct glObject *o){
...
inline void CalcPlane(struct glObject *o, struct sPlane *plane){
	struct sPoint v[4];
	int i;
