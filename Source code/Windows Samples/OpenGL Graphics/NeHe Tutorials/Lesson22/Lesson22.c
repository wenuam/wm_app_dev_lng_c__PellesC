...
int LoadGLTextures(void){											// Load Bitmaps And Convert To Textures
	...
	if (Image) {													// If Texture Exists
		if (Image->data) free(Image->data) /*delete Image->data*/;		// If Texture Image Exists
		free(Image) /*delete Image*/;
		Image=NULL;
	}	
	...
	if (Image=auxDIBImageLoad("Data/OpenGL_ALPHA.bmp")) {
		alpha=malloc(4*Image->sizeX*Image->sizeY) /*alpha=new char[4*Image->sizeX*Image->sizeY]*/;	// Create Memory For RGBA8-Texture
