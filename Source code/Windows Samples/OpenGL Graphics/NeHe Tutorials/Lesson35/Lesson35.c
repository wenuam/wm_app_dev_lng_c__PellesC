...
#pragma comment( lib, "avifil32.lib" )								// Search For avifil32.lib While Linking
#pragma comment( lib, "msvfw32.lib" )								// Search For msvfw32.lib While Linking
...
void OpenAVI(LPCSTR szFile)										// Opens An AVI File (szFile)
{
	...
	hBitmap = CreateDIBSection (hdc, (BITMAPINFO*)(&bmih), DIB_RGB_COLORS, (void**)(&data), NULL, /*NULL*/ 0);
