...
BOOL CreateWindowGL (GL_Window* window)									// This Code Creates Our OpenGL Window
{
	...
	PIXELFORMATDESCRIPTOR pfd =											// pfd Tells Windows How We Want Things To Be
	{
		...
		0 /*window->init.bitsPerPixel*/,							// Select Our Color Depth
	...
	pfd.cColorBits = window->init.bitsPerPixel;  // Select Our Color Depth

	RECT windowRect = (RECT){0, 0, window->init.width, window->init.height};	// Define Our Window Coordinates
