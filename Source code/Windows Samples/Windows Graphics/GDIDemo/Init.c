...
HWND FAR CreateAppWindow(HANDLE hInstance)
{
     ...
     */
    return (CreateWindow(APPCLASS, APPTITLE, WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL));
}
...
HWND FAR CreateMDIClientWindow(HWND hWndFrame)
{
    ...
    hWndClient = CreateWindow("MDICLIENT", NULL, WS_CHILD | WS_CLIPSIBLINGS | WS_VISIBLE, 0, 0, 1, 1, hWndFrame, NULL, hInstance, (LPVOID) & ccs);
