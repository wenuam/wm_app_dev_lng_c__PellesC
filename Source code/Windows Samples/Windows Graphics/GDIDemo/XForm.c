...
/*---------------------------------------------------------------------------*\
   ...
   \*--------------------------------------------------------------------------- */
LRESULT CALLBACK XFormProc(HWND hWnd, UINT wMsg, WPARAM wParam, LPARAM lParam)
{
    switch (wMsg) {
    case WM_CREATE:
...
BOOL XFormCreateProc(HWND hWnd)
{
    ...
    if (AllocWindowInfo(hWnd, sizeof(XFORMDATA))) {
        if ((pxd = (PXFORMDATA)LockWindowInfo(hWnd)) != NULL) {
...
/*---------------------------------------------------------------------------*\
   ...
   \*--------------------------------------------------------------------------- */
BOOL XFormCommandProc(HWND hWnd, WPARAM wParam, LPARAM lParam)
{
    hWnd = hWnd;
    wParam = wParam;
    lParam = lParam;
